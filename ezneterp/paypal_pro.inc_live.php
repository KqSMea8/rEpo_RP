...
class paypal_pro
{
	...
	function __construct($API_USERNAME, $API_PASSWORD, $API_SIGNATURE, $PROXY_HOST, $PROXY_PORT, $IS_ONLINE = TRUE, $USE_PROXY = FALSE, $VERSION = '57.0')
	{
		...
		*/
		...
		$this->API_USERNAME = "admin_api1.virtualstacks.com";
		$this->API_PASSWORD = "LFVHZUKECP9LUTTP";
		$this->API_SIGNATURE = "AFcWxV21C7fd0v3bYYYRCpSSRl31AkcWpUe5S";
		$IS_ONLINE = TRUE;
		...
		{
			$this->PROXY_HOST = '66.55.11.23';
			$this->PROXY_PORT = '33433';
		}
		else
		{
