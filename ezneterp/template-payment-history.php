                        ...
                        <div class="section">
                            ...
                            <div class="tabs">
                                ...
                                <ul class="tabs primary">
                                    ...
                                    <li class="active">
                                        <a class="active" href="index.php?slug=payment-history">Payment History<span
                                                ...
                                                <tbody>
                                                    ...
                                                    if (is_array($arrayOrder) && $num > 0) {
                                                        ...
                                                        echo 'Pending';
                                                                ...
                                                                <td><?php if ($values["AdditionalSpace"] > 0) {
                                                        echo $values["AdditionalSpace"] . ' ' . $values["AdditionalSpaceUnit"];
                                                    } ?></td>
                                                            </tr>
                                                        <?php }
                                                    } else { ?>
