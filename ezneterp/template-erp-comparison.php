...
<section id="mainContent">
    ...
    <div class="InfoText">
        ...
        <div class="section">
            ...
            <h1 id="page-title" class="title">eZnet ERP Pricing &amp;Signup</h1>
            <div id="messages"><div class="">
            <div style="overflow: visible; position: fixed; z-index: 9999; width: 400px; top: 46px; left: 474.5px; display: none;"
                id="better-messages-wrapper" class="better-messeges-processed">
                <div id="better-messages-default"><div id="messages-inner">
                    <table>
                    <tbody>
                        <tr>
                            <td class="tl"></td>
        ...
        <!-- /.section, /#messages -->
            ...
            <div class="content"><div class="CompareWrap">
            <div class="compareleftinfo1">
                ...
                ?>
                        <li class="<?php if (in_array($pktfeature, $packagefea)) {
                                echo "yes";
                            } else {
                                    echo "no";
                            } ?>"><?php if (in_array($pktfeature, $packagefea)) {
                                echo "yes";
                            } else {
                                echo "no";
                            } ?>
            ...
            <?php
                //echo '</li>';
                    ...
                    if ($k == $max) {
                        ...
                        <li class="upgrade"><span class="buttons1"><a href="index.php?slug=upgrade&pack_id=7" title="Upgrade Now">Upgrade Now</a></span></li>
                        <li class="upgrade"><span class="buttons1"><a href="index.php?slug=upgrade&pack_id=8" title="Upgrade Now">Upgrade Now</a></span></li>
                        <li class="upgrade"><span class="buttons1"><a href="index.php?slug=upgrade&pack_id=9" title="Upgrade Now">Upgrade Now</a></span></li>
                        </ul>';
                    }
                }
                    $j++;
            ...
            //print_r($packagefeature);
                ?>
                    <!--amit ul class="feature-list-compare"><li></li>
                        <li class="upgrade"><span class="buttons1"><a href="index.php?slug=upgrade&pack_id=7" title="Upgrade Now">Upgrade Now</a></span></li>
                        <li class="upgrade"><span class="buttons1"><a href="index.php?slug=upgrade&pack_id=8" title="Upgrade Now">Upgrade Now</a></span></li>
                        <li class="upgrade"><span class="buttons1"><a href="index.php?slug=upgrade&pack_id=9" title="Upgrade Now">Upgrade Now</a></span></li>
                    </ul-->
