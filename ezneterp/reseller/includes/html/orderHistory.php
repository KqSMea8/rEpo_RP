    ...
    <tr>
        <td>
            ...
            <table <?= $table_bg ?>>
                ...
                if (is_array($arryOrderHistory) && $num > 0) {
                    ...
                    foreach ($arryOrderHistory as $key => $values) {
                        ...
                        <tr align="left" bgcolor="<?= $bgcolor ?>">
                            ...
                            <td >
                                <?php if ($values['PaymentStatus'] == '1') {
                                    echo "<div class='green'>Paid</div>";
                                } else {
                                    echo "<div class='red'><a href='orderHistory.php?active_id=" . $values["OrderID"] . "&curP=" . $_GET["curP"] . "'>Pending</a></div>";
                                } ?>
                            </td>				
                ...
                <?php } else { ?>
                <tr align="center">
                    <td height="20" colspan="15" class="no_record">No Recourd found.</td>
                </tr>
                    <?php } ?>
                <tr>
                    <td height="20" colspan="15">Total Record(s) : &nbsp;<?php echo $num; ?>
