...
<a href="<?=$Prefix?>upload/company/<?=$arryCompany[0]['Image']?>" class="fancybox" data-fancybox-group="gallery"  title="<?=stripslashes($arryCompany[0]["CompanyName"])?>" ><? echo '<img src="'.$Prefix.'resizeimage.php?w=150&h=150&img=upload/company/'.$arryCompany[0]['Image'].'" border=0 >';?></a>
<?	} ?>
</td>
