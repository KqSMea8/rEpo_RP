...
<a href="<?=$Prefix?>upload/reseller/<?=$arryReseller[0]['Image']?>" class="fancybox" data-fancybox-group="gallery"  title="<?=stripslashes($arryReseller[0]["FullName"])?>" ><? echo '<img src="'.$Prefix.'resizeimage.php?w=150&h=150&img=upload/reseller/'.$arryReseller[0]['Image'].'" border=0 >';?></a>
<?	} ?>
</td>
