...
<tr>
	<td align="right"  class="blackbold" valign="top" >Allowed Number Of Users  :</td>
	<td  align="left"  >
	<?=stripslashes($arryCompany[0]['MaxUser'])?>
...
<tr>
	...
	<td  align="left"  >
		<?=stripslashes($arryCompany[0]['StorageLimit']).' '.$arryCompany[0]['StorageLimitUnit']?> 
...
<tr>
	...
	<input name="OldImage" value="<?=$Prefix?>upload/company/<?=$arryCompany[0]['Image']?>" type="hidden">
	<? } ?>
...
$SupPrefx = $Prefix.'admin/';
include($Prefix."admin/includes/html/box/clock.php"); ?></div>
...
<input name="DisplayName" type="hidden" id="DisplayName" value="<?php echo stripslashes($arryCompany[0]['DisplayName']); ?>"  />
 ...
 <?php if($arryCompany[0]['JoiningDate'] > 0){?>
...
<tr>
        ...
        <td   align="left" >
<?php if($arryCompany[0]['ExpiryDate']>0)$ExpiryDate = $arryCompany[0]['ExpiryDate'];?>		
<script>
$(function() {
