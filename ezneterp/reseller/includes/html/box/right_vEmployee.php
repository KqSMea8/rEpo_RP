...
<div class="right_box">
  ...
  <div id="imgGal">
    ...
    <? 
    $MainDir = $Prefix."admin/hrms/upload/employee/".$_GET['cmp']."/";
   ...
   ?>
    ...
    <?	}else{ ?>
    <div  id="ImageDiv" align="center"><img src="<?=$Prefix?>resizeimage.php?w=120&h=120&img=images/nouser.gif" title="<?=$arryEmployee[0]['UserName']?>" /></div>
    <? } ?>
    </div>
