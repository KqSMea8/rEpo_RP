          ...
          <tr>
            <td  align="center" valign="middle" ><table width="100%"  border="0" cellpadding="0" cellspacing="0" >
                <form name="form1" id="productBasicInfoForm" action=""  method="post"  enctype="multipart/form-data">
                  <tr>
                    <td align="center" valign="top" ><table width="100%" border="0" cellpadding="3" cellspacing="1"  class="borderall">
                        <tr>
                        ...
                        <tr>
                          ...
                          <td align="left"><input name="Price2" type="text" class="inputbox" id="Price2" value="<? echo $arryProduct[0]['Price2']; ?>" size="10" maxlength="10">
                            <?=$Config['Currency']; ?></td>
                        </tr>
                        <?php 
                        /*for($count=0;$count< count($listAllCustomerGroups); $count++){
                        	...
                        	echo '<tr>
                          <td height="30" align="right"  class="blackbold" >'.$listAllCustomerGroups[$count]['GroupName'].' (Price) :</td>
                          <td align="left"><input name="groupprice['.$listAllCustomerGroups[$count]['GroupID'].']" type="text" class="inputbox" size="10" maxlength="10">
                       '.$Config['Currency'].'</td>
                        </tr>';
                        }*/
                        ?>
			...
			<td><input type="checkbox" name="is_upld" id="is_upld" <?php if($arryProduct[0]['is_upld'] == "1"){echo "checked";} ?> onclick="getUploadType(this.value);" value="1" ></td>
			</tr> 
...
<tr id="label_up" <?=$style?>>
			...
			<td><input type="text" class="inputbox" name="label_txt" id="label_txt" value="<? echo stripslashes($arryProduct[0]['label_txt']); ?>" ></td>
		</tr> 
                        <tr>
