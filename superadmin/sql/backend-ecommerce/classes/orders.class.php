...
class orders extends dbClass {
    ...
    function GetOrders($id = 0, $OrderStatus,$PaymentStatus,$CustomerName,$OrderPeriod) {
        ...
        $strSQLQuery = "SELECT o.OrderID,o.Currency,o.CurrencySymbol,o.TotalPrice,o.OrderStatus,o.PaymentStatus,o.OrderDate,o.BillingName,o.OrderType,o.SellerChannel,c.FirstName,c.LastName,c.Cid from e_orders AS o LEFT JOIN e_customers AS c ON c.Cid = o.Cid " . $strAddQuery;
	...
	END )) as OrderTotal FROM e_orders WHERE PaymentStatus=1 AND OrderStatus='Completed'";
          $arrayRow =  $this->query($strSQLQuery, 1);
          return $arrayRow[0]['OrderTotal'];
     }
	...
	END )) as OrderTotal FROM e_orders WHERE (DATE(OrderDate) BETWEEN '".date('Y').'-01-01'."' AND '".date('Y').'-12-31'."') AND PaymentStatus=1 AND OrderStatus='Completed'";
    ...
    function exportOrders()
            {
                ...
                $strSQLQuery = "SELECT o.*,c.FirstName,c.LastName,c.Cid, od.ProductID,od.ProductName,od.ProductOptions,od.Quantity,od.Price,od.Variant_ID,od.Variant_val_Id FROM e_orders o INNER JOIN e_orderdetail od ON o.OrderID = od.OrderID LEFT JOIN e_customers c ON o.Cid=c.Cid GROUP BY o.OrderID  ORDER BY o.OrderID ASC";
