...
class payment extends dbClass
{
	...
	function createFailedTransaction($orderdata, $response, $transaction_id)
	{
			
		global $Config;
		$strSQLQuery="UPDATE e_orders SET OrderStatus='Failed',OrderStatus='Failed',PaymentStatus='5' WHERE  OrderID='".$orderdata['OrderID']."'";
		$this->query($strSQLQuery,0);
	...
	function add_payment_response(){
		...
		$strSQLQuery="INSERT INTO payment_response SET
