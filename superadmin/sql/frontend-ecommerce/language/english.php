...
define('GROUPDISCOUNT','Group Discount');
...
define('COMPLETED_ORDER','Your Order has been received');
...
define('LEFTMENU','Menu');

/*****************************Card Variables****************************************************************************/
define('CARDTYPE','Card Type');
define('CARDNUMBER','Card Number');
define('CARDEXPIRATIONDATE','Expiration Date');
define('CARDCVVNUMBER','CVV Number');

define('Variant','Variant');  //By Chetan 11Sep//
?>
