						...
						<table width="100%" border="0" cellpadding="5" cellspacing="1">
							<tr>
								...
								Page Name (for Menu) :<span class="red">*</span></td>
								 <td   align="left" >
                               <?php 
 $Name = (!empty($arryPages->Name))?($arryPages->Name):('');
echo $FormHelper->input(__('Name'),array('type'=>'text','class'=>'inputbox','id'=>'Name','maxlength'=>50,'value'=>stripslashes($Name))); ?>
								</tr>
							<tr>
								<td width="30%" align="right" valign="top" class="blackbold">
								Page Title :<span class="red">*</span></td>
								 <td   align="left" >
                               <?php 
 $Title = (!empty($arryPages->Title))?($arryPages->Title):('');
echo $FormHelper->input(__('Title'),array('type'=>'text','class'=>'inputbox','id'=>'Title','maxlength'=>50,'value'=>stripslashes($Title)));?>
								</tr>
							<tr>
								<td width="30%" align="right" valign="top" class="blackbold">
...
echo $FormHelper->input(__('MetaDescription'),array('type'=>'textarea','class'=>'','id'=>'MetaDescription','value'=>stripslashes($MetaDescription)));?>
							...
							<tr>
<?php $Status = (!empty($arryPages->Status))?($arryPages->Status):(''); ?>
								<td align="right" valign="middle" class="blackbold">Status :</td>
								<td align="left" class="blacknormal" value="<?php echo $Status;?> " >
 ...
 <?php $Image = (!empty($arryPages->Image))?($arryPages->Image):(''); ?>
		...
		$Template = (!empty($arryPages->Template))?($arryPages->Template):('');			
							...
							<tr>
<?php $page_content = (!empty($arryPages->page_content))?($arryPages->page_content):(''); ?>
			...
			<tr>
				...
				<? if ($_GET['edit'] > 0) {
					...
					$ButtonTitle = 'Submit';
				} ?> <input type="hidden" name="id" id="id" value="<? if(isset($id)) echo $id; ?>" /> <input
