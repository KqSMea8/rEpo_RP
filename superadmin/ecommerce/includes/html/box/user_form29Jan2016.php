...
<table width="97%" border="0" align="center" cellpadding="0"
	...
	<tr>
		...
		<table width="80%" border="0" cellpadding="5" cellspacing="0" class="borderall">
                    <tr>
                            <td colspan="2" align="left" class="head">Company Details Details</td>
                    </tr>
                     <tr>
                            <td align="right" class="blackbold">CompanyName :<span class="red">*</span></td>
                            <td align="left"><?php echo $FormHelper->input(__('companyName'), array('type' => 'text', 'class' => 'inputbox', 'id' => 'companyName', 'maxlength' => 50, 'value' => stripslashes($arryUser->userFname)));
                            ?></td>
                    </tr>
                    <tr>
                            <td align="right" class="blackbold">DisplayName :<span class="red">*</span></td>
                            <td align="left"><?php echo $FormHelper->input(__('displayName'), array('type' => 'text', 'class' => 'inputbox', 'id' => 'displayName', 'maxlength' => 50, 'value' => stripslashes($arryUser->userFname)));
                            ?></td>
                    </tr>
                    <tr>
                            <td align="right" class="blackbold">FirstName :<span class="red">*</span></td>
                            <td align="left"><?php echo $FormHelper->input(__('userFname'), array('type' => 'text', 'class' => 'inputbox', 'id' => 'userFname', 'maxlength' => 50, 'value' => stripslashes($arryUser->userFname)));
                            ?></td>
                    </tr>
                    ...
                    <tr>
                            ...
                            <td align="left"><?php echo $FormHelper->input(__('userContacts'), array('type' => 'text', 'class' => 'inputbox', 'id' => 'userContacts', 'maxlength' => 50, 'value' => stripslashes($arryUser->userContacts)));
                            ?></td>
                    </tr>
                    ...
                    <tr>
                            <td align="right" class="blackbold" valign="top">Address :<span
                                    class="red">*</span></td>
                            <td align="left"><?php echo $FormHelper->input(__('userAddress'), array('type' => 'textarea', 'class' => '', 'id' => 'userAddress', 'maxlength' => 50, 'value' => stripslashes($arryUser->userAddress)));
                            ?></td>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <?php echo $FormHelper->input(__('allow_user'), array('type' => 'select', 'options'=>array('restaurant'=>'Restaurant','jewellry'=>'Jewellry','garments'=>'Garments','furniture'=>'Furniture', 'printing'=>'Printing Graphics'), 'class' => 'inputbox', 'id' => 'allow_user', 'maxlength' => 50, 'selected'=>$arryElement->voucher_type));?>
                        </td>
                    </tr>
                    <!-------------------------------------------------------------------->
                    <tr>
