...
<div id="footer" class="footer-container clearfix" <?= $FooterStyle ?>>
    <div class="footer">
        <div class="copyright">Copyright &copy; <?= $Config['SiteName'] ?>. All Rights Reserved. <br />Powered By: <span><a href="http://www.virtualstacks.com" target="_blank">Virtual Stacks</a></span></div>
    </div>
</div>
