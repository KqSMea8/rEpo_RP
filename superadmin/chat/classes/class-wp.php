<?php
/**
 * Eznetchat environment setup class.
 *
 * @package Eznetchat
 * @since 2.0.0
 */
class WP {
	...
	/**
	 * Query variables for setting up the Eznetchat Query Loop.
	 *
	 * @since 2.0.0
	 * @var array
	 */
	...
	/**
	 * Parse request to find correct Eznetchat query.
	 *
	...
	public function parse_request($extra_query_vars = '') {
		 ...
		 * @param WP           $this             Current Eznetchat environment instance.
		 ...
		 * @since 2.1.0
		 *
		 * @param WP &$this Current Eznetchat environment instance (passed by reference).
		 */
	...
	/**
	 * Set up the Eznetchat Globals.
	 *
	 * The query_vars property will be extracted to the GLOBALS. So care should
	 * be taken when naming global variables that might interfere with the
	 * Eznetchat environment.
	 *
	...
	/**
	 * Sets up all of the variables required by the Eznetchat environment.
	 *
	...
	public function main($query_args = '') {
		...
		/**
		 * Fires once the Eznetchat environment has been set up.
		 *
		 * @since 2.1.0
		 *
		 * @param WP &$this Current Eznetchat environment instance (passed by reference).
