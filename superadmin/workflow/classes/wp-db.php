...
<p>If you don\'t know how to set up a database you should <strong>contact your host</strong>. If all else fails you may find help at the <a href="https://Workflow.org/support/">Workflow Support Forums</a>.</p>' ), htmlspecialchars( $db, ENT_QUOTES ), htmlspecialchars( $this->dbuser, ENT_QUOTES ) ), 'db_select_fail' );
			}
			return;
		}
	}
	...
	public function print_error( $str = '' ) {
		...
		// If there is an error then take note of it
			...
			print "<div id='error'>
			<p class='wpdberror'><strong>workflow database error:</strong> [$str]<br />
			<code>$query</code></p>
			</div>";
...
<p>If you're unsure what these terms mean you should probably contact your host. If you still need help you can always visit the <a href='#'>Workflow Support Forums</a>.</p>
...
<p>If you're unsure what these terms mean you should probably contact your host. If you still need help you can always visit the <a href='https://wordpress.org/support/'>Workflow Support Forums</a>.</p>
" ), htmlspecialchars( $this->dbhost, ENT_QUOTES ) ), 'db_connect_fail' );
   ...
   //die;
	 ...
	 *
	 * Called when Workflow is generating the table scheme.
	 *
	 * @since 2.5.0
	 * @deprecated 3.5.0
