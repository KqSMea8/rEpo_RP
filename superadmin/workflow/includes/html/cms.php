        ...
        <td>
            ...
            <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
                <tr>
                    ...
                    <td width="39%" align="right"> <a href="cms_pageAdd.php" class="add">Add New Page</a> <a href="index.php" class="back">Back</a>      </td>
                </tr>
                ...
                <?php foreach ($arryPages as $values) {  ?>
                        ...
                        ?>
                            ...
                            <td height="26" align="right"  valign="top">
                                ...
                                <a href="cms_delete.php?del_id=<?php echo $values->id; ?>" class="Blue" ><?= $delete ?></a>              
                                &nbsp;
                            </td>
                        </tr>
                    <?php } // foreach end //?>
