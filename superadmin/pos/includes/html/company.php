	...
	<tr>
     ...
     <td width="12%" class="head1" >Display Name</td>
      <td width="10%" class="head1" >Image</td> -->
	            ...
	            <td width="10%" class="head1" >Company Type</td>
			...
			<tr align="left" bgcolor="<?=$bgcolor?>">
				...
				<td><a
					href="companyvendor.php?cmp=<?=$values['CmpID']?>" class="fancybox action_bt fancybox.iframe"><?=$values["totalvendor"]?></a></td>
				<td><?php  if($values['companyType']=="posdealer"){  echo  "POS"; } else{ echo  "General"; }  ?></td>
				<td align="center"><? 
				if($values['Status'] ==1){
			  $status = 'Active';
				}else{
