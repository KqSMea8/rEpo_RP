...
<input type="submit" name="submit"  value="Submit"  />
 ...
 <!-------------------------- end Search  ------------------------------>
            <table <?=$table_bg?>>
                ...
                <tr align="left">
                        <td width="15%" class="head1">Package</td>
                       <!-- <td width="15%" class="head1">Package Id</td>-->
                        <td class="head1" width="8%">Amount</td>
                        <td width="6%" align="center" class="head1">Expire Date</td>
                </tr>
                ...
                <tr align="left" bgcolor="<?=$bgcolor?>">
                        <td height="50"><strong><?=stripslashes($values->pckg_name);?></strong></td>
                       <!-- <td><?=$values->package_id;?></td>-->
