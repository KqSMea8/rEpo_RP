...
echo $FormHelper->input(__('pckg_price'), array('type' => 'text', 'class' => 'inputbox', 'id' => 'pckg_price', 'maxlength' => 50, 'value' => stripslashes($pckg_price))); ?>
				...
				if($type=='select'){
				 ...
				 $element_slug = (!empty($arryElem->element_slug))?($arryElem->element_slug):('');
				if(!isset($tempdata[$element_slug])) $tempdata[$element_slug]='';

				$elementarray['checked']=explode(',',$tempdata[$element_slug]);
				...
				if(!isset($tempdata[$element_slug])) $tempdata[$element_slug]='';
                                  ...
                                  $elementarray['value']=$tempdata[$element_slug];                        
                            }
