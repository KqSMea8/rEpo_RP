...
<p>If you don\'t know how to set up a database you should <strong>contact your host</strong>. If all else fails you may find help at the <a href="https://wordpress.org/support/">WordPress Support Forums</a>.</p>' ), htmlspecialchars( $db, ENT_QUOTES ), htmlspecialchars( $this->dbuser, ENT_QUOTES ) ), 'db_select_fail' );
	...
	public function db_connect( $allow_bail = true ) {
                ...
                //$this->dbh = $Config['DbHost'];
                //$this->dbuser = mydecrypt($Config['DbUser']);
		//$this->dbpassword = mydecrypt($Config['DbPassword']);
		...
		if ( $this->use_mysqli ) {
			...
			if ( WP_DEBUG ) {
			//echo "<pre>";print_r($this);echo"hhhhhhhhhhhhh";exit;
		...
		//echo "<pre>";print_r($Config);echo"hhhhhhhhhhhhh";exit;
			if ( WP_DEBUG ) {
...
" ), htmlspecialchars( $this->dbhost, ENT_QUOTES ) ), 'db_connect_fail' );
	...
	public function update( $table, $data, $where, $format = null, $where_format = null ) { 
		...
		//echo $this->prepare( $sql, array_merge( array_values( $data ), array_values( $where ) ) );die;
