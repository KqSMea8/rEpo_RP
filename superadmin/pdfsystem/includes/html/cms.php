        ...
        <td>
            ...
            <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
                <tr>
                    ...
                    <div align="right"><a href="index.php" class="back">Back</a>&nbsp;
				</div>    </td>
                </tr>
            ...
            <table <?= $table_bg ?>>
                ...
                <?php foreach ($arryPages as $values) {  ?>
                        ...
                        ?>
                            ...
                            <td height="26" align="right"  valign="top" class="head1_inner">
                                <a href="cms_pageAdd.php?edit=<?php echo $values->id; ?>" class="Blue"><?= $edit ?></a>
                                <a href="cms_delete.php?del_id=<?php echo $values->id; ?>" class="Blue" onclick = "return confirm_delete();" ><?= $delete ?></a>              
                                &nbsp;
                            </td>
                        </tr>
                    <?php } // foreach end //?>
...
{
	return confirm("Are You Sure Delete This Cms Page");
}
</script>
