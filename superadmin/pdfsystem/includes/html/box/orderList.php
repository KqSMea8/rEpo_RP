...
<div class="mid-continent borderall" id="inner_mid" style="text-align: center; margin-left: 10%; width: 80%;">	      
        <tr>
...
<!--                            <td width=""><a id="download" class="fancybox add_quick fancybox.iframe" href="login.php">Download</a></td>-->
                            ...
                            if (is_array($arryOrder) ) {  //print_r($arryOrder); die('asasas');
                                $flag = true;
                                $Line = 0;
                                $sn = 0;
                                ...
                                foreach ($arryOrder as $key => $values) {
                                   ...
                                   // $values = get_object_vars($values);
                                    ...
                                    <tr align="left" bgcolor="<?= $bgcolor ?>" data-id="<?= $values['id'] ?>"  data-status="<?= $values['status']; ?>" >
                                       ...
                                       <td height="50"><strong><a  class="fancybox fancybox.iframe" href="viewCustomer.php?id=<?php echo $values['id'] ?> && userId=<?php echo $values['userId'] ?>"><?php echo $values['user'] ?></a></strong></td>
...
<!--                                      <td height="50"><?php echo  $values['author'] ; ?></td>-->
                            ...
                            <tr>
                                <td colspan="10">Total Record(s) : &nbsp;<?php echo $numorder; ?> <?php if (count($arryOrder) > 0) { ?>
                                        &nbsp;&nbsp;&nbsp; Page(s) :&nbsp; <?php
                                        //echo $pagerLinkorder;
                                    }
                                    ?></td>
