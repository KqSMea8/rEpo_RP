...
(empty($midStyle))?($midStyle=""):("");
(empty($innermidNum))?($innermidNum=""):("");
...
<TITLE><?= $Config['SiteName'] ?> &raquo; Pdf System Panel</TITLE>
<META HTTP-EQUIV="Content-Type" CONTENT="text/html; charset=iso-8859-1">
<link href="../../<?= $Config['AdminCSS'] ?>" rel="stylesheet"
	type="text/css">
<link href="../../<?= $Config['AdminCSS2'] ?>" rel="stylesheet"
	type="text/css"><?php if($Config['Online']==1){ ?> <!-- <link href='http://fonts.googleapis.com/css?family=Lato' rel='stylesheet' type='text/css'>-->
<?php } ?> <!-- <link rel="stylesheet" type="text/css" href="../fancybox/source/jquery.fancybox.css?v=2.1.5" media="screen" />
                    ...
                    </script>--> <!--<link rel="stylesheet" href="../fancybox/jquery_calender/jquery-ui.css" />-->
...
<ul>
	...
	<li class="chpassword"><a href="../changePassword.php"><span>Change
	Password</span></a></li>
	<? } ?>
...
require_once("includes/menu.php"); ?> <?php
...
<div id="mid" class="main" <?= $midStyle ?>><? 	//require_once("left.php"); ?>
<?php if($InnerPage==1){
echo '<div class="mid-continent'.$innermidNum.'" id="inner_mid"  style="width:80%;">';
} ?>
