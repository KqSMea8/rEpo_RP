    ...
    unset($_SESSION['mess_Page']);
            ...
            <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
                <tr>
                    ...
                    <td width="39%" align="right"> <a href="ErpPageAdd.php" class="add">Add New Page</a>      </td>
                </tr>
            ...
            <table <?= $table_bg ?>>
                <tr align="left" >
                    ...
                    <td width="10%" height="20"  class="head1" align="center">Slug</td> 
                       <td  width="10%" height="20"  class="head1" align="center">Menu Order</td>
                ...
                if (is_array($arryPages) && $num > 0) {
                    ...
                    foreach ($arryPages as $key => $values) {
                        ...
                        echo '<a href="ErpPageAdd.php?active_id=' . $values["id"] . '&curP=' . $_GET["curP"] . '" class="' . $status . '">' . $status . '</a>';
                        ?>
                            </td>
                            <td height="26" align="right"  valign="top">
                                <a href="ErpPageAdd.php?edit=<?php echo $values['id']; ?>&curP=<?php echo $_GET['curP']; ?>" class="Blue"><?= $edit ?></a>
                                <!--a href="ErpPageAdd.php?del_id=<?php echo $values['id']; ?>&curP=<?php echo $_GET['curP']; ?>" onclick="return confDel('<?= $cat_title ?>')" class="Blue" ><?= $delete ?></a-->              
                                &nbsp;
                            </td>
                        </tr>
                    <?php } // foreach end //?>
...
<?php if (count($arryPages) > 0) { ?>&nbsp;&nbsp;&nbsp;     Page(s) :&nbsp; <?php echo $pagerLink;
} ?>       
                    </td>
                </tr>
            </table>
