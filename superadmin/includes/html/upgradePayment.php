...
<?php if($_POST['TotalAmount']!=0){?>
						...
						<tr>
							...
							<td align="left"><input type="text" class="inputbox"
								maxlength="128" size="60"
								value="<?php if(isset($_SESSION['CrmAdminEmail']))echo $_SESSION['CrmAdminEmail'];?>"
...
if(!isset($arrayOrderInfo[0]['cc_expiration_month'])) 
	$arrayOrderInfo[0]['cc_expiration_month']='';
...
if(!isset($arrayOrderInfo[0]['cc_expiration_year'])) 
	$arrayOrderInfo[0]['cc_expiration_year']='';
