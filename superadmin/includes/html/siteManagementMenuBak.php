<ul class="site-cl">
	...
	<li><a href="headerMenu.php">Menu Management</a>
	...
	<!--  <li><a href="packegeManagement.php">Package Management</a> -->
	 <li><a href="managePackages.php">Package Management</a>
	  <!--  
		<ul>
	...
	<li><a href="manageCoupons.php">Coupon</a></li>
    <li><a href="upgradePackages.php">Upgrade Packages</a></li>
    
    <li><a href="paymentHistory.php">Order History</a></li>
