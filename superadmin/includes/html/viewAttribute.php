...
<a href="editAttribute.php?att=<?=$_GET['att']?>"  class="add">Add <?=$ModuleName?></a>
...
?></td>
      <td  align="center" class="head1_inner" ><a href="editAttribute.php?edit=<?php echo $values['value_id'];?>&amp;curP=<?php echo $_GET['curP'];?>&att=<?=$_GET['att']?>" ><?=$edit?></a>
