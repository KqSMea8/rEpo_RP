...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    unset($_SESSION['mess_Page']);
            ...
            <table <?= $table_bg ?>>
                <tr align="left" >
                    <td width="20%" height="20"  class="head1">Tag & Title</td> 
...
<?
if(IsFileExist($Config['SiteIconDir'],$values['Icon'])){ 

	$PreviewArray['Folder'] = $Config['SiteIconDir'];
	$PreviewArray['FileName'] = $values['Icon']; 
	$PreviewArray['FileTitle'] = stripslashes($values['Icon']);
...
&nbsp;&nbsp;
                                ...
                                <a href="footerSocialLinks.php?del_id=<?php echo $values['id']; ?>&curP=<?php echo $_GET['curP']; ?>" onclick="return confDel('Record')" class="Blue" ><?= $delete ?></a>              
                                &nbsp; 
                            </td>
                        </tr>
                    <?php } // foreach end //?>
