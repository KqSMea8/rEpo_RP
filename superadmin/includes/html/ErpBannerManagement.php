...
<?php if(!empty($_SESSION['mess_banner'])) {echo $_SESSION['mess_banner']; unset($_SESSION['mess_banner']); }?>
</div>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        <td>
            <div class="message">
            <?php if (!empty($_SESSION['mess_Page'])) {
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                <tr>
                    ...
                    <td width="39%" align="right">
                        <a href="ErpBannerAdd.php" class="add">Add New Banner</a>
                    </td>
                </tr>
            </table>
            ...
            <table <?= $table_bg ?>>
                <tr align="left">
                    <td width="15%" height="20" class="head1">Title & Tag</td>
                ...
                (count($arryPages) > 0) ? ($arryPages = $objPager->getPageRecords()) : ("");
                ...
                <tr align="left" bgcolor="<?= $bgcolor ?>">
                    ...
                    <td height="26" align="center">
                        <img border="0" src="../resizeimage.php?w=100&amp;h=100&amp;img=ezneterp/images/<?= $values['Image']; ?>"/>
                    </td>
                    <td align="center"><?php
                        ...
                        echo '<a href="ErpBannerAdd.php?active_id=' . $values["id"] . '&curP=' . $_GET["curP"] . '" class="' . $status . '">' . $status . '</a>';
                        ?>
                    </td>
                    <td height="26" align="right" valign="top">
                        <a href="ErpBannerAdd.php?edit=<?php echo $values['id']; ?>&curP=<?php echo $_GET['curP']; ?>"
                            class="Blue"><?= $edit ?> </a> 
                        <a href="ErpBannerAdd.php?del_id=<?php echo $values['id']; ?>&curP=<?php echo $_GET['curP']; ?>"
                            onclick="return confDel('Record')" class="Blue"><?= $delete ?></a> &nbsp;
                    </td>
                </tr>
                <?php } // foreach end //?>
                <?php } else { ?>
