...
<TABLE WIDTH="100%"   BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0 >
	<tr>
		...
		<a href="addServer.php" class="add">Add Server</a></td>
      </tr>
	<tr>
	  <td  valign="top">
...
?>
	...
	<td height="50"><a href="editCompany.php?edit=<?=$values->id;?>&curP=<?=$_GET['curP']?>" ><strong><?=stripslashes($values->server_name)?></strong></a></td>
