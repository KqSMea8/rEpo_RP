...
function validate_company(frm){
	if(!ValidateForSimpleBlank(frm.SecurityCode, "Security Code.")){
		return false;
	}
...
<form name="form1" action=""  method="post" onSubmit="return validate_company(this);" enctype="multipart/form-data">
...
<ul style="line-height:25px;">
	...
	<li <?=in_array("1",$arrCmpDept)?(""):('style="display:none"')?>> <?=MOD_HRMS?> <br></li>
		
	<li <?=in_array("5",$arrCmpDept)?(""):('style="display:none"')?>> <?=MOD_CRM?> <br></li>

	<li <?=in_array("2",$arrCmpDept)?(""):('style="display:none"')?>> <?=MOD_ECOMMERCE?> <br></li>

	<li <?=in_array("6",$arrCmpDept)?(""):('style="display:none"')?>> <?=MOD_INVENTORY?> <br></li>

	<li <?=in_array("9",$arrCmpDept)?(""):('style="display:none"')?>> <?=MOD_WEBSITE?> <br></li>

	<li <?=in_array("12",$arrCmpDept)?(""):('style="display:none"')?>> <?=MOD_POS?> <br></li>
</ul>
...
<? //HRMS
$HrmsFlag='';
if($arryCompany[0]['Department']=="" || in_array("1",$arrCmpDept)) { 
...
<? //CRM
if($arryCompany[0]['Department']=="" || in_array("5",$arrCmpDept)) { 
...
<? //ECOMMERCE
if($arryCompany[0]['Department']=="" || in_array("2",$arrCmpDept)) { 
...
<? //POS
if($arryCompany[0]['Department']=="" || in_array("12",$arrCmpDept)) { 
	$NumVendor = $objConfigure->NumPosVendor();
	//$NumOrder = $objConfigure->NumPosOrder();
	$NumOrder=0;
?>
<tr>
	 <td colspan="4" align="left" class="head"><?=MOD_POS?> Data Count</td>
</tr>
<tr>
	<td  align="right" width="20%">  Vendor : </td>
	<td  align="left" width="30%">
	<?=$NumVendor?>
	</td>
...
<? //INVENTORY
if($arryCompany[0]['Department']=="" || in_array("6",$arrCmpDept)) { 
...
<tr>
        <td  align="center"   class="blackbold" > <strong>Enter Security Code : </strong>
	<input name="SecurityCode" type="password" class="inputbox" id="SecurityCode" value=""  maxlength="50" autocomplete="off" /> 
&nbsp; &nbsp; 
