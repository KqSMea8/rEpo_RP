...
function validate_reseller(frm){
	if(confirm("Are you sure you want to permanently delete this reseller?")){
		return true;
	}else{
		return false;
	}
...
<form name="form1" action="<?=$ActionUrl?>"  method="post" onSubmit="return validate_reseller(this);" enctype="multipart/form-data">
...
<tr>
	 <td colspan="4" align="left" class="head">Reseller Admin Details</td>
</tr>
<tr>
        <td  align="right"   class="blackbold" width="20%"> Reseller Name  : </td>
        <td   align="left" width="30%">
<?php echo stripslashes($arryReseller[0]['FullName']); ?>          </td>
      
        <td  align="right"   class="blackbold" width="20%"> Display Name  : </td>
        <td   align="left" >

<?=stripslashes($arryReseller[0]['DisplayName'])?>
 ...
 <td  align="left">
<?php echo $arryReseller[0]['Email']; ?>
</td>

	 <td  align="right"   class="blackbold" >Status  : </td>
        <td   align="left"  >
          <? 	 if($arryReseller[0]['Status'] ==1){
			  $status = 'Active';
		 }else{
			  $status = 'InActive';
		 }
...
<ul style="line-height:25px;">
	<li <?=($arryReseller[0]['Department']=="")?(''):('style="display:none"')?>> <?=MOD_ERP?> <br></li>

	<li <?=substr_count($arryReseller[0]['Department'],"1")?(''):('style="display:none"')?>> <?=MOD_HRMS?> <br></li>
		
	<li <?=substr_count($arryReseller[0]['Department'],"5")?(''):('style="display:none"')?>> <?=MOD_CRM?> <br></li>

	<li <?=substr_count($arryReseller[0]['Department'],"2")?(''):('style="display:none"')?>> <?=MOD_ECOMMERCE?> <br></li>

	<li <?=substr_count($arryReseller[0]['Department'],"3,4,6,7,8")?(''):('style="display:none"')?>> <?=MOD_INVENTORY?> <br></li>
</ul>
...
<td></td>
<td valign="top">
<? if($arryReseller[0]['Image'] !='' && file_exists('../upload/reseller/'.$arryReseller[0]['Image']) ){ ?>

<a href="../upload/reseller/<?=$arryReseller[0]['Image']?>" class="fancybox" data-fancybox-group="gallery"  title="<?=stripslashes($arryReseller[0]["FullName"])?>" ><? echo '<img src="../resizeimage.php?w=150&h=150&img=upload/reseller/'.$arryReseller[0]['Image'].'" border=0 >';?></a>
<?	} ?>
</td>
...
<? //HRMS
if($arryReseller[0]['Department']=="" || substr_count($arryReseller[0]['Department'],"1")) { 
...
<? //CRM
if($arryReseller[0]['Department']=="" || substr_count($arryReseller[0]['Department'],"5")) { 
...
<? //ECOMMERCE
if($arryReseller[0]['Department']=="" || substr_count($arryReseller[0]['Department'],"2")) { 
...
<? //INVENTORY
if($arryReseller[0]['Department']=="" || substr_count($arryReseller[0]['Department'],"3,4,6,7,8")) { 
...
<input type="hidden" name="RsID" id="RsID" value="<?=$RsID?>" />
