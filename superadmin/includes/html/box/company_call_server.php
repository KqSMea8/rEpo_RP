	  ...
	  <td  valign="top"><form action="" method="POST">
		<table width="100%" cellspacing="0" cellpadding="5" border="0"
			...
			<tr>
				...
				<td valign="top" align="left">
				<input type="hidden" value="<?php echo !empty($settingArray[0]->server_id)?$settingArray[0]->server_id:'';?>" name="old_server">
				...
				<input type="submit" name="CallServerUpdate" value="Save" class="button">
			</td>
			</tr>
		</table>
