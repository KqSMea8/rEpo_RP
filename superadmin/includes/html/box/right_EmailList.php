            ...
            <div class="sel-wrap">
                <select name="sortby" id="sortby" class="textbox">
                    <option value=""> All </option>
                     ...
                     <option value="CompanyName" <? if ($_GET['sortby'] == 'CompanyName') echo 'selected'; ?>>Company Name </option> 
                     <option value="CmpID" <? if ($_GET['sortby'] == 'CmpID') echo 'selected'; ?>>Company ID </option>  
                     <option value="DisplayName" <? if ($_GET['sortby'] == 'DisplayName') echo 'selected'; ?>>Display Name </option>  
