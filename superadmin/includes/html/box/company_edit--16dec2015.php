...
<label <?=$HideModule?>><input type="checkbox" name="Department[]" id="Department5" value="9" <?=substr_count($arryCompany[0]['Department'],"9")?("checked"):("")?> onclick="Javascript:SetModuleOff(); SetDomain();" /> <?=MOD_WEBSITE?> <br></label>
