	...
	<tr>
	 ...
	 <span id="MsgSpan_Email"></span>		</td>
        ...
        <td   align="left" class="blacknormal">
            <input name="Password" type="Password" class="inputbox" id="Password" value="<?php echo stripslashes($arryReseller[0]['Password']); ?>"  maxlength="15" />
            <span class="passmsg"><?=$MSG[150]?></span>
