    ...
    unset($_SESSION['mess_Page']);
            ...
            <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
                <tr>
                    ...
                    <td width="39%" align="right"> <a href="ErpAddCoupons.php" class="add">Add Coupon</a>      </td>
                </tr>
            ...
            <table <?= $table_bg ?>>
                ...
                if (is_array($arryPages) && $num > 0) {
                    ...
                    foreach ($arryPages as $key => $values) {
                        ...
                        echo '<a href="ErpAddCoupons.php?active_id=' . $values["id"] . '&curP=' . $_GET["curP"] . '" class="' . $status . '">' . $status . '</a>';
                        ?>
                            </td>
                            <td height="26" align="center"  valign="top">
                                <a href="ErpAddCoupons.php?edit=<?php echo $values['id']; ?>&curP=<?php echo $_GET['curP']; ?>" class="Blue"><?= $edit ?></a>
                                <a href="ErpAddCoupons.php?del_id=<?php echo $values['id']; ?>&curP=<?php echo $_GET['curP']; ?>" onclick="return confDel('Record')" class="Blue" ><?= $delete ?></a>              
                                &nbsp;
                            </td>
                        </tr>
                    <?php } // foreach end //?>
