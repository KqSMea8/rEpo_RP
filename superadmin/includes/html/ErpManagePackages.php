                ...
                if (is_array($arryPages) && $num > 0) {
                    ...
                    foreach ($arryPages as $key => $values) {
                        ...
                        <tr align="left"  bgcolor="<?= $bgcolor ?>">
                            ...
                            <td height="26"><? if(isset($values['type'])) echo $values['type']; ?></td>
                        ...
                        ?>
                            ...
                            <td height="26" align="center"  valign="top">
                                <a href="ErpPackages.php?edit=<?php echo $values['id']; ?>&curP=<?php echo $_GET['curP']; ?>" class="Blue"><?= $edit ?></a>
                                <!--  <a href="packages.php?del_id=<?php echo $values['id']; ?>&curP=<?php echo $_GET['curP']; ?>" onclick="return confDel('Record')" class="Blue" ><?= $delete ?></a> -->          
                                &nbsp;
                            </td>
                        </tr>
                    <?php } // foreach end //?>
