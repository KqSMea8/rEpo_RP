...
$viewAll = 'paymentHistory.php';
include('siteManagementMenu.php');
...
<?
	...
	$FreeUrl = 'paymentHistory.php?mode=Free';	
	$PaidUrl = 'paymentHistory.php?mode=Paids';	
?>
		...
		<td>
			...
			<table <?= $table_bg ?>>
				...
				<tr align="left" bgcolor="<?= $bgcolor ?>">
					...
					<a href="paymentHistory.php?del_id=<?php echo $values['OrderID']; ?>&curP=<?php echo $_GET['curP']; ?>"
				...
				<?php } else { ?>
				<tr align="center">
					<td height="20" colspan="10" class="no_record">No record found.</td>
				</tr>
				<?php } ?>
