...
<TABLE WIDTH="100%"   BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0 >
	...
	<form name="frmSrch" id="frmSrch" action="cmpListdatabase.php" method="get" onSubmit="return ResetSearch();">
...
<tr>
 ...
 <input type="submit" class="button" name="DATABASE" id="DATABASE" value="Create Database" style="font-weight: normal; height: 22px;">
