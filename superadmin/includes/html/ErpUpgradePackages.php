...
<tr>
<td align="left" >
	<a href="ErpCmpList.php?link=ErpViewPackageLog.php" class="fancybox action_bt fancybox.iframe" class="action_bt">Select Company</a></td>
</tr>
...
<?
	...
	$OnlineUrl = 'ErpViewPackageLog.php?cmp='.$CmpID.'&mode=online';	
	$OfflineUrl = 'ErpViewPackageLog.php?cmp='.$CmpID.'&mode=offline';	
?>
...
<? if($num>0){ ?>
<a class="fancybox action_bt fancybox.iframe" href="ErpDeleteUserLog.php?cmp=<?=$CmpID?>"  class="action_bt" style="float:right">Delete User Log</a>
<? }?>	
