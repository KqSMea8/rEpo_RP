							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0"
								...
								<tr>
									<td align="center" valign="top"><table width="100%" border="0"
											...
											<tr>
												<td width="30%" align="right" valign="top" class="blackbold">
													Image Text :<span class="red">*</span>
												</td>
												<td width="56%" align="left" valign="top"><textarea
													name="Text" id="Title"
													value=""
													class="inputbox" size="50"> <? if(isset($arryPage[0]['Text'])) echo stripslashes($arryPage[0]['Text']); ?> </textarea>
												</td>
											</tr>
											...
											<tr>
												...
												<td height="40" align="left" valign="top"
													...
													onselectstart="return false" />&nbsp;<?=$MSG[201]?> <? if(!empty($arryPage[0]['Image']) && file_exists('../images/'.$arryPage[0]['Image']) ){ ?>
