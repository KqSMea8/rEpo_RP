...
function ChangePage(){
	ShowHideLoader('1','S');
	var SendUrl = 'emailTemplate.php?cat='+document.getElementById("cat").value;
...
//-->
	...
	<tr>
		...
		<input name="Submit" type="submit" class="button" value="Update" /> <input
			...
			value="<?=$arrayContents[0]['TemplateID']?>" /> <input type="hidden"
			name="EmpID" id="EmpID" value="<?=$_GET['EmpID']?>" /></td>
	</tr>
