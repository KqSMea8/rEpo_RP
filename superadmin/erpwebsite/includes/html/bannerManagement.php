            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                <tr>
                    ...
                    <td width="39%" align="right">
                        <a href="bannerAdd.php" class="add">Add New Banner</a>
                    </td>
                </tr>
            </table>
            ...
            <table <?= $table_bg ?>>
                ...
                <tr align="left" bgcolor="<?= $bgcolor ?>">
                    ...
                    <td height="26" align="right" valign="top">
                        <a href="bannerAdd.php?edit=<?php echo $values['id']; ?>&curP=<?php echo $_GET['curP']; ?>"
                            class="Blue"><?= $edit ?> </a> 
                        <a href="bannerAdd.php?del_id=<?php echo $values['id']; ?>&curP=<?php echo $_GET['curP']; ?>"
                            onclick="return confDel('<?= $cat_title ?>')" class="Blue"><?= $delete ?></a> &nbsp;
                    </td>
                </tr>
                <?php } // foreach end //?>
                <?php } else { ?>
