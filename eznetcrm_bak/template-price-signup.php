...
<div class="tryNow"><?php if(!empty($_SESSION['CrmDisplayName'])){?> <a
	href="index.php?slug=upgrade&pack_id=<?php echo $pricePackg['id'];?>">Upgrage
Now</a> <?php } else{ ?> <a href="index.php?slug=upgradeWTS&pack_id=<?php echo $pricePackg['id'];?>">Buy Now</a> <?php } ?>
</div>
