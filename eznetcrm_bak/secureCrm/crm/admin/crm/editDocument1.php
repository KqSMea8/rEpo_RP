<?php $FancyBox=1;
 /**************************************************/
	...
	require_once($Prefix."classes/group.class.php");
        require_once($Prefix."classes/upload.class.php");
	...
	if($_GET['parent_type']!='' && $_GET['parentID']!=''){
		...
		$EditUrl = "editDocument1.php?edit=".$_GET["edit"]."&module=".$_GET["module"]."&parent_type=".$_GET['parent_type']."&parentID=".$_GET['parentID']."&tab=Document&curP=".$_GET["curP"]; 
		$ActionUrl = $EditUrl;
		}else{
	...
	$EditUrl = "editDocument1.php?edit=".$_GET["edit"]."&module=".$_GET["module"]."&curP=".$_GET["curP"]; 
	$ActionUrl = $EditUrl;
   }
			...
			// } else {
				...
				if($ImageId){
				 ...
				 if($_FILES['FileName']['name'] != ''){
					...
					$_SESSION['mess_Document'] = $ErrorMsg;
