...
class territory extends dbClass
{
                ...
                function  GetSubTerritoryTree($ParentID,$num)
		{
			  ...
			  $query = "SELECT * FROM c_territory WHERE ParentID =".$ParentID;
                          //echo "=>".$query."<br>";
                ...
                function addTerritoryRule($arryDetails)
		{
            ...
            function getTerritoryByCountryID($country_id){
                 ...
                 $strSQLQuery = "select l.TRLID,l.country,t.Name,t.TerritoryID,r.TRID from c_territory_rule_location as l left outer join c_territory_rule as r on r.TRID = l.TRID left outer join c_territory as t on t.TerritoryID = r.TerritoryID where l.country = '".$country_id."'";
