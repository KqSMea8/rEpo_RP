                    ...
                    foreach ($arryFormFields as $key => $values) {
                        ...
                        ?>
                            ...
                            <td height="26" align="right"  valign="top">
                                ...
                                <a href="editFormField.php?del_id=<?php echo $values['FieldId']; ?>&curP=<?php echo $_GET['curP']; ?>&CustomerID=<?php echo  $_REQUEST['CustomerID'];?>" onclick="return confDel('<?= $values['Name'] ?>')" class="Blue" ><?= $delete ?></a>              
                                &nbsp;
                            </td>
                        </tr>
                    <?php } // foreach end //?>
