    ...
    if($values['fieldname'] == 'CustType'){
        ...
        if($arrayVal['CustType']=='c'){$flabel = 'Customer'; $cusVal = $CustomerName;}
            ...
            echo ''.$intr.'
                    ...
                    {   
                        echo ($CountryName)? $CountryName : '<span class="red">Not specified.</span>';
                        ...
                        {    
                            ...
                            }elseif($values['fieldname'] == 'closeDate'){ $sD = 'closeDate'; $sT = 'closeTime';        
                            }else{ $sD = 'CloseDate'; $sT = '';}
                    ...
                    {
                        if(!empty($arryContact[0]['AssignTo']) || !empty($arrayVal['assignedTo'])){
		...
		elseif($values['fieldname'] == 'Rating')
                    ...
                    elseif($values['fieldname'] == 'FileName'){
                            ...
                            { 		
                                echo '<div id="DocDiv">'.$document.'<br><a href="dwn.php?file='.$MainDir.$document.'" class="download">Download</a></div>';			
 ...
 //echo (!empty($arrayVal[$values['fieldname']]))?($arrayVal[$values['fieldname']]).' ['.$arrayVal[$values['fieldlabel']].': '.stripslashes($arrayVal[$values['fieldname']]]).']'):(NOT_SPECIFIED);
    ...
    {?>
        ...
        <tr>
                ...
                <td  align="left" colspan="2"  class="blacknormal"> <?=(!empty($StateName))?(stripslashes($StateName)):(NOT_SPECIFIED)?> </td>
              </tr>
