...
<tr align="left"  class="<?=$class?>">
	<td height="22" ><a class="fancybox fancybig fancybox.iframe" href="../userlogin/vQuote.php?view=<?=$values['quoteid']?>&module=Quote&pop=1" target="_blank"><?=stripslashes($values["subject"])?></a></td>
