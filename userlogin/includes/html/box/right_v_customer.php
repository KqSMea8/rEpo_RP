...
<?php 
	...
	foreach($permission as $k=>$menu){
		...
		<li <?=($_GET['tab']==$k)?("class='active'"):("");?>><?php echo $menu ?>
     	<ul>
     	<li><a href="viewMenus.php?CustomerID=<?php echo $Customer_ID;?>">Menu</a></li>
     	<li>Form
     	<ul>
     	<li><a href="viewForms.php?CustomerID=<?php echo $Customer_ID;?>">Form</a></li>
     	<li><a href="viewFormFields.php?CustomerID=<?php echo $Customer_ID;?>">Form Fields</a></li>
     	<li><a href="viewFormData.php?CustomerID=<?php echo $Customer_ID;?>">Customer Form Data</a></li>
     
     	</ul>
     	</li>
     	<li><a href="viewContents.php?CustomerID=<?php echo $Customer_ID;?>">Page</a></li>
     	<li><a href="template.php?CustomerID=<?php echo $Customer_ID;?>">Template</a></li>
     	<li><a href="setting.php?CustomerID=<?php echo $Customer_ID;?>">Global Setting</a></li>
     	</ul>
     </li>
		<?php }else{	
		?>
