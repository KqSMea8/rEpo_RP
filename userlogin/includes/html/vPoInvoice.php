...
<tr>
	 <td  align="left" class="head" ><?=RECEIVED_ITEM?>
             ...
             if($arryPurchase[0]['InvoiceEntry'] != 1){
             	...
             	?>
	<!-- <div style="float:right"><a class="fancybox hideprint fancybox.iframe" href="vPO.php?module=Order&pop=1&po=<?=$arryPurchase[0]['PurchaseID']?>" ><?=VIEW_ORDER_DETAIL?></a></div>-->
             <?php }?>
	...
	<td align="left" >
            <?php
                if($arryPurchase[0]['InvoiceEntry'] == 1){
                    ...
                    include(_ROOT."/admin/finance/includes/html/box/po_item_Invoice_Entry_view.php");
                }else{
                    include(_ROOT."/admin/finance/includes/html/box/po_item_invoice.php");
                }
            ?>
