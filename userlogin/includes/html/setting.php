                                    ...
                                    <td align="center" valign="top" ><table width="100%" border="0" cellpadding="5" cellspacing="1" >
															...
															<?php
 															foreach ($arryMenutype as $key => $values) { 
													 			echo '<td width="20" align="left" valign="middle">
																	...
																	elseif($arrySetting[0][$values['MenuType']] == "Yes")	echo "checked";
											 ...
											 <tr>
                                                ...
                                                <td width="56%"  align="left" valign="top">
                                                    <input  name="Sitename" id="Sitename" type="text" onKeyPress="Javascript:ClearAvail('MsgSpan_Sitename');" onBlur="Javascript:CheckAvailSiteName('MsgSpan_Sitename','Sitename','<?php echo $CustomerID;?>');" class="inputbox"  value="<?php echo $arrySetting[0]['Sitename'];?>" />
													<div id="MsgSpan_Sitename"></div>
													 <?php if($arrySetting[0]['Sitename']!=''){
...
<?php 
$Domain='';
                    if($_GET['CustomerID']!='' && $arrySetting[0]['Sitename']!=''){
...
function generatecode(){
	...
	<?php if($_GET['CustomerID']!='' && $arrySetting[0]['Sitename']==''){ 
		$Domain='http://'.$_SERVER['SERVER_NAME'].'/web/'.$_SESSION['DisplayName'].'/';
		?>
