...
<link rel="stylesheet" href="<?= _SiteUrl?>/userlogin/css/style.css" />
...
<script language="javascript" src="<?=$Prefix?>/userlogin/includes/sales.js"></script>
...
<div id="main_table_list" class="main-container <?=$clearfix?>">
	...
	<? if($InnerPage==1){ 
		$class="";
		if($ThisPageName=="viewCustomer.php" OR $ThisPageName=="dashboard.php")
		$class='three-four';
		echo '<div class="mid-continent '.$class.'" id="inner_mid">'; } ?>
