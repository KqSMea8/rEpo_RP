<?	require_once("../includes/pdf_comman.php");
	...
	$pdf->ezSetDy(-5);
    if($NumLine>0){
        $Head1 = '<b>SKU</b>'; $Head2 = '<b>Description</b>';$Head3 = '<b>Serial Number</b>'; $Head4 = '<b>Qty</b>'; $Head5 = '<b>Unit Price</b>'; $Head6 = '<b>Taxable</b>'; $Head7 = '<b>Amount</b>'; 
...
if(empty($arryPurchaseItem[$Count]['Taxable'])) $arryPurchaseItem[$Count]['Taxable']='No';
 ...
 $arryDef[$i][$Head3] = str_replace(",",", ",$arryPurchaseItem[$Count]["SerialNumbers"]);
        ...
        $pdf->ezTable($data,'','',array('cols'=>array($Head1=>array('justification'=>'left','width'=>'40'),$Head2=>array('justification'=>'left'),$Head3=>array('justification'=>'left','width'=>'90'),$Head4=>array('justification'=>'left','width'=>'90'),$Head5=>array('justification'=>'left','width'=>'40'),$Head7=>array('justification'=>'right','width'=>'80')), 'shaded'=>0,'shadeCol'=>array(0.9,0.9,0.9), 'showLines'=>2 , 'xPos' =>300 ,'width'=>500,'fontSize'=>8,'showHeadings'=>0, 'colGap'=>2, 'rowGap'=>2) );
