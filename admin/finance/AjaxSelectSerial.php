...
/*$('document').ready(function() {
    $('#ajaxSerial').load("AjaxSelectSerial.php?id=<?=$_GET['id']?>&cond=<?=$_GET['cond']?>&sku=<?=$_GET['sku']?>&WID=<?=$_GET['WID']?>&LineID=<?=$_GET['LineID']?>&total=<?=$_GET['total']?>&SerialValue=<?=$_GET['SerialValue']?>&MainSku=<?=$_GET['MainSku']?>");
});*/
