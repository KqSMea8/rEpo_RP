<?php 	
	...
	(empty($_GET['bytype']))?($_GET['bytype']=""):("");
	if(!empty($_GET['testpayments'])=='321#'){	

		//$objhostbill->updateInvoiceFee();
		//die;
		//$out=	$objhostbill->getTransactiondetail(694);	

//print_r($out);die;
	$objhostbill->GetTempHostbillPayment();
	die('sdfs');	
	}
	...
	$kk=addslashes($_GET['key']);
	$customers=$objCustomer->getCustomers(0,'Active',$kk,'','');
	//echo '<pre>';
