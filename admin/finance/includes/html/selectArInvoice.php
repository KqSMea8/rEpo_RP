...
function SetInvoiceID(InvoiceID){	 
	ResetSearch();
	window.parent.document.getElementById("InvoiceID").value=InvoiceID; 
	parent.jQuery.fancybox.close();
	 
}

</script>
<div class="had">Select Invoice</div>
...
<TABLE WIDTH="100%"   BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0 >
	...
	<form onsubmit="return ResetSearch();" method="get" action="selectArInvoice.php" id="frmSrch" name="frmSrch">
...
<table <?=$table_bg?>>
	...
	<tr align="left"  bgcolor="<?=$bgcolor?>">
			<td>
                      ...
                      <a href="Javascript:void(0)" onMouseover="ddrivetip('<?=CLICK_TO_SELECT?>', '','')"; onMouseout="hideddrivetip()" target="_parent" onclick="Javascript:SetInvoiceID('<?=$values["InvoiceID"]?>');">
			...
			<td align="center">	
			 <?		
					...
					if($InvoicePaid=='Unpaid' && $values['PaymentTerm']=='Credit Card' && ($values['OrderPaid']==1 || $values['OrderPaid']==4)){
						 $StatusCls = 'green';
