<? if($_GET['pop']!=1){ ?>
	...
	<div class="had">RMA <span>&raquo;	<?=$ModuleName?> Detail </span></div>
...
<tr>
	 ...
	 <div style="float:right"><a class="fancybox hideprint fancybox.iframe" href="vPORma.php?module=Order&pop=1&po=<?=$arryPurchase[0]['PurchaseID']?>" ><?=VIEW_ORDER_DETAIL?></a></div>
