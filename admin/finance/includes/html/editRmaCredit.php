...
<tr>
 ...
 <tr>
        <td align="right">RMA Action</td>
		 <td><select id="Module" class="inputbox" name="Module">
        <option value="Return" <?php if($arryPurchase[0]['Module']=='Return'){ echo "selected='selected'";}?>>Return</option>
        <option value="Credit"<?php if($arryPurchase[0]['Module']=='Credit'){ echo "selected='selected'";}?>>Credit</option>
        </select></td>
      </tr>
...
<tr>
	 <td align="left"><? include("includes/html/box/po_order_rma_view.php");?></td>
</tr>
<tr>
    <td>
...
<tr>
	 ...
	 <div style="float:right"><a class="fancybox fancybox.iframe" href="vPORma.php?module=Order&pop=1&po=<?=$po?>" ><?=VIEW_ORDER_DETAIL?></a></div>
...
<tr>
	<td align="left" >
		<? 	
	if(!empty($_GET['edit'])){
		include("includes/html/box/po_item_rma_view.php");
	}else{
