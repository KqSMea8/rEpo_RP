...
$("#sp").select2();
	...
	<tr>
	 ...
	 <? if($num>0){?>
	     ...
	     <input type="button" class="export_button"  name="exp" value="Export To Excel" onclick="Javascript:window.location='export_cust_bysalesperson.php?<?=$QueryString?>&module=Invoice';" />
