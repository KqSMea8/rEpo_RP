...
<select style="width: 220px;" name="CatID" class="inputbox" id="CatID" >
...
<tr>
	<td align="right" valign="top">
		...
		<input type="button" class="export_button"  name="exp" value="Export To Excel" onclick="Javascript:window.location='export_intrastat.php?<?=$QueryString?>&module=Invoice';" />
		<? } ?>
	</td>
</tr>
