...
var WID = "<?=$_GET['WID']?>";
var lineNumber = $("#lineNumber").val();
 		  var SendParam = 'action=SelectAllSerial&Sku='+Sku+'&Totalqty='+totalqty+'&condition='+condition+'&LineID='+LineID+'&WID='+WID+'&r=' + Math.random()+'&Condition='+condition;
...
//console.log(TotalUnit);
 		//console.log(responseText['Serial']);
													//var totalqty=jQuery('#totalQtyInvoced').val();
													//jQuery('#allSelectedSerialNumber').val('');
													//jQuery('#AvgCost').val(0);
													//jQuery('.order-qty').text(totalqty);
