...
window.parent.document.getElementById("SuppCompany").value=responseText["VendorName"];
...
if(window.parent.document.getElementById("Currency") != null){
	...
	$("#Currency", parent.document).find('option[value="'+responseText["Currency"]+'"]').prop('selected',true);//updated by chetan 25Feb//
}
if(window.parent.document.getElementById("AccountID") != null){
	window.parent.document.getElementById("AccountID").value=responseText["AccountID"]; 
	parent.$("#AccountID").select2();
}

		if(window.parent.document.getElementById("PaymentTerm") != null){
			parent.SelectPaymentTerm();
		}
