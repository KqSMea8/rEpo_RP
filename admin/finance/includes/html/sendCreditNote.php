...
<div id="preview_div">	
            ...
            <td align="left">
                ...
                <table width="100%" border="0" cellpadding="5" cellspacing="0" class="borderall">	 
                    ...
                    <tr>
                        ...
                        <td   align="left" ><B><?= stripslashes($arryCreditSale[0]['CreditID']) ?></B></td>
                    </tr>
                    <tr>
                        <td  align="right"   class="blackbold" width="20%"> Posted Date : </td>
                        <td   align="left" ><?= ($arryCreditSale[0]['PostedDate'] > 0) ? (date($Config['DateFormat'], strtotime($arryCreditSale[0]['PostedDate']))) : (NOT_SPECIFIED) ?></td>
                    </tr>
                    <tr>
                        <td  align="right"   class="blackbold" >Created By  : </td>
                        <td   align="left" >
                            <?
                            if($arryCreditSale[0]['AdminType'] == 'admin'){
                            $CreatedBy = 'Administrator';
                            }else{
                            $CreatedBy = '<a class="fancybox fancybox.iframe" href="../userInfo.php?view='.$arryCreditSale[0]['AdminID'].'" >'.stripslashes($arryCreditSale[0]['CreatedBy']).'</a>';
                            }
                            echo $CreatedBy;
                            ?></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td   align="left"  >
                            <?= ($arryCreditSale[0]['Approved'] == 1) ? ('<span class=green>Yes</span>') : ('<span class=red>No</span>') ?>
	...
	<tr>
                        ...
                        <td   align="left" >
                            <? 
                            if($arryCreditSale[0]['Status'] == 'Cancelled' || $arryCreditSale[0]['Status'] == 'Rejected'){
                            $StatusCls = 'red';
                            }else if($arryCreditSale[0]['Status'] == 'Completed'){
                            $StatusCls = 'green';
                            }else{
                            $StatusCls = '';
                            }

                            echo '<span class="'.$StatusCls.'">'.$arryCreditSale[0]['Status'].'</span>';
                    ...
                    <tr>
                        ...
                        <td   align="left" >
                            ...
                            <a class="fancybox fancybox.iframe" href="../custInfo.php?view=<?= $arryCreditSale[0]['CustCode'] ?>" ><?= stripslashes($arryCreditSale[0]['CustomerName']) ?></a>		</td>
                    </tr>
			  <tr>
                            ...
                            <tr>
                                ...
                                <td   align="left" >
                                    <select class="inputbox" name='tempidd' id="tempID" onchange='makepdffile("../pdfCommonhtml.php?o=<?= $_GET['view'] ?>&module=<?= $_GET['moduleu'] ?>&attachfile=1&ModuleDepName=<?= $ModuleDepName ?>")'>
                                         <?php //Added on 3May2018 by chetan for default dynamic temp//
					$dId = '';
