...
<table <?=$table_bg?>>
  ...
  ?>
    <tr align="left"  bgcolor="<?=$bgcolor?>">
       <td>
<a href="PoInvoiceList.php?key=<?=$values['PurchaseID']?>&link=payPurchaseInvoice.php" class="fancybox fancybox.iframe" onMouseover="ddrivetip('<?=CLICK_TO_SELECT?>', '','')"; onMouseout="hideddrivetip()"><?=$values['PurchaseID']?></a></td>
	   <td>
