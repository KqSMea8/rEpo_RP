...
<div id="preview_div">	
    <div class="had">Send Invoice</div>
            ...
            <td align="left">
                ...
                <table width="100%" border="0" cellpadding="5" cellspacing="0" class="borderall">	 
                    ...
                    <tr>
                        ...
                        <td   align="left" ><?= ($arryInvoice[0]['InvoiceDate'] > 0) ? (date($Config['DateFormat'], strtotime($arryInvoice[0]['InvoiceDate']))) : (NOT_SPECIFIED) ?></td>
                    </tr>
                    <tr>
                        <td  align="right"   class="blackbold" >Created By  : </td>
                        <td   align="left" >
                            <?
                            if($arryInvoice[0]['AdminType'] == 'admin'){
                            $CreatedBy = 'Administrator';
                            }else{
                            $CreatedBy = '<a class="fancybox fancybox.iframe" href="../userInfo.php?view='.$arryInvoice[0]['AdminID'].'" >'.stripslashes($arryInvoice[0]['CreatedBy']).'</a>';
                            }
                            echo $CreatedBy;
                            ?></td>
                    </tr>
...
<?
    if ($arryInvoice[0]['InvoicePaid'] == 'Paid') {
        $StatusCls = 'green';
    } else {
        $StatusCls = 'red';
    }

    echo '<span class="' . $StatusCls . '">' . $arryInvoice[0]['InvoicePaid'] . '</span>';
    ?>
                    ...
                    <tr>
                        ...
                        <td   align="left" >
                            ...
                            <a class="fancybox fancybox.iframe" href="../custInfo.php?view=<?= $arryInvoice[0]['CustCode'] ?>" ><?= stripslashes($arryInvoice[0]['CustomerName']) ?></a>		</td>
                    </tr>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="borderall">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <!--input type="text" name="ToEmail" id="ToEmail" value="<?= stripslashes($arryInvoice[0]['Email']) ?>" class="disabled_inputbox" readonly-->
