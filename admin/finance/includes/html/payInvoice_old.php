<? if($_GET['pop']!=1){ ?>
	...
	if(!empty($_REQUEST['edit']) && $paidAmnt != $InvoiceAmount){?>
	 <!--<a class="fancybox add" href="#payInvoice_div" style="float: right;">Receive Payment</a>-->
	<?php }?>
...
<br>
<tr>
	 <td align="left"><? include("../sales/includes/html/box/invoice_information_view.php");?></td>
</tr>
...
<tr>
    <td  align="center" valign="top" >
		...
		<tr>
			<td align="left" colspan="2">
				<? 	include("../sales/includes/html/box/sales_order_item_view.php");?>
			</td>
		</tr>
