...
<?
//include("includes/html/box/card_invoice_full.php");
include("includes/html/box/card_invoice_partial.php");
?>
...
(empty($Commition[0]['CommPercentage']))?($Commition[0]['CommPercentage']=""):(""); 
(empty($crfees))?($crfees=""):(""); 
