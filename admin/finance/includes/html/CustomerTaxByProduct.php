...
<td valign="bottom">
<div id="taxDiv"  <?  if($_GET['rby']!='L'){echo 'style="display:none22"';}?>>
Tax Rate :<br> 
...
<tr>
	<td align="right" valign="top">
		...
		<input type="button" class="export_button"  name="exp" value="Export To Excel" onclick="Javascript:window.location='export_customer_tax_product.php?<?=$QueryString?>&module=Invoice';" />
		<? } ?>
	</td>
</tr>
