...
echo '<div class="draggable" id="cmp" style="'.$cmpStyle.'" onclick="Javascript:SelectBox(this)"; onblur="Javascript:UnSelectBox()"; tabindex="1">';
	...
	if(!empty($StateName)) $Address .= $StateName.',<br>';		   
...
echo '<div class="draggable" id="currency" align="right" style="'.$currencyStyle.'">'.$Config['CurrencySymbol55'].'  &nbsp;
<span class="inputamnt" style="width:150px;position:absolute;top:-1px;" id="curr">'.number_format($CheckAmount,2).'&nbsp;</span>
</div>';


/***********memo********************/
$memoStyle = !empty($arryTemplate[0]['memoStyle'])?($arryTemplate[0]['memoStyle']):("left: 3px;position: relative;right: auto;top: 50px;width: 630px;min-height:40px;font-weight:bold;");
