...
<?php   if(!empty($arrySale[0]['ShippingAccountNumber'])) { echo $arrySale[0]['ShippingAccountNumber']; }
...
<td  align="right"   class="blackbold" > Freight Discounted : </td>
	...
	<?php if($arrySale[0]['FreightDiscounted']==0) {echo "No";}?> 
	<?php if($arrySale[0]['FreightDiscounted']==1) {echo "Yes";} ?>
