...
<?
if(!empty($_GET['edit']) && empty($TotalCharge) && empty($TotalChargeAllInvoice) && empty($PaymentInvoice) && ($_SESSION['AdminType'] == 'admin' || $FullAcessLabel==1) ){ ?>
...
<td  align="right"   class="blackbold" > Tracking #  : </td>
	<td   align="left" >
	<input name="TrackingNo[]" type="text" class="inputbox track" id="TrackingNo" value="<?php echo stripslashes($TrackingNo[$i]); ?>"  maxlength="100" />     <? if($i==0){?>		<a href="javascript:;" class="add_row" id="addmore">Add More</a> <?}?> <? if($i>=1){?> <img src="../images/delete-161.png" class="rangDel" style="cursor:pointer"> <? }?>    
	</td>
</tr>
<? }?>
