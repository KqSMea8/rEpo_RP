...
<tr>
 ...
 <tr>
	...
	<input name="SuppCode" type="text" class="datebox" id="SuppCode" value=""  maxlength="20" onKeyPress="Javascript:ClearAvail('MsgSpan_SuppCode');return isUniqueKey(event);" onBlur="Javascript:CheckAvailField('MsgSpan_SuppCode','SuppCode','<?=$_GET['edit']?>');" onMouseover="ddrivetip('<?=BLANK_ASSIGN_AUTO?>', 220,'')"; onMouseout="hideddrivetip()"/>
...
if($arryCurrentLocation[0]['country_id']==106){?>
 <tr>
		<td  align="right" class="blackbold">VAT TIN :</td>
               <td  align="left" >
		<input name="VAT"  type="text" class="inputbox" id="VAT" value="<?=stripslashes($arrySupplier[0]['VAT'])?>"  maxlength="50" />  </td>
	
		<td  align="right"   class="blackbold">CST No :</td>
                <td  align="left" >
		<input name="CST"  type="text" class="inputbox" id="CST" value="<?=stripslashes($arrySupplier[0]['CST'])?>"  maxlength="50" />  </td>
	</tr>
...
<input name="LastName" type="text" class="inputbox" id="LastName" value="<?php echo stripslashes($arrySupplier[0]['LastName']); ?>"  maxlength="50" onkeypress="return isCharKey(event);"/>            </td>
 ...
 <tr>
        ...
        <td align="left" colspan="3"><input name="Website" type="text" class="inputbox" id="Website" value="<?=(!empty($arrySupplier[0]['Website']))?($arrySupplier[0]['Website']):("http://")?>"  maxlength="100" />  <?=WEBSITE_FORMAT?></td>
      </tr>
