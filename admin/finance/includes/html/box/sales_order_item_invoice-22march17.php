...
var SubTotal = price*qty;
	...
	function calculateGrandTotal() {		
		...
		var item_taxable = ''; 		
		var taxRate = 0; var tax = 0; var amount = 0; var TDiscount=0;
...
//($arrySaleItem[$Count]["DropshipCheck"] != 1 && (
 if($_SESSION['TrackInventory'] !=1 && $_SESSION['SelectOneItem']!='1'){
  if((($arrySaleItem[$Count]["evaluationType"] == 'Serialized' || $arrySaleItem[$Count]["evaluationType"] == 'Serialized Average')
        ...
        //End//
?>
        <a  class="fancybox slnoclass fancybox.iframe" href="addSerial.php?id=<?= $Line ?>&MainSku=<?=$mainSku?>&cond=<?=stripslashes($arrySaleItem[$Count]["Condition"])?>" id="addItem" ><img src="../images/tab-new.png"  title="Serial number">&nbsp;Add S.N.</a>
        <?php }?>
