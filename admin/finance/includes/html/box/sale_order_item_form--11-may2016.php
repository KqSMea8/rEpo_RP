...
<!---------Amit Singh-------->
       ...
       <!--By chetan 18Jan--->
       <td>
          <input type="text" <? if($arrySaleItem[$Count]["DropshipCheck"] == 1){?>style="display:none;"<?php }?> name="avgCost<?=$Line?>" id="avgCost<?=$Line?>" value="<?=stripslashes($arrySaleItem[$Count]["avgCost"])?>" class="disabled textbox avgCost" maxlength="6" size="6" readonly>
