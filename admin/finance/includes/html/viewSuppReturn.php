...
<TABLE WIDTH="100%"   BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0 >
	...
	<tr>
        <td align="left" >
<?
echo '<a class="red_bt fancybox fancybox.iframe" href="SupplierList.php?link=viewSuppReturn.php">Select Vendor</a>';
?>
</td>
      </tr>	
    ...
    <tr align="left"  >
     <!-- <td width="0%" class="head1" ><input type="checkbox" name="SelectAll" id="SelectAll" onclick="Javascript:SelectCheckBoxes('SelectAll','OrderID','<?=sizeof($arryReturn)?>');" /></td>-->
      ...
      <td width="8%" align="center" class="head1" >Currency</td>
       <td width="10%"  align="center" class="head1" >Amount Paid</td>
    </tr>
  ...
  ?>
    <tr align="left" >
      <!--<td ><input type="checkbox" name="OrderID[]" id="OrderID<?=$Line?>" value="<?=$values['OrderID']?>" /></td>-->
       <td><a class="fancybox fancybig fancybox.iframe" href="../purchasing/vReturn.php?view=<?=$values['OrderID']?>&pop=1"><?=$values["ReturnID"]?></a></td>
	   <td height="20">
    ...
    <?php }else{?>
    <tr align="center" >
      <td  colspan="7" class="no_record"><?=NO_ITEM_RETURNED?> </td>
    </tr>
    <?php } ?>
  
	 <tr >  <td  colspan="7"  id="td_pager">Total Record(s) : &nbsp;<?php echo $num;?>      <?php if(count($arryReturn)>0){?>
