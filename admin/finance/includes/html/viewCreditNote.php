<script language="JavaScript1.2" type="text/javascript">
    ...
    {
        location.href = "viewCreditNote.php?customview=" + id;
        LoaderSearch();
    }
...
<div class="message" align="center"><?php
    ...
    echo $_SESSION['mess_credit'];
    unset($_SESSION['mess_credit']);
    }
    ?></div>
                ...
                <div id="preview_div">
                    ...
                    <table <?= $table_bg ?>>
                        ...
                        <tr align="left"  >
                            ...
                            <td width="9%" class="head1" >Posted Date</td>
                            <td width="8%" class="head1" >GL Posting Date</td>
                            <td width="10%"  class="head1" >Credit Memo ID#</td>
			    <td width="8%"  class="head1" >Invoice#</td>
                            <!--td width="10%" class="head1" >Expiry Date</td-->
                            <td class="head1">Customer</td>
			    <td width="9%"   class="head1" >Posted By</td>
...
<? 
	...
	/***********/			
 	if($values['PostToGL'] == "1" && $values['Status']=='Part Applied'){   
		$paidOrderAmnt = $objBankAccount->GetTotalPaymentCredit($values['CreditID'],"Sales");  
...
echo $objSale->GetCreditStatusMsg($values['Status'],$values['OrderPaid']);
