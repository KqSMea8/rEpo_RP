...
$("#c").select2();
	...
	<tr>
	 ...
	 <? if($num>0){?>
	      <input type="button" class="print_button"  name="exp" style="float:right" value="Print" onclick="Javascript:window.print();"/>
              <input type="button" class="export_button"  name="exp" value="Export To Excel" onclick="Javascript:window.location='export_sales_tax_report.php?<?=$QueryString?>&module=Invoice';" />
	...
	<tr>
	  <td  valign="top">
		...
		<table <?=$table_bg?>>
		<tr align="left"  >
                 <td class="head1" width="20%">Customer</td>    
