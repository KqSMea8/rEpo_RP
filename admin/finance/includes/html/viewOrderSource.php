...
<table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
 <tr>
        <td align="right" ><a href="editOrderSource.php"  class="add">Add <?=$ModuleName?></a></td>
 </tr>
</table>
...
echo '<a href="editOrderSource.php?active_id='.$values["value_id"].'&curP='.$_GET["curP"].'" class="'.$status.'">'.$status.'</a>';
//}
?></td>
      <td  align="center"  >
...
<a href="editOrderSource.php?edit=<?php echo $values['value_id'];?>&amp;curP=<?php echo $_GET['curP'];?>" ><?=$edit?></a>
<a href="editOrderSource.php?del_id=<?php echo $values['value_id'];?>&amp;curP=<?php echo $_GET['curP'];?> " onclick="return confirmDialog(this, '<?=$ModuleName?>')"  ><?=$delete?></a>  
<? //}?> </td>
    </tr>
    <?php } // foreach end //?>
