<?php
	...
	if($_POST){
		...
		// added by chetan 20Sep 2016
		if(isset($_POST['Complete'])){
			$objSupplier->MoveRecordToMasterTable();	
			$ErrorMsg = 'Vendor '.MODULE_ADDED;
		...
		/*------------------- Added By Chetan -------------------*/
			...
			foreach ($_POST as $k => $v)
			 ...
			 $pid = exec('php /var/www/html/erp/cron/ImportVendor.php "'.$post_data.'" > /dev/null & echo $!;', $output, $return); 
