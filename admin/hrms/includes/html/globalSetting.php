...
<td  align="left" valign="top">
<input name="EarlyBreakRestrict" id="EarlyBreakRestrict"  type="checkbox" value="1" <?=($arryGlobal[0]['EarlyBreakRestrict'] == 1)?('checked'):('')?> />
</td>
</tr>
<tr id="EarlyPunchRestricttr2">
<td  align="right"   class="blackbold" valign="top">Early Lunch In Restrict :</td>
<td  align="left" valign="top">
<input name="EarlyLunchRestrict" id="EarlyLunchRestrict"  type="checkbox" value="1" <?=($arryGlobal[0]['EarlyLunchRestrict'] == 1)?('checked'):('')?> />
</td>
