	   ...
	   <table cellspacing="1" cellpadding="5" border="0">
				...
				<tr>
					 ...
					 Duaration :
                      ...
                      <td align="left">
                      <?php $durationtime=array('day'=>'Daily','week'=>'Weekly','month'=>'Monthly','quarter'=>'Quarterly','year'=>'Yearly');?>
                     <?php $duration= $quotadetail[0]->duration;?>
					<select name="duration" id="duration" class="inputbox">
					<?php if(!empty($durationtime)){
						foreach($durationtime as $k=>$dval){
							$select='';
							if($duration==$k)
							$select='selected="selected"';
							echo '<option value="'.$k.'" '.$select.'>'.$dval.'</option>';
						}}?>
					 ...
					 <tr>
						  <td valign="top" align="right" class="blackbold">Call Quota <span class="red">*</span>:</td>
						  <td align="left">
							<input type="text" name="q_time" class="inputbox" value="<?php echo !empty($quotadetail[0]->q_time)?$quotadetail[0]->q_time:'';?>">
						  ...
						  <td align="left">
								...
								<input type="hidden" name="quotaId" value="<?php echo !empty($quotadetail[0]->id)?$quotadetail[0]->id:'';?>" class="button">							
							</td>
						</tr>
