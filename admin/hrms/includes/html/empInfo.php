...
<table width="100%" border="0" cellpadding="3" cellspacing="0" >
 ...
 <tr>
        <td  align="right"   class="blackbold" width="25%"> Employee Code : </td>
        <td   align="left" >
...
<? if($arryEmployee[0]['ExistingEmployee']=="1"){ //start existing employee ?>
<tr>
...
<? 	
	...
	<? if(!empty($arryEmployee[0]['TerminationDate'])) { ?>
	   <tr>
...
<? } //end existing employee?>	  	  
	 ...
	 <td align="right" width="20%" valign="top">
	  <? 
$NouserImg = ($arryEmployee[0]['Gender']=='Female')?('nouserf.png'):('nouserm.png');


$PreviewArray['Folder'] = $Config['EmployeeDir'];
$PreviewArray['FileName'] = $arryEmployee[0]['Image']; 
$PreviewArray['NoImage'] = $Prefix."images/".$NouserImg;
...
echo PreviewImage($PreviewArray);
	...
	?>
		...
		<?	//}else{ ?>
	  <!--img src="../../resizeimage.php?w=120&h=120&img=images/<?=$NouserImg?>" title="<?=$arryEmployee[0]['UserName']?>" -->
