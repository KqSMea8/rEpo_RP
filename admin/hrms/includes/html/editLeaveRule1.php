...
$RuleValueTd =  '<td>
<input  name="RuleValue[]" id="RuleValue'.$Line.'" value="'.stripslashes($RuleValueArry[$Count]).'" type="text" class="textbox" style="width:60px;" maxlength="5" onkeypress="return isNumberKey(event);"/> 
...
<input id="Days<?=$LineDays?>" name="Days[]"  class="textbox" size="3" value="<?=$arryFinalLeave[$LeaveType]?>"  type="text" maxlength="2" onkeypress="return isDecimalKey(event);"> 
