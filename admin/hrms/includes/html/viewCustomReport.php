...
<a href="viewCustomReport.php" class="back">Back</a>
<?}?>
...
<? if($num>0 && $_GET['CustomReport']>0){ ?>
	<div id="print_export" style="clear:both"><input type="button" class="export_button"  name="exp" value="Export To Excel" onclick="Javascript:window.location='export_custom_report.php?<?=$QueryString?>';" /></div> 
	<div class="cb"></div>	
<? } ?>
