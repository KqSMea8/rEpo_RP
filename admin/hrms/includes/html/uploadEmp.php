...
function ValidateForm(frm)
{
	...
	if( ValidateMandExcel(frm.excel_file,"Please upload employee sheet in excel format.")
...
<a href="dwn.php?file=upload/employee/EmpTemplate.xls" class="download" style="float:right">Download Template</a> 
...
<tr>
                      <td height="30" class="blackbold" valign="top"   align="right"> </td>
                    ...
                    <tr>
                    <td  class="blackbold" valign="top" width="45%"  align="right"> Upload Excel Sheet :<span class="red">*</span></td>
		...
		<tr>
                      ...
                      <td  align="left"   class="blacknormal" valign="top">
		<? if(empty($_POST['RowNo'])) $_POST['RowNo']=8;?>
