...
?>			
	...
	<tr>
		  ...
		  <td align="left" >
	<input id="LeaveDeduction" name="LeaveDeduction"  value="<?=$arrySalary[0]['LeaveDeduction']?>"  type="text" maxlength="10" size="15" onkeypress="Javascript:ClearMsg();" class="disabled" readonly="" > 
	 <?=$Config['Currency']?> 
		   </td>
		</tr>
	<? } ?>	
