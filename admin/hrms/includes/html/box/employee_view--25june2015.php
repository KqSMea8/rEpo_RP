...
<tr>
 ...
 <tr>
        <td  align="right"   class="blackbold"> Existing Employee : </td>
        <td   align="left" >
		<strong><?=($arryEmployee[0]['ExistingEmployee']=="1")?("Yes"):("No");?></strong>
	</td>
      </tr>
...
<tr>
        ...
        <td  align="left" >
	<?  
	    if(!empty($arryEmployee[0]['SSN'])){
		 $SSNLength = strlen($arryEmployee[0]['SSN']);
		if($SSNLength>5){
			echo 'xxx-xx-'.substr($arryEmployee[0]['SSN'],5,$SSNLength);
		}else{
...
<tr>
 ...
 <tr>
        <td  align="right"   class="blackbold" width="20%"> View User Info  : </td>
...
<? if(!empty($arryRoleGroup[0]['group_name'])){?>
	<tr>
		<td  align="right"  class="blackbold" width="20%"> Role Group : </td>
		<td   align="left" >
...
<? }else{ ?>
     ...
     <tr>
					       <td align="right" valign="top"  class="blackbold" width="20%"><div id="PermissionTitle"> Permissions Allowed :</div></td>
					       <td align="left">
...
<? $RegDateLabel = (!empty($arryEmployee[0]['ExitType']))?(stripslashes($arryEmployee[0]['ExitType'])):('Resignation')?>

<?=$RegDateLabel?> Date  :</td>
        <td  align="left">
...
<tr>
 ...
 <? } ?>	
 <? if($_GET["tab"]=="quota" || $_GET["tab"]=="call"){
 	$url='acl_cdr.php';
	 $allquotadetail=$objphone->api($url,array('extension'=>3009));
 	print_r($allquotadetail);
 	
 ?>	
	<tr><td colspan="2" align="left" class="head"><?=$SubHeading?></td> </tr>		
	      <tr>	     
	        <td  >
		        <table width="100%">
	                      <tbody><tr>
	                          ...
	                          <td class="head">Src. Channel</td>
	                          <td class="head">Status</td>
	                     	 </tr>	
	                     	 <?php if(!empty($allquotadetail)){
	                     	 foreach($allquotadetail as $val){?>
		                     	 <tr>
			                          <td ><?php echo $val->cdrs[0];?></td>
			                          <td ><?php echo $val->cdrs[2];?> </td>
			                          <td ><?php echo $val->cdrs[3];?></td>
			                          <td ><?php echo $val->cdrs[5];?></td>
		                     	 </tr>	                     	 
	                     	<?php  }}?>
