...
<? if($arryEmployee[0]['Image'] !='' && file_exists($Prefix.'upload/employee/'.$arryEmployee[0]['Image']) ){ ?>
	...
	<div  id="ImageDiv"><a href="<?=$Prefix?>upload/employee/<?=$arryEmployee[0]['Image']?>" class="fancybox" data-fancybox-group="gallery"  title="<?=$arryEmployee[0]['UserName']?>"><? echo '<img src="'.$Prefix.'resizeimage.php?w=150&h=150&img=upload/employee/'.$arryEmployee[0]['Image'].'" border=0 >';?></a>
	
	&nbsp;<a href="Javascript:void(0);" onclick="Javascript:DeleteFile('<?=$Prefix?>upload/employee/<?=$arryEmployee[0]['Image']?>','ImageDiv')"><?=$delete?></a>	</div>
<?	} ?>
	...
	<tr>
	 ...
	 <span id="MsgSpan_Email"></span>		</td>
	  ...
	  <? if(empty($_GET['edit'])){ ?>
        ...
        <td   align="left" ><input name="Password" type="Password" class="inputbox" id="Password" value="<?php echo stripslashes($arryEmployee[0]['Password']); ?>"  maxlength="15" />          <span><?=PASSWORD_LIMIT?></span></td>
      </tr>		 
	  <tr>
