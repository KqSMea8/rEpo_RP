<div class="right-search">
			...
			<form class="admin_r_search_form" action="" method="get" enctype="multipart/form-data" name="form3" onSubmit="return LoaderSearch();">
			 <fieldset>
                    	 <label>Year:</label>
						 <div class="sel-wrap">
                        <?=getFinancialYear($_GET['yr'],"yr","textbox")?>
						 </div>
                    </fieldset>
