...
?>			
	...
	<tr>
		  ...
		  <td align="left" >
	<input id="LeaveDeduction" name="LeaveDeduction"  value="<?=$arrySalary[0]['LeaveDeduction']?>"  type="text" maxlength="10" size="15" onkeypress="Javascript:ClearMsg();" class="textbox" onblur="Javascript:SetFormValues('1');"> 
	 <?=$Config['Currency']?> 
		   </td>
		</tr>
	<? } ?>	
...
function SetFormValues(opt){
	...
	if(BasicSalary!='' && !isNaN(BasicSalary)){
		...
		if(document.getElementById("SubTotalD") != null){
			LeaveDeduction = parseInt(document.getElementById("LeaveDeduction").value);
