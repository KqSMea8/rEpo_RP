...
?>			
	...
	<input id="<?=$FieldName?>" name="<?=$FieldName?>" class="textbox"  value="<?=$FieldValue?>"  type="text" maxlength="10" onkeypress="Javascript:ClearMsg();" onblur="Javascript:SetFormValues('1');" size="15" > 
	 <?=$Config['Currency']?> 
	<?
...
function SetFormValues(opt){
	ClearMsg();
	var FieldName,FieldValue,FieldValueTemp,HeadType,AmtPer,FieldLabel,catGrade,SubTotalA=0,SubTotalB=0,SubTotalC=0,Total=0;
