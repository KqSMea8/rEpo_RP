...
<tr>
	...
	<tr>
        ...
        <td   align="left" >
<input name="ProbationPeriod" type="text" class="textbox" id="ProbationPeriod" value="<?php echo stripslashes($arryEmployee[0]['ProbationPeriod']); ?>" size="2" maxlength="4" onkeypress="return isNumberKey(event);" />  Days          </td>
      </tr>

	<tr>
        <td  align="right"   class="blackbold" > Eligibility Period   : </td>
        <td   align="left" >
<input name="EligibilityPeriod" type="text" class="textbox" id="EligibilityPeriod" value="<?php echo stripslashes($arryEmployee[0]['EligibilityPeriod']); ?>" size="2" maxlength="4" onkeypress="return isNumberKey(event);" />  Days          </td>
      </tr>
    ...
    <tr>
        ...
        <td align="left" >
	 <select name="LeaveAccrual" class="textbox" id="LeaveAccrual" style="width:100px;">
