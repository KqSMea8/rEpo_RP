				...
				echo '<td class="head1">
					 <table width="300" align="center" cellpadding="0" cellspacing="1" >
						<tr align="left" class="'.$bgclass.'">
							<td>IN</td>
							<td>OUT</td>
							<td><table  align="center" cellpadding="0" cellspacing="1" >
						<tr>
...
//print_r($arryBreakList[$values['EmpID']][$arrYDate[$dat2]]);


?>
             <td><?  echo $arryBreakList[$values['EmpID']][$arrYDate[$dat2]]["LO"]; ?></td> 
             <td> <? echo $arryBreakList[$values['EmpID']][$arrYDate[$dat2]]["LI"];?></td>
<td><?  echo $arryBreakList[$values['EmpID']][$arrYDate[$dat2]]["SO"]; ?></td> 
             <td> <? echo $arryBreakList[$values['EmpID']][$arrYDate[$dat2]]["SI"];?></td>
