...
<TABLE WIDTH="100%"   BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0 >
	<tr>
        <td>
	<a href="editAttrib.php?att=<?=$_GET['att']?>"  class="add">Add <?=$ModuleName?></a>
...
echo '<a href="editAttrib.php?active_id='.$values["value_id"].'&curP='.$_GET["curP"].'&att='.$_GET["att"].'" class="'.$status.'">'.$status.'</a>';
?></td>
