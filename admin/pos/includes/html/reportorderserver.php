...
<div class="had">Order Server </div>
        ...
        <td><br>
            ...
            <table <?= $table_bg ?> class="view-category">
                <tr align="left" >
                    ...
                    <td width="15%" height="20"  class="head1" > Order Server</td>
                    <td width="15%" height="20"  class="head1" >Number of Orders</td>
                    ...
                    foreach ($OrderList as $key => $values) {
                      ...
                      ?>
                        <tr align="left"  bgcolor="<?= $bgcolor ?>">
                            ...
                            <td align="center" height="26"><?= $values['server_name']; ?></td>
