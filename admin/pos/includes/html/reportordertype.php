        ...
        <td><br>
            ...
            <table <?= $table_bg ?> class="view-category">
                <tr align="left" >
                    ...
                    <td width="15%" height="20"  class="head1">Order Type</td>
                    <td  height="20" width="20%" class="head1" align="center">Number of Orders</td>
                    ...
                    foreach ($OrderList as $key => $values) {
                      ...
                      ?>
                        <tr align="left"  bgcolor="<?= $bgcolor ?>">
                            <td align="center" height="26"><?= $values['order_type']; ?></td>
                            <td align="center"><?= $values['totalorder']; ?></td>
