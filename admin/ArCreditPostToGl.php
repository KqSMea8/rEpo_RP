<?php
//usr/bin/php /var/www/html/erp/admin/ArCreditPostToGl.php 28551 37 POS

/*$argv['1'] = $_GET['ord']; //OrderID
$argv['2'] = $_GET['cmp'];  //CmpID
$argv['3'] = $_GET['type'];  //OrderSource
*/
...
if(!empty($argv['1']) && !empty($argv['2']) && !empty($argv['3'])){
	...
	if(!empty($arryCompany[0]['DisplayName'])){
		...
		if($ModuleIsActive == 1){  
			 ...
			 $Approved=1;
			 include_once($PrefixTemp."includes/AutoPostToGlArCreditMemo.php");
			 echo CREDIT_MEMO_POSTED_TO_GL_AACOUNT;	
		}
	}
