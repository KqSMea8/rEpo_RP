...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    unset($_SESSION['mess_Page']);
        	...
        	<table>
        	<tr>
        	<td>Search: <input type="text" name="search_str" class="inputbox" value="<?php  if(isset($_POST['search_str']) && $_POST["search_str"] != '') { echo $_POST['search_str']; }?>" ></td>
