...
define('MANAGE_CATEGORY','Manage Categories'); 
define('MANAGE_TEMPLATE','Manage Templates');
define('MANAGE_SETTING','Manage Setting');
define('ALIASEXIST',' could not updated .Menu alias already exist');

define('FORMADDED','Your data has been saved.');
?>
