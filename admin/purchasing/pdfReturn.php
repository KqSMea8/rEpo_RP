<?	require_once("../includes/pdf_comman.php");
	...
	$Head6 = '<b>Total Qty Returned</b>'; 
	$Head7 = '<b>Qty Returned</b>';
	$Head8 = '<b>Unit Price</b>';
	$Head9 = '<b>Tax Rate</b>';
	$Head10 = '<b>Amount</b>'; 
	    ...
	    $arryDef[$i][$Head2] = stripslashes($arryPurchaseItem[$Count]["Condition"]);
            ...
            $arryDef[$i][$Head7] = $arryPurchaseItem[$Count]["qty_returned"];
        ...
        $pdf->ezTable($data,'','',array('cols'=>array($Head1=>array('justification'=>'left','width'=>'45'),$Head2=>array('justification'=>'left', 'width'=>'55'),$Head3=>array('justification'=>'left','width'=>'55'),$Head4=>array('justification'=>'left','width'=>'55'),$Head5=>array('justification'=>'left','width'=>'55'),$Head6=>array('justification'=>'left','width'=>'45'),$Head7=>array('justification'=>'left','width'=>'55'),$Head8=>array('justification'=>'left','width'=>'60'),$Head9=>array('justification'=>'right','width'=>'55'),$Head10=>array('justification'=>'right','width'=>'55')), 'shaded'=>0,'shadeCol'=>array(0.9,0.9,0.9), 'showLines'=>2 , 'xPos' =>300 ,'width'=>500,'fontSize'=>8,'showHeadings'=>0, 'colGap'=>2, 'rowGap'=>2) );
        $pdf->setStrokeColor(0,0,0,1);
