...
if(!empty($ErrorMSG)){
	...
	#include("includes/html/box/invoice_form.php");
...
<tr>
	 ...
	 <div style="float:right"><a class="fancybox fancybox.iframe" href="vPO.php?module=Order&pop=1&po=<?=$arryPurchase[0]['PurchaseID']?>" ><?=VIEW_ORDER_DETAIL?></a></div>
