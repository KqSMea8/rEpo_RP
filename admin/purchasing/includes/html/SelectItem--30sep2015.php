<script language="JavaScript1.2" type="text/javascript">
    ...
    function SetItemCode(ItemID, Sku, AliasID) {
        ...
        if (SkuExist == 1) {
            ...
            var proc = $("#proc").val();
    //By Chetan// 
            var SendUrl = "&action=ItemInfo&ItemID="+ escape(ItemID) +"&AliasID="+escape(AliasID)+"&proc=" + escape(proc) + "&r=" + Math.random();
    //End//
            /******************/
            $.ajax({
                type: "GET",
    ...
    <tr>
        <td align="right" valign="top">
            ...
            <form name="frmSrch" id="frmSrch" action="SelectItem.php" method="get" onSubmit="return ResetSearch();">
                <input type="text" name="key" id="key" placeholder="<?= SEARCH_KEYWORD ?>" class="textbox autocomplete" autocomplete="off" size="20" maxlength="30" value="<?= $_GET['key'] ?>">&nbsp;<input type="submit" name="sbt" value="Go" class="search_button">
        ...
        <td id="ProductsListing" height="400" valign="top">
            ...
            <form action="" method="post" name="form1">
                ...
                <div id="preview_div">
                  ...
                  <!--By Chetan-->  <td><a href="Javascript:void(0)" onclick="$('#tr<?=$Line;?>').slideToggle('slow');"><?=$values["Sku"]?></a></td><!--End-->
                            ...
                            <tr id="tr<?=$Line;?>" style="display:none">
                                <td colspan="6">
                                    <table width="100%" border="1">
                                        ...
                                        <tr  align="left"  valign="middle" >
                                             <td> <a href="Javascript:void(0)" onclick="Javascript:SetItemCode('<?=$values["ItemID"]?>','<?=$values["Sku"]?>','<?=$alias['AliasID']?>');" onMouseover="ddrivetip('<?= CLICK_TO_SELECT ?>', '', '')"; onMouseout="hideddrivetip()"><?=stripslashes($alias['ItemAliasCode'])?></a></td>
