        ...
        <ul>
            ...
            if (sizeof($GetPFdTempalteNameArray) > 0) {
                foreach ($GetPFdTempalteNameArray as $tempnmval) {
                    ...
                    echo '<li><a class="delete" href="../editcustompdf.php?curP=' . $_GET['curP'] . '&view=' . $_GET["view"] . '&Deltempid=' . $tempnmval['id'] . '&ModuleDepName=' . $ModuleDepName . '&rtn=' . $_GET["rtn"] . '"></a><a class="edit editpdf" href="../editcustompdf.php?curP=' . $_GET['curP'] . '&view=' . $_GET["view"] . '&tempid=' . $tempnmval['id'] . '&ModuleDepName=' . $ModuleDepName . '">' . $tempnmval['TemplateName'] . '</a></li>';
                }
            }
            ?>
