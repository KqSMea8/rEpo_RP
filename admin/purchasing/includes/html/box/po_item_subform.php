...
<input type="hidden" name="Condition<?=$Line?>" id="Condition<?=$Line?>" class="textbox"  value=""/>
        ...
        <td>
<textarea name="description<?=$Line?>" id="description<?=$Line?>" title="<?=stripslashes($arryPurchaseItem[$Count]["description"])?>" style="width:500px;height: 30px;" class="textbox"><?=stripslashes($arryPurchaseItem[$Count]["description"])?></textarea>
