...
<thead>
    <tr align="left"  >
		...
		<td width="10%" class="heading" >Total Qty Returned</td>
...
<tfoot>
     ...
     <tr class='itembg'>
		...
		*/
		...
		Tax : <input type="text" align="right" name="taxAmnt" id="taxAmnt" class="disabled" readonly value="" size="15" style="text-align:right;"/><br><br>
