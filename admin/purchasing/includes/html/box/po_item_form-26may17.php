...
<script language="JavaScript1.2" type="text/javascript">
 function ResetSearch() {
	...
	$("#addrow").on("click", function () { 
        ...
        cols += '<td><img src="../images/delete.png" id="ibtnDel">&nbsp;<input type="text" name="sku' + counter + '" id="sku' + counter + '" class="textbox"  size="10" maxlength="10" onclick="Javascript:SetAutoComplete(this);" onblur="SearchItem(this.value,'+counter+');"   />&nbsp;<a class="fancybox fancybox.iframe" href="SelectItem.php?proc=Purchase&id=' + counter + '" ><img src="../images/view.gif" border="0"></a><input type="hidden" name="item_id' + counter + '" id="item_id' + counter + '" readonly maxlength="20"  /><a class="fancybox reqbox fancybox.iframe" id="req_link' + counter + '" href="reqItem.php?id=' + counter + '" style="display:none"><img src="../images/tab-new.png" style="display:none;" border="0" title="Additional Items" ></a><input type="hidden" name="req_item' + counter + '" id="req_item' + counter + '" readonly /><input type="hidden" name="old_req_item' + counter + '" id="old_req_item' + counter + '" readonly /><input type="hidden" name="add_req_flag' + counter + '" id="add_req_flag' + counter + '" readonly /></td><td><div <?=$style?>><select name="WID'+counter+'" id="WID'+counter+'" class="textbox" style="width:80px;"><?=$WarehouseDrop?></select></div></td><td <?=$style?>><div <?=$style?>><select name="Condition'+counter+'" id="Condition'+counter+'" class="textbox" style="width:120px;"><option value="">Select</option> <?=$ConditionDrop?></select></div></td><td><input type="text" name="description' + counter + '" id="description' + counter + '" class="textbox" style="width:332px;"  maxlength="50"  /> <a class="fancybox" href="#comments_div' + counter + '" ><img src="../images/comments.png" title="Comments" border="0"/></a><div id="comments_div' + counter + '" style="display:none;"><textarea style="height:100px;" maxlength="100" name="DesComment' + counter + '" id="DesComment' + counter + '"></textarea> </div></td><td><input type="text" name="on_hand_qty' + counter + '" id="on_hand_qty' + counter + '" class="disabled" readonly size="5"/></td><td><input type="text" name="qty' + counter + '"  id="qty' + counter + '"  class="textbox" size="5" maxlength="6" onkeypress="return isNumberKey(event);" /><input type="hidden" name="evaluationType' + counter + '"  id="evaluationType' + counter + '"  class="textbox"  /></td><td><input type="text" name="price' + counter + '"  id="price' + counter + '" class="textbox" size="10" maxlength="10" onkeypress="return isDecimalKey(event);"/></td><td><input type="text" class="normal" name="item_taxable' + counter + '" id="item_taxable' + counter + '" readonly size="2" maxlength="20"  /><!--select name="tax' + counter + '" id="tax' + counter + '" class="textbox" style="width:120px;display:'+TaxShowHide+'">' + TaxRateOption + '</select--></td><td align="right"><input type="text" name="amount' + counter + '" id="amount' + counter + '" class="textbox"  size="13" maxlength="10" onkeypress="return isDecimalKey(event);" style="text-align:right;"/></td>';
...
<td <?=$style?>><div <?=$style?>><select name="Condition<?=$Line?>" id="Condition<?=$Line?>" <?php if($_GET['edit']>0){ ?>onchange="getItemCondionQty('<?=stripslashes($arryPurchaseItem[$Count]['sku'])?>','<?=$Line?>',this.value)" <?php }?> class="textbox" style="width:120px;"><option value="">Select</option><?=$ConditionSelectedDrop?></select></div></td>
...
<textarea name="DesComment<?=$Line?>" id="DesComment<?=$Line?>" style="height:100px;" maxlength="100"><?=stripslashes($arryPurchaseItem[$Count]["DesComment"])?></textarea>
        ...
        <td><input type="text" name="qty<?=$Line?>" id="qty<?=$Line?>" class="textbox" size="5" maxlength="6" onkeypress="return isNumberKey(event);" value="<?=stripslashes($arryPurchaseItem[$Count]["qty"])?>"/>
...
<input type="hidden" name="evaluationType<?=$Line?>" id="evaluationType<?=$Line?>" value="<?=stripslashes($arryPurchaseItem[$Count]["evaluationType"])?>">
       ...
       <td><input type="text" name="price<?=$Line?>" id="price<?=$Line?>" class="textbox" size="10" maxlength="10" onkeypress="return isDecimalKey(event);" value="<? if($arryPurchaseItem[$Count]['DropshipCheck'] ==1 && !empty($_GET['SaleID'])){  echo stripslashes($arryPurchaseItem[$Count]["DropshipCost"]); } else { echo stripslashes($arryPurchaseItem[$Count]["price"]); }?>"/>
