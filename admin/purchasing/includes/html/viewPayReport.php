  ...
  ?>
    <tr align="left" >
      ...
      <td>
       ...
       <td><a class="fancybox fancybig fancybox.iframe" href="vPO.php?module=Order&pop=1&po=<?=$values['PurchaseID']?>" ><?=$values["PurchaseID"]?></a></td>
	   	<td>
      ...
      <td> <a class="fancybox fancybox.iframe" href="suppInfo.php?view=<?=$values['SuppCode']?>"><?=stripslashes($values["SuppCompany"])?></a> </td> 
       <td align="center"><?=$values['CreditAmnt']?></td>
