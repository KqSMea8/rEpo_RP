...
$CountPO = $objPurchase->getCountReceiptPO($arryPurchase[0]['PurchaseID']);
	...
	if($OrderIsOpen ==  1){
		...
		}else if($module=='Order' && $POReceipt!=1 ){ 
...
<? if(!empty($_GET['edit']) && $_SESSION['EDI_Access']=='enable') {?> <tr> <td align="right" class="blackbold">EDI Ref No :</td> <td align="left" colspan="3"><input name="EDIRefNo" type="text" class="disabled" readonly style="width: 90px;" id="EDIRefNo" value="<?php echo stripslashes($arryPurchase[0]['EDIRefNo']); ?>" maxlength="20" /></td> </tr> <? } ?>
