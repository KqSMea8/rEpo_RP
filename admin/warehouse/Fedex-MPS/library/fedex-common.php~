...
function getProperty($var){
	if($var == 'key') Return 'HCK0eqlTS0LSS9o7'; 
	if($var == 'password') Return 'i0WrmarsrGXOrsMORMWsazrul'; 
	if($var == 'shipaccount') Return '292261063';
	if($var == 'billaccount') Return '292261063'; 
	if($var == 'dutyaccount') Return '292261063'; 
	if($var == 'freightaccount') Return '292261063';  
	if($var == 'trackaccount') Return '292261063'; 
	if($var == 'dutiesaccount') Return '292261063';
	if($var == 'importeraccount') Return '292261063';
	if($var == 'brokeraccount') Return '292261063';
	if($var == 'distributionaccount') Return '292261063';
	...
	if($var == 'meter') Return '109505681';
		
	if($var == 'shiptimestamp') Return mktime(10, 0, 0, date("m"), date("d")+1, date("Y"));

	if($var == 'spodshipdate') Return '2016-07-05';
	if($var == 'serviceshipdate') Return '2017-07-08';

	if($var == 'readydate') Return '2016-07-01T08:44:07';
	//if($var == 'closedate') Return date("Y-m-d");
	if($var == 'closedate') Return '2016-07-30';
	...
	if($var == 'recipient') Return array(
		...
		'Address' => array(
			'StreetLines' => array('650 Technology Park'),
			'City' => 'LAKE MARY',
