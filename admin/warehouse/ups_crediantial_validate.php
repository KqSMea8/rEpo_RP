...
$Config['ups_account_number']= $_POST['api_account_number'];
$Config['ups_key']= $_POST['api_key'];
$Config['ups_password']= $_POST['api_password'];
$Config['ups_ShipperNumber'] = $_POST['api_meter_number'];
