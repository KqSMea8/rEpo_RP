<?php 
	/**************************************************/
	if($_GET['batchId']>0) { $_GET['batch'] = $_GET['batchId']; }
	if($_GET['batch']>0){
	...
	/**************************************************/
		...
		$Amazonservice = $arryProduct->AmazonSettings($Prefix,false,3);pr($Amazonservice);
							echo 'ssss'.$Amazonservice;pr($Amazonservice,1);die;
