...
$objShipment = new shipment();
    ...
    $ModuleIDTitle = "Shipment Number"; $ModuleID = "ShippedID"; $PrefixSO = "SHIP";  $NotExist = NOT_EXIST_Return;
	$ModuleName = $module;
...
$arrySale = $objShipment->GetShipment($_GET['SHIP'],'','Shipment');
	...
	require_once("includes/pdf_ship.php");
	...
	$pdf->ezSetDy(-5);
    if($NumLine>0){
        $Head1 = '<b>SKU</b>'; $Head2 = '<b>Description</b>'; $Head3 = '<b>Qty Ordered</b>'; $Head4 = '<b>Qty Invoiced</b>'; $Head5 = '<b>Qty Shipped</b>'; $Head6 = '<b>Unit Price</b>'; $Head7 = '<b>Discount</b>'; $Head8 = '<b>Taxable</b>'; $Head9 = '<b>Amount</b>'; 
		...
		for($Line=1;$Line<=$NumLine;$Line++) { 
			...
			$qty_returned = $arrySaleItem[$Count]["qty_shipped"];
