<?
	...
	/*************************************/
	if(empty($ModuleID)){
		$ModuleIDTitle = "Shipment Number"; $ModuleID = "ReturnID"; 
	}
...
if(empty($arrySale[0]['InvoiceID'])){ $InvoiceID = $arryShip[0]['RefID']; }
	...
	$data = array(
		...
		array($Head1 => "Shipment Date :", $Head2 => $ShippedDate),
		array($Head1 => "Invoice Number# :", $Head2 => $InvoiceID),
		...
		array($Head1 => "Ship From# :", $Head2 => $arryShip[0]['WarehouseCode']),
		array($Head1 => "Ship From (Warehouse) :", $Head2 => $arryShip[0]['WarehouseName']),
		array($Head1 => "Status :", $Head2 => $arryShip[0]['ShipmentStatus']),
		array($Head1 => "Shipment  Comment :", $Head2 => $shipmentComment)
