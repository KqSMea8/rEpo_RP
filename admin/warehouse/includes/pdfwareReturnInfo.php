...
//echo "<pre>";print_r($arrySale);
	...
	$data = array(
		...
		//array($Head1 => "Receipt Date :", $Head2 => $ReturnDate),
		...
		//array($Head1 => "Receipt Amount Paid :", $Head2 => $arrySale[0]['ReturnPaid']),
		//array($Head1 => "Receipt Paid Comment :", $Head2 => $ReturnComment)
