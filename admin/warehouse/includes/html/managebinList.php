...
function SetWarCode(WID){	
	...
	$.ajax({
		...
		//alert(responseText);
                  window.parent.document.getElementById("wCode").value=responseText["warehouse_code"];
                       window.parent.document.getElementById("wName").value=responseText["warehouse_name"];


                       window.parent.document.getElementById("wAddress").value=responseText["Address"];
                       window.parent.document.getElementById("wCity").value=responseText["City"];
                       window.parent.document.getElementById("wState").value=responseText["State"];
                       window.parent.document.getElementById("wCountry").value=responseText["Country"];
                       window.parent.document.getElementById("wZipCode").value=responseText["ZipCode"];
                       window.parent.document.getElementById("wMobile").value=responseText["mobile_number"];
                       window.parent.document.getElementById("wLandline").value=responseText["phone_number"];
...
<form name="frmSrch" id="frmSrch" action="warehouseList.php" method="get" onSubmit="return ResetSearch();">
