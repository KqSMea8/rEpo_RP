<?	require_once("../includes/pdf_comman.php"); 
	...
	$pdf->ezSetDy(-5);
    if($NumLine>0){
        $Head1 = '<b>SKU</b>'; $Head2 = '<b>Description</b>'; $Head3 = '<b>Qty Ordered</b>'; $Head4 = '<b>Total Qty Received</b>'; $Head5 = '<b>Qty Received</b>'; $Head6 = '<b>Unit Price</b>'; $Head7 = '<b>Dropship Cost</b>'; $Head8 = '<b>Taxable</b>'; $Head9 = '<b>Amount</b>'; 
        ...
        $pdf->ezTable($data,'','',array('cols'=>array($Head1=>array('justification'=>'left','width'=>'50'),$Head2=>array('justification'=>'left'),$Head3=>array('justification'=>'left','width'=>'40'),$Head4=>array('justification'=>'left','width'=>'50'),$Head5=>array('justification'=>'left','width'=>'50'),$Head6=>array('justification'=>'left','width'=>'50'),$Head7=>array('justification'=>'left','width'=>'60'),$Head8=>array('justification'=>'left','width'=>'40'),$Head9=>array('justification'=>'right','width'=>'70')), 'shaded'=>0,'shadeCol'=>array(0.9,0.9,0.9), 'showLines'=>2 , 'xPos' =>300 ,'width'=>500,'fontSize'=>8,'showHeadings'=>0, 'colGap'=>2, 'rowGap'=>2) );
        $pdf->setStrokeColor(0,0,0,1);
