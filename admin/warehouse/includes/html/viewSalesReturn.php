	 ...
	 ?></td>
      ...
      <td  align="center" class="head1_inner">
		...
		<a href="editSalesReturn.php?del_id=<?=$values['ReceiptID']?>&curP=<?=$_GET['curP']?>&rcpt=<?=$values['ReceiptNo'];?>" onclick="return confirmDialog(this, '<?=$ModuleName?>')"><?=$delete?></a> 
                <? }?>
                <?php /*<a href="pdfWarehouseReturn.php?RTN=<?=$values['ReceiptID']?>"><?=$download?></a>*/?>
                <a href="../pdfCommonhtml.php?o=<?=$values['ReceiptID']?>&module=<?=$module?>&ModuleDepName=WhouseCustomerRMA" ><?=$download?></a>
