...
<input type="button" class="print_button"  name="exp" value="Print" onclick="Javascript:window.print();"/>
	  <? } ?>
		...
		<? if(empty($_GET['po'])){ ?>
			<a class="fancybox add fancybox.iframe" href="PoList.php?link=editStockIn.php" >Add StockIn</a>
		<? } ?>
...
<a href="editReturn.php?edit=<?=$values['OrderID']?>&curP=<?=$_GET['curP']?>&po=<?=$_GET['po']?>"><?=$edit?></a>
<a href="editReturn.php?del_id=<?=$values['OrderID']?>&curP=<?=$_GET['curP']?>&po=<?=$_GET['po']?>" onclick="return confirmDialog(this, '<?=$ModuleName?>')"><?=$delete?></a> 
