...
<tr>
    <td  align="center" valign="top" >
		...
		<tr>
			<td align="left" colspan="2">
				<? 	include("includes/html/box/transfer_ship_item.php");?>
			</td>
		</tr>
		</table>	
	...
	<tr>
		<td  align="center">
	    	<input type="hidden" name="ShipOrder" id="ShipOrder" value="<?=$transferNo?>" />
			<input type="hidden" name="shipID" id="shipID" value="" />
			<input type="hidden" name="OrderID" id="OrderID" value="<?=$transferNo?>" />
			<input type="hidden" name="OrderType" id="OrderType" value="Transfer" />
