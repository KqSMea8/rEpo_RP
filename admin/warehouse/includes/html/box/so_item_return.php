...
<thead>
    <tr align="left" >
		...
		<td width="23%" class="heading">Description</td>
		<td width="10%" class="heading">Qty Ordered</td>
		<td width="15%" class="heading">Qty Returned</td>
		<td width="14%" align="center" class="heading">Qty Receipted</td>
		<td width="12%" align="center" class="heading">Qty Receipt</td>
...
<tbody>
	...
	for($Line=1;$Line<=$NumLine;$Line++) { 
		...
		if($arryShipItem[$Count]["qty_returned"] == $arrySaleItem[$Count]["qty_receipt"])
		{  
			  
			$textFld = $arrySaleItem[$Count]["qty_receipt"];
		  ...
		  $remainQty = $arrySaleItem[$Count]["qty_returned"]-$arryShipItem[$Count]["qty_receipt"];
	...
	?>
     <tr class='itembg'>
		...
		<td><input type="text" value="<?=$arrySaleItem[$Count]["qty_receipt"];?>" size="5" readonly="" class="disabled"></td>
       ...
       <td>
		<input type="text" name="tax<?=$Line?>" id="tax<?=$Line?>" readonly="" class="disabled" class="textbox" value="<?=$arrySaleItem[$Count]['tax'];?>">
