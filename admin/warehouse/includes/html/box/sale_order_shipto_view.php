<table width="100%" border="0" cellpadding="5" cellspacing="0">
	<tr>
	  ...
	  <tr style="display:none">
		...
		<td align="left"><?php echo stripslashes($arrySale[0]['ShippingName']); ?></td>
	</tr>
	<tr>
		<td align="right" class="blackbold" width="40%">Company Name :</td>
		<td align="left"><?php echo stripslashes($arrySale[0]['ShippingCompany']); ?>
		</td>
	</tr>
	<tr>
...
?>
	...
	<tr>
		...
		<td align="left"><?php echo stripslashes($arrySale[0]['ShippingCity']); ?>
		</td>
	</tr>

	<tr>
		<td align="right" class="blackbold">State :</td>
		<td align="left"><?php echo stripslashes($arrySale[0]['ShippingState']); ?>
		</td>
	</tr>
	...
	<tr>
		...
		<td align="left"><?php echo stripslashes($arrySale[0]['ShippingCountry']); ?>
		</td>
	</tr>

	<tr>
		<td align="right" class="blackbold">Zip Code :</td>
		<td align="left"><?php echo stripslashes($arrySale[0]['ShippingZipCode']); ?>
		</td>
	</tr>
	...
	<tr>
		...
		<td align="left"><?=stripslashes($arrySale[0]['ShippingMobile'])?></td>
	</tr>

	<tr>
		<td align="right" class="blackbold">Landline :</td>
		<td align="left"><?=stripslashes($arrySale[0]['ShippingLandline'])?></td>
	</tr>
...
<?php if(empty($TaxableBilling)){?>
	<tr>
		...
		<td align="left"><?=($arrySale[0]['tax_auths']=="Yes")?("Yes"):("No")?>
		</td>
	</tr>
	...
	if(empty($arrySale[0]['freightTxSet'])) $arrySale[0]['freightTxSet']=''
	?>


	<tr>
		<td align="right" class="blackbold">Tax Rate <?=$TaxName?> :</td>
		<td align="left"><?=$TaxVal?> <input type="hidden" name="TaxRate"
			id="TaxRate" value="<?=$arrySale[0]['TaxRate']?>">
