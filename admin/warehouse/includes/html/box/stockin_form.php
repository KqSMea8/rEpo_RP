            ...
            <td  align="center" valign="top" >
                ...
                <table width="100%" border="0" cellpadding="5" cellspacing="0" class="borderall">
                    ...
                    <tr>
                        ...
                        <td   align="left" >
                            <? if (!empty($_GET['edit']) || !empty($arryAdjustment[0]["RecieveID"])) { ?>
                                <B><?= stripslashes($arryAdjustment[0]["RecieveID"]) ?></B>

                            <? } else { ?>
                                <input name="RecieveID" type="text" class="datebox" id="RecieveID" value=""  maxlength="20" onKeyPress="Javascript:ClearAvail('MsgSpan_ModuleID');
                    return isAlphaKey(event);" onBlur="Javascript:CheckAvailField('MsgSpan_ModuleID', 'RecieveID', '<?= $_GET['edit'] ?>');" onMouseover="ddrivetip('<?= BLANK_ASSIGN_AUTO ?>', 220, '')"; onMouseout="hideddrivetip()"/>
...
<? $RecieveDate = ($arryAdjustment[0]['ReceivedDate'] > 0) ? ($arryAdjustment[0]['ReceivedDate']) : (date("Y-m-d"));?>
