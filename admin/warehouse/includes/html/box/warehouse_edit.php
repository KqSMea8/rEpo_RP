...
<tr>
        <td  align="right"   class="blackbold" width="20%"> Warehouse Code  :<span class="red">*</span> </td>
        <td   align="left" >
		
     <input name="warehouse_code" type="text" class="disabled" readonly="readonly" id="warehouse_code" value="<?php echo stripslashes($arryWarehouse[0]['warehouse_code']); ?>"  maxlength="30" onKeyPress="Javascript:ClearAvail('MsgSpan_Display'); return isUniqueKey(event);" onBlur="Javascript:CheckAvailField('MsgSpan_Display','warehouse_code','<?=$_GET['edit']?>');"/>
...
<input name="phone_number" type="text" class="inputbox" id="phone_number" value="<?php echo stripslashes($arryWarehouse[0]['phone_number']); ?>"  maxlength="50" />            </td>
   ...
   <tr>
        ...
        <td   align="left" >
             <input name="Default" type="checkbox" <? if($arryWarehouse[0]['Default']==1){ echo "checked";}?>  id="Default" value="1"   />           
         </td>
      </tr>
 ...
 <tr>
	...
	<tr>
       ...
       <tr>
          ...
          <td  align="left" >
            <textarea name="Address" type="text" class="textarea" id="Address"><?=stripslashes($arryWarehouse[0]['Address'])?></textarea>			          </td>
        </tr>
	...
	?>
     ...
     <tr>
	  ...
	  <td  align="left" id="state_td" class="blacknormal">&nbsp;</td>
        ...
        <td   align="left" ><div id="StateValueDiv"><input name="OtherState" type="text" class="inputbox" id="OtherState" value="<?php echo $arryWarehouse[0]['OtherState']; ?>"  maxlength="30" /> </div>           </td>
      </tr>
	   ...
	   <tr>
        ...
        <td align="left" ><div id="CityValueDiv"><input name="OtherCity" type="text" class="inputbox" id="OtherCity" value="<?php echo $arryWarehouse[0]['OtherCity']; ?>"  maxlength="30" />  </div>          </td>
      </tr>
	
	    <tr>
        <td align="right"   class="blackbold" >Zip Code  :<span class="red">*</span></td>
        <td  align="left"  >
	 <input name="ZipCode" type="text" class="inputbox" id="ZipCode" value="<?=stripslashes($arryWarehouse[0]['ZipCode'])?>" maxlength="15" />			</td>
      </tr>
