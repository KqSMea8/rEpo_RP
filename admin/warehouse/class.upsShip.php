...
class upsShip {
	...
	function buildRequestXML() {
		...
		$ShipmentConfirmRequestXML->push('Shipper');
			$ShipmentConfirmRequestXML->element('Name', 'MKB Technology');
			$ShipmentConfirmRequestXML->element('AttentionName', 'Mahir Abdi');
			$ShipmentConfirmRequestXML->element('ShipperNumber', '11YA89');
			$ShipmentConfirmRequestXML->push('Address');
				$ShipmentConfirmRequestXML->element('AddressLine1', '650 Technology Park');
				$ShipmentConfirmRequestXML->element('City', 'Lake Mary');
				$ShipmentConfirmRequestXML->element('StateProvinceCode', 'FL');
		...
		$ShipmentConfirmRequestXML->push('ShipTo');
			$ShipmentConfirmRequestXML->element('CompanyName', 'Avarisource LLC Suite M');
			$ShipmentConfirmRequestXML->element('AttentionName', 'Nafees');
			...
			$ShipmentConfirmRequestXML->push('Address');
				$ShipmentConfirmRequestXML->element('AddressLine1', '927 Calle Negocio');
				$ShipmentConfirmRequestXML->element('City', 'San Clemente');
				$ShipmentConfirmRequestXML->element('StateProvinceCode', 'CA');
				$ShipmentConfirmRequestXML->element('CountryCode', 'US');
				$ShipmentConfirmRequestXML->element('PostalCode', '92673');
			...
			$ShipmentConfirmRequestXML->push('Prepaid');
				$ShipmentConfirmRequestXML->push('BillShipper');
					$ShipmentConfirmRequestXML->push('CreditCard');
						...
						$ShipmentConfirmRequestXML->element('ExpirationDate', '011921');
		...
		$ShipmentConfirmRequestXML->push('ShipmentServiceOptions');
			$ShipmentConfirmRequestXML->push('OnCallAir');
				$ShipmentConfirmRequestXML->push('PickupDetails');
					$ShipmentConfirmRequestXML->element('PickupDate', date(ymd));
