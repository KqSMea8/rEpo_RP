...
return array(
    ...
    'dhl' => array(
        ...
        'pass' => $Config['dhl_password'],

        // Shipper, Billing and Duty Account 6781numbers
        'shipperAccountNumber' => $Config['dhl_account_number'],
        'billingAccountNumber' => $Config['dhl_account_number'],
        'dutyAccountNumber' => $Config['dhl_account_number'],
    ),
);
