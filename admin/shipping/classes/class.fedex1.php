...
class fedexAPI
{
	...
	global $Config;
        ...
        {
            /*$this->ship_account       = "510051408";
            $this->bill_account       = "510051408";
            $this->duty_account       = "510051408";
            $this->account_to_validate= "510051408";
            $this->track_account      = "510051408";
            $this->account            = "510051408";    //FEDEX Account Number

            $this->meter    = "118684482";      //Production Meter Number
            $this->key      = "Jl04sDDZrqxztwYV";   //Production Key
            $this->password = "Zd1YllLPMW2UBTdfrM6wvT3Ym";  //Production Password
	    */   
    ...
    public function addShipper()
    {
        ...
        (
            ...
            'Address' => array(
                'StreetLines' => array($_POST['Address1From']),
                'City' => $_POST['CityFrom'],
