...
function getProperty($var){
	global $Config;
	if($var == 'key') Return $Config['Fedex_key']; 
	if($var == 'password') Return $Config['Fedex_password']; 
	if($var == 'shipaccount') Return $Config['Fedex_account_number'];
	if($var == 'billaccount') Return $Config['Fedex_account_number']; 
	if($var == 'dutyaccount') Return $Config['Fedex_account_number']; 
	if($var == 'freightaccount') Return $Config['Fedex_account_number'];  
	if($var == 'trackaccount') Return $Config['Fedex_account_number']; 
	if($var == 'dutiesaccount') Return $Config['Fedex_account_number'];
	if($var == 'importeraccount') Return $Config['Fedex_account_number'];
	if($var == 'brokeraccount') Return $Config['Fedex_account_number'];
	if($var == 'distributionaccount') Return $Config['Fedex_account_number'];
	...
	if($var == 'meter') Return $Config['Fedex_meter_number'];
	...
	if($var == 'trackingnumber') Return $Config['tracking_number'];
