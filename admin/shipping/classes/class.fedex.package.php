 ...
 */
  ...
  public function setPackageDimensions($length, $width, $height,$unit = "IN")
	...
	//echo $INVOICENO;die;P_O_NUMBER
	 $this->CustomerReferences = array('0' => array('CustomerReferenceType' => 'CUSTOMER_REFERENCE', 'Value' => $_POST['CUSTOMERREFERENCE']),'1' => array('CustomerReferenceType' => 'INVOICE_NUMBER', 'Value' => $_POST['INVOICENO']), '2' => array('CustomerReferenceType' => 'P_O_NUMBER', 'Value' => $_POST['PONUMBER'])
