...
<?
	if(is_array($response->TrackDetails->OtherIdentifiers)){
		$InvoiceNo = $response->TrackDetails->OtherIdentifiers[0]->Value;
		$PONo = $response->TrackDetails->OtherIdentifiers[1]->Value;
	}else{
		$InvoiceNo = $response->TrackDetails->OtherIdentifiers->Value;
		$PONo = $response->TrackDetails->OtherIdentifiers->Value;
	}
?>
<tr>
 ...
 <?php echo $InvoiceNo;?> 
	...
	<td align="left"> <?php echo $PONo;?>  </td>
