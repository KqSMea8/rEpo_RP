...
if ($arryManufacturer[0]['Image'] != '' && file_exists($MainDir. $arryManufacturer[0]['Image'])) {
$ImageExist = 1;
$OldImage = $MainDir . $arryManufacturer[0]['Image'];    
?>
                                                <tr> 
...
<a data-fancybox-group="gallery" class="fancybox" href="<?=$MainDir.$arryManufacturer[0][Image]?>">
<? echo '<img src="resizeimage.php?w=200&h=200&img='.$MainDir.$arryManufacturer[0]['Image']. '&" border=0 >'; ?>
</a>&nbsp;<a href="Javascript:void(0);" onclick="Javascript:DeleteFile('<?=$MainDir.$arryManufacturer[0]['Image']?>','DeleteSpan')" onmouseout="hideddrivetip();">
<?=$delete?></a>	
