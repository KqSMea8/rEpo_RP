        ...
        <tr>
            <td align="center" valign="top">
                <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                    <tr><td><?php if($arrayCoupon[0]['PromoType'] == "Product" && $_REQUEST['promotype'] == ""){ ?><a href="editCoupon.php?promoID=<?=$_REQUEST['promoID']?>&promotype=product" class="edit">Edit Product</a><?php }?></td></tr>
                    <tr>
                        <td align="center" valign="middle">
                           <?php if(!empty($_REQUEST['promoID']) && $_REQUEST['promotype'] == "product"){?>
						...
						<td class="formItemControl">                                                   
							<select name="promo_categories[]" multiple class="select multiselect"  id="select_products2">
								 <?php 
                                                                   $objCategory->getPromoCategories(0,0,$_GET['ParentID'],$_REQUEST['promoID']);
                                                                  ?>
							</select>
						</td>
					</tr>
						...
						<td class="formItemControl">
							...
							<?php
								$result = mysql_query("
									...
									WHERE pp.promoID='".$_REQUEST['promoID']."'
								");
                    ...
                    <tr>
                        <td align="center" height="135" valign="top"><br>
                            <? if ($_GET['promoID'] > 0) {
                             ...
                             <?php if(!empty($_REQUEST['promotype'])){?>
