                ...
                <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td align="center" valign="middle">
							...
							foreach( $arryTemplates as $i => $values )
							{
								...
								echo "\t\t<td class=\"blackbold\"><div class=\"template-thumb\" id=\"thumb".$values['TemplateId']."\"><img width=\"205px;\" height=\"150px;\" src=\"".$Prefix."template/".$values['TemplateName']."/".$values['Thumbnail']."\" ></div>
								<div>".$Priceval." <div>
                    ...
                    <tr>
                        <td align="center" height="135" valign="top"><br>
                           <table width="100%"  border="0" cellpadding="1" cellspacing="1" class="borderall" style="display:none;" id="amounttbl">
                           <tr>
                           <td><b>Total</b> :</td>
