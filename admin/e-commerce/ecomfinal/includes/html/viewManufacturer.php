                ...
                if (is_array($arryManufacturer) && $num > 0) {
                    ...
                    foreach ($arryManufacturer as $key => $values) {
                        ...
                        <tr align="left"  bgcolor="<?= $bgcolor ?>">
                            ...
                            <td align="center">
<?php if($values['Image'] != ""){?> <a data-fancybox-group="gallery" class="fancybox" href="../../../upload/manufacturer/<? echo $_SESSION['CmpID'].'/'.$values['Image']; ?>"><? echo '<img src="../../../resizeimage.php?w=70&h=50&img=upload/manufacturer/'.$_SESSION['CmpID'].'/'.$values['Image'] . '&bg=000000" border=0 >'; ?></a><?php } else {?>-<?php }?></td>
                            <td align="center" ><?
                                            if ($values['Status'] == 1) {
                                                $status = 'Active';
                                            } else {
