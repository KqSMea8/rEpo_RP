<?php 
	...
	require_once("classes/theme.class.php");
	 ...
	 if (is_object($themeObj)) {
		...
		$returnURL='http://'.$_SERVER['SERVER_NAME'].'/erp_old/erp/admin/e-commerce/'.$_SESSION['DisplayName'].'/paymentnotify.php';
		$notifyURL='http://'.$_SERVER['SERVER_NAME'].'/erp_old/erp/admin/e-commerce/'.$_SESSION['DisplayName'].'/paymentnotify.php';
		$cancelURL='http://'.$_SERVER['SERVER_NAME'].'/erp_old/erp/admin/e-commerce/'.$_SESSION['DisplayName'].'/template.php';
