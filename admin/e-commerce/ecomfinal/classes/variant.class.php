...
public function insert( $table, $data, $format = null ) {
	...
	function _insert_replace_helper( $table, $data, $format = null, $type = 'INSERT' ) {
        ...
        function AddVariant($arryDetails){
                        ...
                        @extract($arryDetails);	
			 $sql = "insert into inv_variant_value (variant_type_id,variant_name,required) values('".$variant_type_id."','".addslashes($variant_name)."', '".$required."')"; 
			//$rs = $this->query($sql,0);
...
function GetVariantDispaly($variant_id){
        ...
        function GetMultipleVariantOption($id){
             global $Config;
             $sql = " where 1";
