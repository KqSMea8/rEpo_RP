			...
			else
			{
               ...
               function getCustomerGroupById($customerGroupID) {
                ...
                function changeCustomerGroupStatus($customerGroupID) {
                    $sqlSettings = "SELECT * FROM e_customer_group WHERE GroupID=" . $customerGroupID;
                    ...
                    if (sizeof($rs)) {
                        ...
                        $sqlSettings = "UPDATE e_customer_group SET Status='".$Status ."' WHERE GroupID=" . $customerGroupID;
                ...
                $sqlSettings = "DELETE FROM e_customer_group WHERE GroupID = " . $customerGroupID;
