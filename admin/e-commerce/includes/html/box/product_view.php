                                            ...
                                            <table width="100%" border="0" cellpadding="3" cellspacing="1"  class="borderall">
                                                ...
                                                <? if ($_GET["tab"] == "basic") { ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><? if(!empty($arryProduct[0]['Price2'])) echo $Config['Currency']." ".number_format($arryProduct[0]['Price2'],2); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td  height="30" align="right"  class="blackbold" >Sale Price :</td>
                                                        <td><? if(!empty($arryProduct[0]['Price'])) echo $Config['Currency']." ".number_format($arryProduct[0]['Price'],2); ?> </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td valign="top" align="left">
                                                              <? if(isset($arryProduct[0]['MetaKeyword'])) echo $arryProduct[0]['MetaKeyword'] ;?>
                                                          </td>
                                                      </tr>
                                                   <tr>
