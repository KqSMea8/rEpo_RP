...
<tbody>
	...
	for($Line=1;$Line<=$NumLine;$Line++) { 
	   ...
	   if(!isset($arrayOptionList[$Count]["title"])) $arrayOptionList[$Count]["title"]='';
	   if(!isset($arrayOptionList[$Count]["Id"])) $arrayOptionList[$Count]["Id"]='';
	   if(!isset($arrayOptionList[$Count]["Price"])) $arrayOptionList[$Count]["Price"]='';
	   if(!isset($arrayOptionList[$Count]["PriceType"])) $arrayOptionList[$Count]["PriceType"]='';
	   if(!isset($arrayOptionList[$Count]["Weight"])) $arrayOptionList[$Count]["Weight"]='';
	   if(!isset($arrayOptionList[$Count]["SortOrder"])) $arrayOptionList[$Count]["SortOrder"]='';
