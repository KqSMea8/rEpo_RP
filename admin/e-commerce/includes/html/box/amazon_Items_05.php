...
/* $Amazonservice = $objProduct->AmazonProductSettings($Prefix,true,8);
$result_ASIN = $objProduct->searchProduct($Amazonservice,'sku00016');
...
if(!empty($result_ASIN)){
   ...
   $lowest_ASIN = $objProduct->getLowestOfferListingForASIN($Amazonservice, array_slice($ASIN_List, 0, 20));
}
...
//echo "<pre>";
//print_r($AmazonData);
//echo "<pre>";print_r($arryProduct);exit;
if(!empty($_GET['pid'])){
	$AmazonData = $objProduct->getAmazonData($arryProduct[0]['ProductID'],'amazon','','','',(int)$_GET['pid']);
}else{
	$AmazonData = $objProduct->getAmazonData($arryProduct[0]['ProductID'],'amazon');
	}
...
/*if(!($AmazonData[0]['Status']) && !empty($AmazonData[0]['FeedSubmissionId'])){
	$Amazonservice = $objProduct->AmazonSettings($Prefix,true,$AmazonData[0]['AmazonAccountID']);
	$data = $objProduct->getFeedSubmissionHistory($Amazonservice,$AmazonData[0]['FeedSubmissionId']);
	//pr($data);
	//$Amazonservice = $objProduct->AmazonSettings($Prefix,true);
	$objProduct->invokeGetFeedSubmissionResult($Amazonservice,trim($AmazonData[0]['FeedSubmissionId']));
	$objProduct->updateAmazonStatus(trim($AmazonData[0]['FeedSubmissionId']),$_POST['FeedProcessingStatus'],$_POST['FeedProcessingSMsg']);
}*/
...
<div class="had">Manage Amazon Products</span> <?php if(!empty((int)$_GET['pid'])){ ?> <a href="AmazonEditProduct.php?curP=<?=$_GET['curP']?>" class="back">Back</a> <?php } ?> </div>
...
<table width="100%" border="0" cellpadding="5" cellspacing="0">
	...
	<tr>
		...
		<td align="left"><textarea name="ItemConditionNote" type="text" class="inputbox" id="ItemConditionNote"><?php echo trim(strip_tags($arryProduct[0]['ItemConditionNote'])); ?> </textarea>
		</td>
	</tr>
	<tr>
		...
		<td align="left"><textarea name="ShortDetail" type="text" class="inputbox" id="ShortDetail"><?php echo (!empty($arryProduct[0]['Name']))?strip_tags($arryProduct[0]['Name']):''; ?> </textarea>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td align="left" >
			...
			<input id="LaunchDate" name="LaunchDate" class="datebox" readonly=""  value="<?=$arryProduct[0]['LaunchDate']?>" type="text">
			...
			<td align="left" width="40%"> <input class="inputbox" type="checkbox"
				name="GiftMessage" value="1" <?php if($arryProduct[0]['GiftMessage']) echo "checked";?> />
	...
	<tr>
		<td align="right" class="blackbold" width="20%">Sale Start Date</td>
			...
			<input id="SaleStartDate" name="SaleStartDate" readonly="" class="datebox" value="<?=$arryProduct[0]['SaleStartDate']?>" type="text">
		...
		<td align="right" class="blackbold" width="20%">Is Gift Wrap Available:</td>
			<td align="left" width="40%"> <input class="inputbox" type="checkbox"
				name="GiftWrap" value="1" <?php if($arryProduct[0]['GiftWrap']) echo "checked";?>>
			</td>
	</tr>
	...
	<tr>
		<td align="right" class="blackbold" width="20%">Sale End Date:</td>
			<td align="left" width="40%"> 
			<input id="SaleEndDate" name="SaleEndDate" class="datebox" value="<?=$arryProduct[0]['SaleEndDate']?>" type="text">
			...
			<td align="left"> <input type="text" name="Mid" class="inputbox" id="Mid" required="" placeholder="select from other properties section" value="<?=$mid?>"/>
			</td>
	...
	<tr>
		...
		<td align="left" > 
		<input id="RestockDate" name="RestockDate" class="datebox" value="<?=$arryProduct[0]['RestockDate']?>" type="text">
		</td>
	...
	<tr>
		...
		<td align="left"><input name="Brand" type="text" class="inputbox"
			id="Brand" value="<?php echo $arryProduct[0]['Brand']; ?>"  />
		</td>
		
		<td align="right" class="blackbold" width="15%">Manufacturer Part No. :</td>
		<td align="left"><input name="MfrPartNumber" type="text" class="inputbox"
			id="MfrPartNumber" value="<?php echo $arryProduct[0]['MfrPartNumber']; ?>"/>
		</td>
	</tr>
...
<!-- Keywords  Start-->
	...
	<tr>
		...
		<td align="left"><input name="Keywords[]" type="text" class="inputbox"
			id="Keywords" value="<?php echo $Keywords[0]; ?>"  />
		</td>
	</tr>
	<tr>
		<td align="right" class="blackbold" width="15%">Search Term 2:</td>
		<td align="left"><input name="Keywords[]" type="text" class="inputbox"
			id="Keywords" value="<?php echo $Keywords[1]; ?>"  />
		</td>
	</tr>
	<tr>
		<td align="right" class="blackbold" width="15%">Search Term 3:</td>
		<td align="left"><input name="Keywords[]" type="text" class="inputbox"
			id="Keywords" value="<?php echo $Keywords[2]; ?>"  />
		</td>
	</tr>
	<tr>
		<td align="right" class="blackbold" width="15%">Search Term 4:</td>
		<td align="left"><input name="Keywords[]" type="text" class="inputbox"
			id="Keywords" value="<?php echo $Keywords[3]; ?>"  />
		</td>
	</tr>
<!-- Keywords  Start-->
	<tr>
		<td align="right" class="blackbold"></td>
		<td align="left"><input class="button" type="submit" name="submitAmazon" style="display:<?=(@$_GET['quickAmazon']==1) ? 'none;' : '';?>"
