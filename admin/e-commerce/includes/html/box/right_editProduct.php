...
<?php if($_SESSION['MarketPlace']==1){?>
			<li <?= ($_GET['tab'] == "SendAmazon") ? ("class='active'") : (""); ?>><a href="<?= $EditUrl ?>SendAmazon">List on Amazon</a></li>
			<li <?= ($_GET['tab'] == "SendEbay") ? ("class='active'") : (""); ?>><a href="<?= $EditUrl ?>SendEbay">List on Ebay</a></li>
<? }?>
  ...
  <div class="right_box">
    <ul class="rightlink">
      ...
      <li class="disable">Recommended</li>
		...
		<?php if($_SESSION['MarketPlace']==1){?>
			<li class="disable">SendAmazon</li>
<? }?>
    </ul>
  </div>
</div>
