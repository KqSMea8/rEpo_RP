                            ...
                            <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="borderall">
                                <tr>
                                    <td align="center" valign="top" ><table width="100%" border="0" cellpadding="5" cellspacing="1" >
                                            ...
                                            $AsgnedCategories= explode(',',$arryCustomer[0]['AssignedCategories']);
                                            
                                            	?>
                                            <tr>
                                                <td colspan="2" align="left" class="head">Assigned Categories </td>
                                            </tr>
                                            <tr>
                                                <td width="30%" align="right" valign="top" class="blackbold">  Categories : </td>
                                                <td width="56%"  align="left" valign="top">
                                                    <select  name="AssignedCategories[]" class="inputbox"  id="AssignedCategories" multiple> 
                                                    <?php for($count=0;$count<count($Categories);$count++){
                                                    echo '<option value="'.$Categories[$count]['CategoryID'].'" ';
                                                    if(in_array($Categories[$count]['CategoryID'],$AsgnedCategories)){
                                                    	echo 'selected="selected"';                                                    	
                                                    }
                                                    echo '>'.$Categories[$count]['Name'].'</option>';
                                                    }?>
                                            ...
                                            <tr>
                                                <td width="30%" align="right" valign="top" class="blackbold"> Wallet Limit :<span class="red">*</span> </td>
                                                <td width="56%"  align="left" valign="top">
                                                    <input  name="WalletLimit" id="WalletLimit" onkeyup="keyup(this);" value="<?= stripslashes($arryCustomer[0]['WalletLimit']) ?>" type="text" class="inputbox"  size="50" />
                                                </td>
                                            </tr>
                                             <tr>
                                                <td width="30%" align="right" valign="top" class="blackbold"> Wallet Balance :<span class="red">*</span> </td>
                                                <td width="56%"  align="left" valign="top">
                                                    <?= stripslashes($arryCustomer[0]['WalletBalance']) ?>
                                                </td>
                                            </tr>
                                             <tr>
                                                <td width="30%" align="right" valign="top" class="blackbold"> Add Wallet Amount :<span class="red">*</span> </td>
                                                <td width="56%"  align="left" valign="top">
                                                   <input  name="AddWalletAmount" id="AddWalletAmount" onkeyup="keyup(this);" value="" type="text" class="inputbox"  size="50" />
                                                </td>
                                            </tr>
                                            <?php }?>
                                            <!-- Added by karishma for dealer 6 Oct 2016-->
