    ...
    unset($_SESSION['mess_Page']);
            ...
            <table <?= $table_bg ?>>
                <tr align="left" >
					...
					<td width="10%" height="20"  align="center" class="head1">Image</td> 
			...
			<? 
                        ...
                        $PreviewArray['FileName'] = $values['Slider_image']; 
                        $PreviewArray['NoImage'] = $Prefix."images/no.jpg";
                        $PreviewArray['FileTitle'] = stripslashes($values['Name']);
                    ...
                    ?>
                        ...
                        ?>
                            ...
                            <td height="26" align="right"  valign="top">
                                ...
                                <a href="editSliderBanner.php?del_id=<?php echo $values['Id']; ?>" onclick="return confDel('Record')" class="Blue" ><?= $delete ?></a>              
                                &nbsp;
                            </td>
                        </tr>
                    <?php } // foreach end //?>
