                ...
                <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    <td align="center" valign="top" ><table width="100%" border="0" cellpadding="5" cellspacing="1" >
                                            ...
                                            <?php } else { ?>
                                                <tr>
                                                    <td width="30%" align="right" valign="top" =""  class="blackbold"> 
                                                        Calculation Method : <span class="red">*</span> </td>
                                                    <td width="56%"  align="left" valign="top">
                                                        <select style="width:199px;" name="MethodId" id="MethodId" class="inputbox">
                                            ...
                                            <tr> 
                                                ...
                                                <td  height="50" align="left" valign="top" class="blacknormal"> 
                                                    <select class="inputbox"  name="Priority" id="Priority">
                                                        <option value="1" <?php if ($arryShipping[0]['Priority'] == "1") {
                                                echo "selected";
                                            } ?>>1</option>
                                                        <option value="2" <?php if ($arryShipping[0]['Priority'] == "2") {
                                                echo "selected";
                                            } ?>>2</option>
                                                        <option value="3" <?php if ($arryShipping[0]['Priority'] == "3") {
                                                echo "selected";
                                            } ?>>3</option>
                                                        <option value="4" <?php if ($arryShipping[0]['Priority'] == "4") {
                                                echo "selected";
                                            } ?>>4</option>
                                                        <option  value="5" <?php if ($arryShipping[0]['Priority'] == "5") {
                                                echo "selected";
                                            } ?>>5</option>
                                                        <option value="6" <?php if ($arryShipping[0]['Priority'] == "6") {
                                                echo "selected";
                                            } ?>>6</option>
                                                        <option value="7" <?php if ($arryShipping[0]['Priority'] == "7") {
                                                echo "selected";
                                            } ?>>7</option>
                                                        <option value="8" <?php if ($arryShipping[0]['Priority'] == "8") {
                                                echo "selected";
                                            } ?>>8</option>
                                                        <option value="9" <?php if ($arryShipping[0]['Priority'] == "9") {
                                                echo "selected";
                                            } ?>>9</option>
                                                        <option value="10" <?php if ($arryShipping[0]['Priority'] == "10") {
                                                echo "selected";
                                            } ?>>10</option>
                                                    </select>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" class="blacknormal">
                                                     <table width="151" border="0" cellpadding="0" cellspacing="0" class="margin-left blacknormal">
                                                        <tr>
                    ...
                    <tr>
                        <td align="center" height="135" valign="top"><br>
                            <? if ($_GET['edit'] > 0) {
                                $ButtonTitle = 'Update';
                                $buttonId = "UpdateShipping";
                            } else {
                                $ButtonTitle = 'Submit';
                                $buttonId = "SubmitShipping";
                            } ?>
