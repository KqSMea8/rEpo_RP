...
<?php } ?>
                                        ...
                                        <table width="100%" border="0" cellpadding="5" cellspacing="1" <?php if ($_GET['template_id'] > 0) { ?>style="display: block;" <?php } else { ?> style="display: none;" <?php } ?>>
                                            ...
                                            <tr>
                                                ...
                                                <td width="56%"  align="left" valign="top">
                                                    <input  name="Subject" id="Subject" value="<? if(isset($arrayTemplateByID[0]['Template_Subject'])) echo $arrayTemplateByID[0]['Template_Subject']; ?>" type="text" class="inputbox" />
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td  colspan="2" class="editor_box" align="right" valign="top">
                                                    <textarea id="Html_Content" name="Html_Content" rows="15" cols="80"><? if(isset($arrayTemplateByID[0]['Template_Content'])) echo $arrayTemplateByID[0]['Template_Content']; ?></textarea>
                                                    <script type="text/javascript">
