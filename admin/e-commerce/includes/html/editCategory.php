...
<?php
			...
			if(IsFileExist($Config['ProductsCategory'],$arryCategory[0]['Image'])){ 
...
<?php
	$PreviewArray['Folder'] = $Config['ProductsCategory'];
	...
	&nbsp;<a href="Javascript:void(0);" onclick="Javascript:RemoveFile(\''.$Config['ProductsCategory'].'\',\''.$arryCategory[0]['Image'].'\',\'ImageDiv\')">'.$delete.'</a><input type="hidden" name="OldImage" value="'.$OldImage.'"></div>';
