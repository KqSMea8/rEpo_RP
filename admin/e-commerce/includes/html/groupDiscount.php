...
<?php if (isset($_SESSION['mess_cart'])) { ?><?= $_SESSION['mess_cart'];
		...
		<?php
		if(isset($arrygroupdiscount[0]['GroupDiscount'])){				
	...
	if(!isset($GroupDiscount[$listAllCustomerGroups[$count]['GroupID']]['type']))
		$GroupDiscount[$listAllCustomerGroups[$count]['GroupID']]['type']='';
	if(!isset($GroupDiscount[$listAllCustomerGroups[$count]['GroupID']]['val']))
		$GroupDiscount[$listAllCustomerGroups[$count]['GroupID']]['val']='';
