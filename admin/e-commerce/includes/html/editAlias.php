...
<? }else{ ?>
	<input  name="ItemAliasCode" id="ItemAliasCode" value="<? if(isset($arryAlias[0]['ItemAliasCode'])) echo stripslashes($arryAlias[0]['ItemAliasCode']);?>"  type="text" class="inputbox"  style="text-transform:uppercase" maxlength="30"  onKeyPress="Javascript:ClearAvail('MsgSpan_Display'); " onBlur="Javascript:CheckAvailField('MsgSpan_Display','ItemAliasCode','<?=$_GET['edit']?>'); " />
...
<? } ?>
	...
	<tr>
		<td  align="right"   class="blackbold" >Short Description: <span class="red">*</span>  </td>
		<td  align="left">
...
<tr>
	...
	<? 
if(!isset($arryAlias[0]['Manufacture'])) $arryAlias[0]['Manufacture']='';
