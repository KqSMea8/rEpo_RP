 ...
 <tr>
					...
					<select name="DisplayMenu" id="DisplayMenu" class="inputbox">
						...
						<option value="Both" <?php if($arryPage[0]['DisplayMenu']=="Both"){ echo "selected";}?>>Both</option>
								...
								Page Banner Image :</td>
								<td height="50" align="left">

								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="35%" class="blacknormal" valign="top"><input
											name="Banner_image" type="file" class="inputbox" id="Image"
											...
											if ($arryPage[0]['Banner_image'] != '' && file_exists($MainDir.$arryPage[0]['Banner_image'])) {
												$OldImage = $MainDir . $arryPage[0]['Banner_image'];
												?> <span id="DeleteSpan"> <input type="hidden"
											name="OldImage" value="<?=$OldImage?>"> <a
											data-fancybox-group="gallery" class="fancybox"
											href="<?=$MainDir.$arryPage[0][Banner_image]?>"><? echo '<img src="resizeimage.php?w=200&h=200&img=' . $MainDir. $arryPage[0]['Banner_image'] . '" border=0  >'; ?></a>&nbsp;<a
											href="Javascript:void(0);"
											onclick="Javascript:DeleteFile('<?=$MainDir.$arryPage[0]['Banner_image']?>','DeleteSpan')"
