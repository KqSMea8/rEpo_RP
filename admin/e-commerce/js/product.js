$(document).ready(function() { 
   $("#SubmitButton").click(function(){
           ...
           //alert($('#product_type').val()); return false;
	//alert($('#product_type').val()); return false;
	 if($('#product_type').val()=='Virtual'){
		if($('#virtual_file').val()==''){
	      ...
	      var virtualfile= $('#virtual_file').val();
	      var virtualfileext=virtualfile.split('.').pop();
		if (virtualfileext !="pdf"){
			alert ("Please Upload Only PDF File");
			 $("#virtual_file").focus();
			return false ;
			}
 ...
 if(pname == "")
  ...
  $("#UpdateAttribute").click(function(){
   ...
   $("#UpdateBasic").click(function(){
	...
	//alert($('#product_type').val()); return false;
	 if($('#product_type').val()=='Virtual'){
		if($('#virtual_file').val()=='' && $('#uploaded_virtual_file').val()=='' ){
            	alert ("Please Upload Only PDF File");
                 $("#virtual_file").focus();
                 return false;
            } else {
	      var virtualfile= $('#virtual_file').val();
	      var virtualfileext=virtualfile.split('.').pop();
			if (virtualfileext !="pdf" && $('#uploaded_virtual_file').val()=='' ){
			alert ("Please Upload Only PDF File");
			$("#virtual_file").focus();
			return false ;
			}
