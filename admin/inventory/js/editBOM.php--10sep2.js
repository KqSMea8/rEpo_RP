...
function ShowList(){   
 ...
 if(document.getElementById("bill_option").value == 'No'){
                ...
                var Url2 = "isRecordExists.php?bom_Sku="+escape(document.getElementById("bom_Sku").value)+"&editID="+bomID;
                SendExistRequest(Url2,'bom_Sku', "Bill Number"); 
        ...
        $.ajax({
            ...
            success: function (responseText) {
             ...
             if(responseText["Sku"] == undefined){
                ...
                document.getElementById('MsgSpan_Display').innerHTML="<span class=redmsg>Item Sku! is not exists.</span>";
	 ...
	 document.getElementById("sku"+count).focus();
       ...
       //alert(SelID );
        ...
        $.ajax({
            ...
            dataType : "JSON",
            success: function (responseText) {
             if(responseText["Sku"]==document.getElementById("bom_Sku").value){
 		alert('Item Sku [ '+key+' ] is not Available.');
                  }else if(responseText["Sku"] == undefined){
...
function SearchOptionComponent(key,count){
 var NumLine = document.getElementById("NumLine").value;   
	 ...
	 document.getElementById("sku"+count).focus();
       ...
       //alert(SelID );
        ...
        $.ajax({
            ...
            success: function (responseText) {
              if(responseText["Sku"] == undefined){
                        alert('Item Sku [ '+key+' ] does not exists.');
                        	document.getElementById("sku"+SelID).value='';
			document.getElementById("sku"+SelID).value='';
			document.getElementById("item_id"+SelID).value='';
                        	document.getElementById("Condition"+SelID).value='';
...
$("#addrowoption").on("click", function () { 
        ...
        colsop += '<td><img src="../images/delete.png" id="ibtnDel">&nbsp;<input type="text" name="sku' + counter + '" id="sku' + counter + '" class="textbox"  size="10" onclick="Javascript:SetAutoComplete(this);" onblur="return SearchOptionComponent(this.value,'+counter+');" maxlength="10"  />&nbsp;<a class="fancybox fancybox.iframe" href="OptionComItem.php?id=' + counter + '" ><img src="../images/view.gif" border="0"></a>&nbsp;&nbsp;<a class="fancybox reqbox fancybox.iframe" id="req_link' + counter + '" href="reqItem.php?id=' + counter + '" style="display:none"><img src="../images/tab-new.png" style="display:none;" border="0" title="Additional Items" ></a><input type="hidden" name="item_id' + counter + '" id="item_id' + counter + '" readonly maxlength="20"  /><input type="hidden" name="req_item' + counter + '" id="req_item' + counter + '" readonly /><input type="hidden" name="old_req_item' + counter + '" id="old_req_item' + counter + '" readonly /><input type="hidden" name="add_req_flag' + counter + '" id="add_req_flag' + counter + '" readonly /></td><td style="display:none"><select name="Condition'+counter+'" id="Condition'+counter+'" class="textbox" style="width:120px;"><option value="">Select Condition</option><?=$ConditionDrop?></select></td><td><input type="text" name="description' + counter + '" id="description' + counter + '" class="disabled" readonly style="width:350px;"  maxlength="50" onkeypress="return isAlphaKey(event);" /></td><td><input type="text" name="qty' + counter + '" id="qty' + counter + '" class="textbox"  size="5"/><input type="hidden" name="price' + counter + '"  id="price' + counter + '" class="textbox" size="15" maxlength="10" onkeypress="return isNumberKey(event);"/><input type="hidden" name="amount' + counter + '" id="amount' + counter + '" class="disabled" readonly size="15" maxlength="10" onkeypress="return isDecimalKey(event);" style="text-align:right;"/></td>';



		newRow.append(colsop);
