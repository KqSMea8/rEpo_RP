<script language="JavaScript1.2" type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#AddSerialNumber").click(function() {
            ...
            if (totalQtySerial == "") {
                alert("Please Enter Dis-assembly Qty.");
                return false;
            ...
            $.ajax({
                ...
                success: function(responseText) {
                    if (responseText != "")
                    {
                        ...
                        window.parent.document.getElementById("serial_Num").value = resSerialNo;
    ...
    <table width="100%"   border=0 align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td align="left" valign="top" width="250px">
                ...
                <?php  
                $serial_value_sel = preg_split("/\\r\\n|\\r|\\n/", $_GET['serial_value_sel']);
               ...
               //$serial_value_sel = explode("|",$_GET['serial_value_sel']);
                ...
                <textarea name="allSerialNo" type="text" disabled class="textarea" style="height: 250px; width: 275px;" id="allSerialNo"><? foreach($serial_value_sel as $serial){?><? print str_replace("|", "\n", $serial);?> <? }?></textarea>
