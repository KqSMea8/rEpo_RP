...
window.parent.document.getElementById("Condition" + SelID).setAttribute('onChange', "getSubItemCondionQty('"+responseText["Sku"]+"','"+SelID+"',this.value)");
			...
			if(responseText["evaluationType"] == 'Serialized'){
                         ...
                         //window.parent.document.getElementById("hideSerial"+SelID).style.display = 'none';   
                        //}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
	...
	<form name="frmSrch" id="frmSrch" action="SubItemList.php" method="get" onSubmit="return ResetSearch();">
                    ...
                    if (is_array($arryProduct) && $num > 0) {
                     ...
                     ?>
                            <tr align="left" valign="middle" bgcolor="<?= $bgcolor ?>">
                                ...
                                <td><? if(isset($values['allocated_qty'])) echo  $values['allocated_qty']; ?></td>
