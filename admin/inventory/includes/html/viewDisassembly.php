...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <tr>
        <td  align="right" >
            ...
            <? } ?>
            <a href="editDassemble.php?curP=<?= $_GET['curP'] ?>" class="add">Add Disassembly</a>	
            <? if ($_GET['key'] != '') { ?>
                <a href="viewDisassembly.php?curP=<?= $_GET['curP'] ?>" class="grey_bt">View All</a>
            <? } ?>
                ...
                <div id="preview_div">
                    <table <?= $table_bg ?>>
                        <tr align="left">
                            ...
                            <td width="12%" class="head1" align="center">Disassembly No.</td>
                            <td width="12%" class="head1" align="center">Bill Number</td>
                            
                            <td  class="head1" >Description</td>
<td width="15%"  class="head1" ><?= DAssemble_Location ?></td>
                            <td width="10%" class="head1" > Qty</td>
                            <td   class="head1" ><?= DAssemble_DATE ?></td>
                        ...
                        if (is_array($arryAssemble) && $num > 0) {
                            ...
                            foreach ($arryAssemble as $key => $values) {
                                ...
                                <tr align="left" valign="middle" bgcolor="<?= $bgcolor ?>">
                                    <!--<td><input type="checkbox" name="adjustmentID[]" id="ItemID<?= $Line ?>" value="<? if(isset($values['adjustmentID'])) echo $values['adjustmentID']; ?>"></td>-->

<td align="center">  
                                        <?= stripslashes($values['DsmCode']); ?>
                                    </td>
 ...
 <td align="center">  
    ...
    <td><?= stripslashes($values['warehouse_name']); ?></td>
                                    <td><?= stripslashes($values['disassembly_qty']); ?></td>
                                    <td><?= date($Config['DateFormat'], strtotime($values['disassemblyDate'])); ?></td>
                                    ...
                                    <td  align="center"  class="head1_inner" >
																					...
																					<a href="vDisassemble.php?view=<?= $values['DsmID'] ?>&curP=<?= $_GET['curP'] ?>" ><?= $view ?></a>
																			
                                        <? if ($values['Status'] != 2 ) {?>
                                        <a href="editDassemble.php?edit=<? echo $values['DsmID']; ?>&curP=<?php echo $_GET['curP']; ?>"><?= $edit ?></a>  

                                        <a href="editDassemble.php?del_id=<? echo $values['DsmID']; ?>&curP=<?php echo $_GET['curP']; ?>" onClick="return confDel('Product')"  ><?= $delete ?></a>
<? }?>	</td>
                                       </tr>
                            <?php } // foreach end //  ?>
                        ...
                        <?php } else { ?>
                            <tr >
                                <td  colspan="8" class="no_record">No  Disassambly found</td>
                            </tr>
