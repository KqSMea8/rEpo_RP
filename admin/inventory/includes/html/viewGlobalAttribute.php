        ...
        unset($_SESSION['mess_attr']);
            ...
            <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
                <tr>
                    ...
                    <td width="39%" align="right"> <a href="editGlobalAttribute.php" class="add">Add New Global Attribute</a>      </td>
                </tr>
                    ...
                    foreach ($arryGlobalAttributes as $key => $values) {
                        ...
                        ?>
                            ...
                            <td height="26" class="head1_inner" align="center"  valign="top">
                                <a href="editGlobalAttribute.php?edit=<?php echo $values['Gaid']; ?>&curP=<?php echo $_GET['curP']; ?>" class="Blue"><?= $edit ?></a>
                                <a href="editGlobalAttribute.php?del_id=<?php echo $values['Gaid']; ?>&curP=<?php echo $_GET['curP']; ?>" onclick="return confDel('<?= $cat_title ?>')" class="Blue" ><?= $delete ?></a>              
                                &nbsp;
                            </td>
                        </tr>
    <?php } // foreach end // ?>
