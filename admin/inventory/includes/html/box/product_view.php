                                        ...
                                        <td align="center" valign="top" >
                                            <table width="100%" border="0" cellpadding="3" cellspacing="1"  class="borderall">
                                                ...
                                                <? if ($_GET["tab"] == "basic") { ?>
                                                    ...
                                                    <tr>
                                                        <td width="31%" align="right"   class="blackbold" >Product Name : </td>
                                                        <td width="69%" height="30" align="left">
                                               ...
                                               <td><? if ($arryProduct[0]['IsTaxable'] == 'Yes') echo 'Yes'; ?></td>
                                                 ...
                                                 <td><? if ($arryProduct[0]['FreeShipping'] == 'Yes') echo 'Yes'; ?></td>
                                               </tr>
                                                ...
                                                <? if ($_GET["tab"] == "description") { ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" valign="top">
                                                            <? echo stripslashes($arryProduct[0]['Detail']); ?>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td  align="left" valign="top">
                                                            <? echo stripslashes($arryProduct[0]['ShortDetail']); ?> </td>
                                                    </tr> 
                                                     <?php } ?>
                                                     <? if ($_GET["tab"] == "seo") { ?>
                                                            ...
                                                            <tr>
                                                              ...
                                                              <table width="100%" border="0" cellpadding="3" cellspacing="1">
                                                               ...
                                                               <td  colspan="2"  style="display:<?php if($arryProduct[0]['InventoryControl'] == "Yes"){?>table-cell<?php } else {?>none<?php }?>;" id="showInventoryControl"> 
                                                                    <table width="100%" border="0" cellpadding="3" cellspacing="1">
                                                             <tr>
                                                                <td  height="30"  class="blackbold" align="right">  If product is out of stock :</td>
                                                                <td>
                                                                ...
                                                                <tr>
                                                                    <td  height="30"  class="blackbold" align="right">Notify me when inventory is equal <br>to or less than :  </td>
                                                                <td>
