...
var warehouse = document.getElementById("from_WID").value;
...
$.fancybox.open({
                                ...
                                href:'addSerialNumber.php?id='+ln+'&total='+total+'&cond='+cond+'&warehouse='+warehouse+'&sku='+sku,
                                type: 'iframe',
  width:'50%', height:'75%',
                                helpers   : { 
...
<span style="<?=$serDisSub?>"  id="serialSub<?= $Line ?>"><a  onclick="frameDisplay(<?= $Line ?>);"   ><img src="../images/tab-new.png"  title="Serial number">&nbsp;Select S.N.</a>
       ...
       <td align="right"><input type="text" align="right" name="amount<?=$Line?>" id="amount<?=$Line?>" class="disabled" readonly size="15" maxlength="10" onkeypress="return isDecimalKey(event);" style="text-align:right;" value="<?=number_format($arryTransferItem[$Count]["price"]*$arryTransferItem[$Count]["qty"],2)?>"/></td>
