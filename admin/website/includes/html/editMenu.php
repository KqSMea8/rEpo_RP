                        ...
                        <td align="center" valign="middle">
                            ...
                            <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="borderall">
                                ...
                                <tr>
									...
									echo (!empty($arryMenu) && $values['MenuTypeId'] == $arryMenu[0]['MenuTypeId']) ? "selected" : "";
											 ...
											 <tr>
                                                ...
                                                <td width="56%"  align="left" valign="top">
													...
													<?php
													if(!empty($arryMenu) && $arryMenu[0]['ParentId']!=''){
													$webcmsObj->getParentMenus(0,0,$arryMenu[0]['ParentId']);	
													}else{
													$webcmsObj->getParentMenus(0,0);	
													}
                                            ...
                                            <tr>
                                                ...
                                                <td width="56%"  align="left" valign="top">
                                                    <input  name="Name" id="Name" value="<?=(!empty($arryMenu)) ? stripslashes($arryMenu[0]['Name']) : ''; ?>" type="text" class="inputbox"  size="50" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="30%" align="right" valign="top"  class="blackbold"> 
                                                    Alias : </td>
                                                <td width="56%"  align="left" valign="top">
                                                    <input  name="Alias" id="Alias" value="<?=(!empty($arryMenu)) ?stripslashes($arryMenu[0]['Alias']) : ''; ?>" type="text" class="inputbox" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="30%" align="right" valign="top"  class="blackbold"> 
                                                ...
                                                <td width="56%"  align="left" valign="top">
                                                    <input  name="Priority" id="Priority" onkeypress="return isNumberKey(event)" value="<?=(!empty($arryMenu)) ? stripslashes($arryMenu[0]['Priority']) : ''; ?>" type="text" class="inputbox" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="30%" align="right" valign="top"  class="blackbold"> 
                                                ...
                                                <td width="56%"  align="left" valign="top">
													...
													foreach ($ArticlesArray as $key => $values) {
														...
														echo (!empty($arryMenu) && $values['ArticleId'] == $arryMenu[0]['Link']) ? "selected" : "";
                                            ...
                                            <tr>
                                                <td width="30%" align="right" valign="top"  class="blackbold"> 
                                                    Meta Keywords :</td>
                                                <td width="56%"  align="left" valign="top">
													 <textarea style="width:60%; height: 85px;" class="inputbox" id="MetaKeywords" name="MetaKeywords"><?=(!empty($arryMenu)) ? stripslashes($arryMenu[0]['MetaKeywords']) : ''; ?></textarea>
                                            ...
                                            <tr>
                                                <td width="30%" align="right" valign="top"  class="blackbold"> 
                                                    Meta Title :</td>
                                                <td width="56%"  align="left" valign="top">
												 <textarea style="width:60%; height: 85px;" class="inputbox" id="MetaTitle" name="MetaTitle"><?=(!empty($arryMenu)) ? stripslashes($arryMenu[0]['MetaTitle']) : ''; ?></textarea>
                                            ...
                                            <tr>
                                                <td width="30%" align="right" valign="top"  class="blackbold"> 
                                                    Meta Description :</td>
                                                <td width="56%"  align="left" valign="top">
												 <textarea style="width:60%; height: 85px;" class="inputbox" id="MetaDescription" name="MetaDescription"><?=(!empty($arryMenu)) ? stripslashes($arryMenu[0]['MetaDescription']) : '';?></textarea>
