                                    ...
                                    <td align="center" valign="top" ><table width="100%" border="0" cellpadding="5" cellspacing="1" >
											<tr>
                                                ...
                                                <td width="56%"  align="left" valign="top">
													...
													foreach ($arryForms as $key => $values) {
														...
														echo (isset($arryFormField[0]['FormId']) && $values['FormId'] == $arryFormField[0]['FormId']) ? "selected" : "";
											...
											<tr>
                                                ...
                                                <td width="56%"  align="left" valign="top">
													...
													foreach ($FieldArray as $key => $values) {
														...
														echo (isset($arryFormField[0]['FieldType']) &&  strtolower($values) == $arryFormField[0]['FieldType']) ? "selected" : "";
														echo '>'.$values.'</option>';
                                            ...
                                            <tr>
                                                <td width="30%" align="right" valign="top"  class="blackbold"> 
                                                    Manadatory :</td>
                                                <td width="56%"  align="left" valign="top">
                                                    <input  name="Manadatory" id="Manadatory" value="1" type="checkbox" <?php echo (isset($arryFormField[0]['Manadatory']) && $arryFormField[0]['Manadatory'] == 'Yes') ? "checked" : "";?> />
                                                </td>
                                            </tr>
