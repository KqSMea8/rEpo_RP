                        ...
                        <tr align="left"  bgcolor="<?= $bgcolor ?>">
                           ...
                           <td height="26" align="center" ><?= $values['Added_date']; ?>     </td>
                            <td height="26" align="center"  valign="top">
                                <a href="showFormData.php?view=<?php echo $values['Added_no']; ?>&formId=<?php echo $values['FormId']; ?>" class="Blue"><?= $view ?></a>
                                <a href="showFormData.php?del_id=<?php echo $values['Added_no']; ?>&formId=<?php echo $values['FormId']; ?>" onclick="return confDel('<?= $values['Name'] ?>')" class="Blue" ><?= $delete ?></a>              
                                &nbsp;
                            </td>
                        </tr>
                    <?php } // foreach end //?>
