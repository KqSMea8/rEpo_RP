    ...
    unset($_SESSION['mess_Page']);
            ...
            <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
                <tr>
                    ...
                    <td width="39%" align="right"> <a href="editContent.php" class="add">Add New Page</a>      </td>
                </tr>
            ...
            <table <?= $table_bg ?>>
                ...
                if (is_array($arryArticles) && $num > 0) {
                    ...
                    foreach ($arryArticles as $key => $values) {
                        ...
                        echo '<a href="editContent.php?active_id=' . $values["ArticleId"] . '&curP=' . $_GET["curP"] . '" class="' . $status . '">' . $status . '</a>';
                        ?>
                            </td>
                            <td height="26" align="right"  valign="top">
                                <a href="editContent.php?edit=<?php echo $values['ArticleId']; ?>&curP=<?php echo $_GET['curP']; ?>" class="Blue"><?= $edit ?></a>
                                <a href="editContent.php?del_id=<?php echo $values['ArticleId']; ?>&curP=<?php echo $_GET['curP']; ?>" onclick="return confDel('<?= $values['Name'] ?>')" class="Blue" ><?= $delete ?></a>              
                                &nbsp;
                            </td>
                        </tr>
                    <?php } // foreach end //?>
