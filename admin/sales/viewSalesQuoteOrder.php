...
/******** Paypal Invoice testing code  By Ravi ********/
if(!empty($_GET['invoicetestcode'])){
...
$arrySale = $objSale->GetSale($_GET['sid'],'',$module);
...
/****************************End Custom Filter****************************************/
   	/*********Get Sales*************/	
		...
		if($Config['batchmgmt']==1){
					$arrySale=$objSale->ListSale($_GET); //updated by bhoodev 29feb//
					$Config['GetNumRecords'] = 1;
					$arryCount=$objSale->ListSale($_GET);//updated by chetan 29feb//
					$num=count($arryCount);
		}else{
