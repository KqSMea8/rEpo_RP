...
//print_r($exist);
        ...
        $arryProduct[0]['evaluationType'] = $exist[0]['evaluationType'];
         ...
         $arryProduct[0]['evaluationType'] = $ArrDetail[0]['evaluationType'];
...
if($arryProduct[0]['evaluationType'] =='LIFO'){
							...
							$_GET['LMT'] = 1;
							$_GET['Ordr'] = 'ASC';
							$_GET['Sku'] = $ArrDetail[0]['sku'];
              $_GET['Condition']  = $_GET['Condi'];
							$arryVendorPrice=$objItem->GetAvgTransPrice($ArrDetail[0]['ItemID'],$_GET);
							...
							$_GET['Sku'] = $ArrDetail[0]['sku'];
							$_GET['Condition']  = $_GET['Condi'];
							$arryVendorPrice=$objItem->GetAvgSerialPrice($ArrDetail[0]['ItemID'],$_GET);
							//$arryVendorPrice[0]['price'] = $arryVendorPrice[0]['price']/$arryVendorPrice[0]['total'];
							$cost[0]['AvgCost'] = $arryVendorPrice[0]['price'];
							}
...
//echo rtrim($arryContact[0]['CityName']); exit;
