<?php 
	...
	require_once($Prefix."classes/function.class.php");// by sachin
	require_once($Prefix."classes/purchase.class.php");

	$objFunction=new functions();//by sachin
...
if(!empty($_GET['POID'])){
		$arrySale[0]['OrderFrom'] = 'PO';
		$arrySale[0]['FromPO'] = $_GET['po'];
