...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <?  if($arryLeadForm[0]['formID']>0){ ?>
    ...
    <tr>
       <td align="right" >
    <a href="vRmaForm.php?formid=<?=$_GET['view']?>&opt=preview" class="fancybox grey_bt fancybox.iframe">View Preview</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="vRmaForm.php?formid=<?=$_GET['view']?>&opt=code" class="fancybox grey_bt  fancybox.iframe">View HTML Code</a>
       </td>
