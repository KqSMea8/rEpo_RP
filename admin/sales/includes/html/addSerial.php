          ...
          <tr>
              <td align="left" valign="top" width="250px">
                          ...
                          <?php for($i=0; $i< sizeof($serialValue); $i++){?>     
                               <option value="<?=$serialValue[$i]['serialNumber']?>" class="multiSelectBox" <?php if (in_array($serialValue[$i]['serialNumber'], $serial_value_sel)){echo "selected";}?>><?=$serialValue[$i]['serialNumber']?></option>
                          <?php }?>
                           </select> 
                          <?php } else {?>
