	...
	<tr>
	  <td  valign="top">
		...
		<div class="report_chart" >
			...
			<div class="cb3"></div>
			<? echo '<img  id="bChart" src="barSO.php?module=Order&f='.$_GET['f'].'&t='.$_GET['t'].'&fby='.$_GET['fby'].'&m='.$_GET['m'].'&y='.$_GET['y'].'&c='.$_GET['c'].'&st='.$_GET['st'].'" >'; 
			echo '<img  id="pChart" style="display:none" src="pieSO.php?module=Order&f='.$_GET['f'].'&t='.$_GET['t'].'&fby='.$_GET['fby'].'&m='.$_GET['m'].'&y='.$_GET['y'].'&c='.$_GET['c'].'&st='.$_GET['st'].'" >'; ?>
