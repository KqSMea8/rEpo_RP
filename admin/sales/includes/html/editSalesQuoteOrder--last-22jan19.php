...
if(document.getElementById("PaymentTerm").value != 'PayPal'){
		...
		if(!ValidateForSelect(frm.CityName, "City")){        
			return false;
		}
		...
		if(!ValidateForSelect(frm.ShippingCityName, "Shipping City")){        
			return false;
		}
...
// End by bhoodev for EDI 14 Feb 2018
    ...
    var selectCity =  document.getElementById("CityName");
	...
	var selectState =  document.getElementById("StateName");
	...
	// added by nisha for Country dropdown
...
<? if(!empty($_GET['edit']) && $arrySale[0]['EDIRefNo']!='') {?> <tr> <td align="right" class="blackbold">EDI Ref No :</td> <td align="left" colspan="3"><input name="EDIRefNo" type="text" class="inputbox disabled" readonly  id="EDIRefNo" value="<?php echo stripslashes($arrySale[0]['EDIRefNo']); ?>" maxlength="150" /></td> </tr> <? } ?>
