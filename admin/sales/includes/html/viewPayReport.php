...
<table <?=$table_bg?>>
  ...
  ?>
    <tr align="left" >
	   ...
	   <td>
<? if($_GET['pop']!=1){ ?>
<a class="fancybox fancybig fancybox.iframe" href="../finance/vInvoice.php?pop=1&view=<?=$values['OrderID']?>" ><?=$values["InvoiceID"]?></a>
...
<? if($_GET['pop']!=1){ ?>
<a class="fancybox fancybig fancybox.iframe" href="vSalesQuoteOrder.php?module=Order&pop=1&so=<?=$values['SaleID']?>" ><?=$values["SaleID"]?></a>
