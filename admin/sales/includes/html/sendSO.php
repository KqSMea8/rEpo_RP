 ...
 <?php if(sizeof($GetPFdTempalteNameArray)>0) { ?>
        ...
        <td   align="left" >
            <select class="inputbox" name='tempidd' id="tempID" onchange='makepdffile("../pdfCommonhtml.php?o=<?= $_GET['view'] ?>&module=<?= $_GET['module'] ?>&attachfile=1&ModuleDepName=<?=$ModuleDepName?>")'>
                 <?php //Added on 19Apr2018 by chetan for default dynamic temp//
				$dId = '';
...
<?php /* <tr>
        ...
        <td  align="right"   class="blackbold" width="20%">Signature : </td>
        <td   align="left" >
            <select class="inputbox" name='empSignature' id="empSignature">
                <option value="0">Default</option>
                <?php 
              foreach($GETEmaiSignatureArray as $vals){
