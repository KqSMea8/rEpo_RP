...
window.parent.document.getElementById("SalesPersonType").value=responseText["SalesPersonType"];
	...
	window.parent.document.getElementById("Country").value=responseText["CountryName"];
		...
		window.parent.document.getElementById("City").value=responseText["CityName"];
		window.parent.document.getElementById("CountryName").value = responseText["country_id"];
	if(responseText["StateName"]!='' && responseText["state_id"]>0){
	   	window.parent.document.getElementById("State").value=responseText["StateName"];
	   	window.parent.document.getElementById("StateName").value =	responseText["state_id"];
	   	window.parent.document.getElementById("billUsedState").value =	1;
	}else{
	
	 	window.parent.document.getElementById("billstate_tr").style.display ='none';
	 	window.parent.document.getElementById("billUsedState").value =	0;
	  
	
	}
 
		window.parent.document.getElementById("CityName").value = responseText["city_id"];
...
//alert(responseText["sStateid"]);
//loadState(responseText["sCountryid"],responseText["sStateid"]);
if(responseText["sStateName"]!='' && responseText["sStateid"]>0){
	window.parent.document.getElementById("ShippingState").value=responseText["sStateName"];
window.parent.document.getElementById("ShippingStateName").value=responseText["sStateid"];
window.parent.document.getElementById("state_tr").style.display ='';
window.parent.document.getElementById("UsedState").value =	1;
}else{
window.parent.document.getElementById("state_tr").style.display ='none';
window.parent.document.getElementById("UsedState").value =	0;
