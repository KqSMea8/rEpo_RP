        ...
        $LineItem='<table style="width:100%; border:0;cellpadding:0; cellspacing:0;border-collapse:collapse;" >
	 		<tr style=" background:'.$LineHeadbackColor.';">
	 			<td  style="width:12%;border:1px solid #e3e3e3;color:#fff;text-align:left; font-size:'.$LineItemFontSize.'px; font-weight:'.$LineItemHeadingBold.'; color:'.$LineHeadColor.';">SKU</td>
                                ...
                                <td  style="width:25%; border:1px solid #e3e3e3;color:#fff; text-align:left; font-size:'.$LineItemFontSize.'px; font-weight:'.$LineItemHeadingBold.'; color:'.$LineHeadColor.';">Description</td>
                                <td  style="width:10%; border:1px solid #e3e3e3;color:#fff;text-align:left; font-size:'.$LineItemFontSize.'px; font-weight:'.$LineItemHeadingBold.'; color:'.$LineHeadColor.';">Qty Ordered</td>
