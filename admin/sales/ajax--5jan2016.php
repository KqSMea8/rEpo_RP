...
/**comment in 17 june2015 **/
		...
		case 'CustomerInfo':
			...
			$arryCustomer = $objCustomer->GetCustomerAllInformation('',$_GET['CustCode'],'');	if($arryCustomer[0]['CustomerName']!=''){ $arryCustomer[0]['CustomerName'] = $arryCustomer[0]['CustomerName'];}else{ $arryCustomer[0]['CustomerName'] = $arryCustomer[0]['CustomerCompany']; }
...
$html = '';
	...
	case 'SelectItem' :$objItem=new items();   
                                $objPager = new pager();
