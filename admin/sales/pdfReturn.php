<?	
    ...
    $ModuleIDTitle = "Return Number"; $ModuleID = "ReturnID"; $PrefixSO = "RTN";  $NotExist = NOT_EXIST_Return;
	$ModuleName = $module;

	if(!empty($_GET['RTN'])){
		$arrySale = $objSale->GetSale($_GET['RTN'],'',$module);
	...
	$pdf->ezSetDy(-5);
    if($NumLine>0){
        $Head1 = '<b>SKU</b>'; $Head2 = '<b>Condition</b>'; $Head3 = '<b>Description</b>'; $Head4 = '<b>Qty Ordered</b>'; $Head5 = '<b>Qty Invoiced</b>'; $Head6 = '<b>Qty Returned</b>'; $Head7 = '<b>Unit Price</b>'; $Head8 = '<b>Discount</b>'; $Head9 = '<b>Taxable</b>'; $Head10 = '<b>Amount</b>'; 
		...
		for($Line=1;$Line<=$NumLine;$Line++) { 
		    ...
		    $arryDef[$i][$Head5] = number_format($qty_invoiced);
        ...
        $pdf->ezTable($data,'','',array('cols'=>array($Head1=>array('justification'=>'left','width'=>'50'),$Head2=>array('justification'=>'left','width'=>'50'),$Head3=>array('justification'=>'left','width'=>'50'),$Head4=>array('justification'=>'left','width'=>'60'),$Head5=>array('justification'=>'left','width'=>'60'),$Head6=>array('justification'=>'left','width'=>'60'),$Head7=>array('justification'=>'left','width'=>'50'),$Head8=>array('justification'=>'left','width'=>'40'),$Head9=>array('justification'=>'right')), 'shaded'=>0,'shadeCol'=>array(0.9,0.9,0.9), 'showLines'=>2 , 'xPos' =>300 ,'width'=>500,'fontSize'=>8,'showHeadings'=>0, 'colGap'=>2, 'rowGap'=>2) );
