...
/*************************/
$arryLead=$objLead->LearReportBysalesperson($_GET);
...
$filename = "LeadSalesPersonList_".date('d-m-Y').".xls";
if($num>0){
	...
	$header = "Lead Name\tleadDate\tSales Person\tRating";
    ...
    */
		...
		$line = stripslashes($values["FirstName"]).' '.stripslashes($values["LastName"])." \t".stripslashes($values["LeadDate"])."\t".stripslashes($values["UserName"])."\t".stripslashes($values["Rating"])."\n";
