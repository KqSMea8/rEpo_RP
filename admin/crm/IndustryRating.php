...
if($num>0){
	...
	$header = "Lead Name\tRating\tJoiningDate\tIndustry";
    ...
    */
		...
		$line = stripslashes($values["FirstName"])." \t".stripslashes($values["Rating"])."\t".stripslashes($values["JoiningDate"])."\t".stripslashes($values["Industry"])."\n";
