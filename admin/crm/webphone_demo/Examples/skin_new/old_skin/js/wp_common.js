...
{
var treatuserserverinputasupperserver = 'true'; // treat serveraddress_user as upperserver. Used in case of standalone tunnel server
...
wp_LoadAppletAndRegister: function ()
{
	...
	{
            if (treatuserserverinputasupperserver === 'true')
            {
