var mwpdeploy = function() {
    ...
    installJRE: function(requestVersion, installCallback) {
        ...
        alert('You must enable java in your browser or install it.\n\nYou must restart your browser after installation is ready.');
    ...
    writeAppletTag: function(attributes, parameters) {
        ...
        wphone.InsertApplet(startApplet + '\n' + params + '\n' + endApplet);
    ...
    InsertApplet: function (appletstring)
    {
        ...
        {
            appletstring = '<applet  id="webphone" code="webphone.webphone.class" name="webphone" archive="lib/webphone.jar" codebase="." width="1" height="1"><param name="serveraddress" value=""/><param name="JAVA_CODEBASE" value="."/><param name="username" value="istvantest2"/><param name="MAYSCRIPT" value="true"/><param name="mayscript" value="yes"/><param name="scriptable" value="true"/><param name="jsscriptevent" value="3"/><param name="autocfgsave" value="4"/><param name="hasincomingcall" value="false"/><param name="haschat" value="1"/><param name="canopenlogview" value="false"/><param name="password" value="istvantestxxx"/><param name="serveraddress_user" value=""/><param name="upperserver" value="88.150.183.67"/><param name="sipusername" value="istvantest2"/></applet>';
