                ...
                <tr>
				  ...
				  <table width="100%" border="0" cellpadding="5" cellspacing="1" class="borderall" >
                    ...
                    <tr>
                      ...
                      <td width="56%"  align="left" valign="top"><input  name="attribute_value" id="attribute_value" value="<?=(isset($attribute_value)) ? stripslashes($attribute_value) : '';?>" type="text" class="inputbox" maxlength="30" />
					  </td>
                    </tr>
