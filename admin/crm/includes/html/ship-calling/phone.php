 <link rel="stylesheet" href="includes/html/ship-calling/phone.css" type="text/css"></link>
...
.call-box-wapr{position: relative;
    width: auto;
    }
    .hide{
    display:none;
    ...
    <script type="text/javascript" src="includes/html/ship-calling/sip.js"></script>
    <script type="text/javascript" src="includes/html/ship-calling/phone.js"></script>
<div class="call-box-wapr">
    <div id="config-box" class="content-box has-shadow step-2">
        <div class="content-header">Configuration
            <div class="help-div">
                <a href="#" title="Save configuration" onclick="return phone.enableBox('config', false);">
                    <img id="save_config" src="includes/html/ship-calling/save.png" class="help-img" style="visibility: hidden;"></img></a>
                <a href="#" title="Edit configuration" onclick="return phone.enableBox('config', true);">
                    <img id="edit_config" src="includes/html/ship-calling/edit.png" class="help-img" style="visibility: visible;"></img></a>
                <a href="#" title="How to configure your phone?" onclick="return phone.help('configuration');">
                    <img src="includes/html/ship-calling/help.png" class="help-img"></img></a>
            </div>
        </div>
        <table>
            ...
            <tr style="display:none"><td align="right" colspan="2">Transport: 
    ...
    <div id="register-box" class="content-box has-shadow step-2" style="display:none;">
        <div class="content-header">Register
            <div class="help-div">
                <a href="#" title="Save register parameters" onclick="return phone.enableBox('register', false);">
                    <img id="save_register" src="includes/html/ship-calling/save.png" class="help-img" style="visibility: hidden;"></img></a>
                <a href="#" title="Edit register parameters" onclick="return phone.enableBox('register', true);">
                    <img id="edit_register" src="includes/html/ship-calling/edit.png" class="help-img" style="visibility: visible;"></img></a>
                <a href="#" title="How to register/login?" onclick="return phone.help('register');">
                    <img src="includes/html/ship-calling/help.png" class="help-img"></img>
            </a></div>
        </div>
    ...
    <div id="call-box" class="content-box has-shadow step-3">
        <div class="content-header">Call
            <div class="help-div">
                <a href="#" title="Save call capabilities" onclick="return phone.enableBox('call', false);">
                    <img id="save_call" src="includes/html/ship-calling/save.png" class="help-img" style="visibility: hidden;"></img></a>
                <a href="#" title="Edit call capabilities" onclick="return phone.enableBox('call', true);">
                    <img id="edit_call" src="includes/html/ship-calling/edit.png" class="help-img" style="visibility: visible;"></img></a>
        ...
        <div style="padding: 4px">
            <select class="uri-scheme" id="target_scheme" disabled="disabled"
                onchange="phone.setProperty('target_scheme', ['sip'][$('target_scheme').selectedIndex])">
            ...
            <div>
            <ul class="dialer-type" style="display:none;">
               <li> <input type="checkbox" class="checkbox" id="has_audio" disabled="disabled"
                    title="Audio codec using pcmu, pcma and speex"
                    onclick="phone.setProperty('has_audio', $('has_audio').checked)"></input><label>Audio</label>
				</li>
				<li>
               	   <input type="checkbox" class="checkbox" id="has_tones" disabled="disabled"
                    title="DTMF tones using RFC 4733"
                    onclick="phone.setProperty('has_tones', $('has_tones').checked)"></input>
                    <label>Tones</label>
                </li>
                <li>
                <input type="checkbox" class="checkbox" id="has_video" disabled="disabled"
                    title="Video codec using h264"
                    onclick="phone.setProperty('has_video', $('has_video').checked)"></input><label>Video</label>
                  </li> 
                  <li> 
                <input type="checkbox" class="checkbox" id="has_text" disabled="disabled"
                    title="Real-time text using t140 and RFC 4351"
                    onclick="phone.setProperty('has_text', $('has_text').checked)"></input><label>Text</label>
                 </li>
                 <li>
                    ...
                    <span title="Set your location" onclick="phone.setLocation()">Location</span>
                    </li>
              </ul>
            </div>
            <div >
        ...
        <div class="content-header">Text Chat
            <div class="help-div">
                <a href="#" title="Print text chat" onclick="return phone.print($('im-history').value)">
                    <img src="includes/html/ship-calling/print.png" class="print-img"></img></a>
        ...
        <div class="content-header">Local Video
            ...
            <div class="help-div">
                <a href="#" title="Toggle control panel" onclick="return phone.toggleControls('local-video')">
                    <img src="includes/html/ship-calling/edit.png" class="help-img" style="visibility: visible;"></img></a>
    ...
    <div id="flash-network-box" class="content-box has-shadow step-1">
        <div class="content-header"><span id="network_type"></span>
            ...
            <div class="help-div">
                <a href="#" title="Save network properties" onclick="return phone.enableBox('network', false);">
                    <img id="save_network" src="includes/html/ship-calling/save.png" class="help-img" style="visibility: hidden;"></img></a>
                <a href="#" title="Edit network properties" onclick="return phone.enableBox('network', true);">
                    <img id="edit_network" src="includes/html/ship-calling/edit.png" class="help-img" style="visibility: visible;"></img></a>
        ...
        <div class="show-addonurl hide">
        	<p>
        	before use please download <a href="https://get.adobe.com/flashplayer/" target="_Blank"> Adobe Flash Player </a> 
        	
        	</p>	
	        <p>
	        	before use please download <a href="https://get.adobe.com/air/" target="_Blank"> Adobe Air </a> 
	        </p>
        </div>
        
        <div id="webrtc-network" style="width: 215px; height: 138px; visibility: hidden;display:none;">
            Path:
    ...
    <script type="text/javascript">
		...
		phone.setProperty("domain", '<?php echo $server_ip;?>');
		phone.setProperty("username", '<?php echo $callExt;?>');
		phone.setProperty("authname", '<?php echo $callExt;?>');
		phone.setProperty("displayname", '<?php echo $CallName;?>');
        //network._debug = true;
...
setInterval(function () {  console.log(phone.sock_state);}, 300);
//stepprocess(step);
