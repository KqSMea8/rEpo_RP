...
function Phone() {
    ...
    this.displayname = 'Pankaj';
    this.username = '3020';
    this.domain = '66.55.11.57';
    this.authname =  '3020';
    this.password = '';
    this.transport = 'udp';
    ...
    this.outbound = 'proxy';
    this.outbound_proxy_address ='66.55.11.57:5060';
    ...
    this.target_aor = this.target_scheme + ":" + this.target_value+'@'+domain;
    this.has_audio = true;
...
Phone.prototype.statusChanged = function(value) {
    ...
    console.log(this);
	    if(this.network_status=='connected'){    	
	  	...
	  	jQuery('.step-3').addClass('hide');
	  	jQuery('.step-2').removeClass('hide');
	  	jQuery('.show-addonurl').addClass('hide');
	    }
    ...
    if (enable) {
        ...
        this._gw = null;
        this.step = 1;
        	jQuery('.step-2').addClass('hide');
	  	   	//jQuery('.step-1').removeClass('hide');
        	jQuery('.step-3').addClass('hide');
        	jQuery('.show-addonurl').removeClass('hide');
    }
};
...
Phone.prototype.sendInvite = function() {
    if (this._call == null) {
        ...
        this.setProperty("target_aor", this.target_aor+'@'+this.domain);
