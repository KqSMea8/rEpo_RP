                ...
                <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td align="center" valign="middle">
							...
							foreach( $arryTemplates as $i => $values )
							{
								...
								echo "\t\t<td class=\"blackbold\"><img width=\"205px;\" height=\"150px;\" src=\"".$Prefix."template/".$values['TemplateName']."/".$values['Thumbnail']."\" ><br><br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input type=\"button\"  onclick=\"submitform('".$values['TemplateId']."')\" name=\"activate\" ";  
								if(!empty($arrySetting) && $arrySetting[0]['TemplateId']==$values['TemplateId']) 
								echo "value=\"Active\" class=\"activate\">";
								else echo "value=\"Apply\" class=\"apply\"></td>\n";
                    ...
                    <tr>
                        <td align="center" height="135" valign="top"><br>
                            ...
                            <input type="hidden" name="Id" id="Id" value="<?=(!empty($arrySetting)) ? $arrySetting[0]['Id'] : ''; ?>" />
