        ...
        <td  valign="top">
			...
			<img class="ui-datepicker-trigger" src="../images/cal.png" alt="..." title="..." onclick="calIcon(this)">
				...
				<img class="ui-datepicker-trigger" src="../images/cal.png" alt="..." title="..." onclick="calIcon(this)">
				 ...
				 <input type="hidden" name="tab" value="call"/>
				 <?php if(!empty($_GET['module'])){  ?>
				 <input type="hidden" name="module" value="<?php echo $_GET['module']; ?>"/>
				 <?php  } ?>
				 <input type="submit"  value="Go" class="button"> </li>
                </ul>
                    ...
                    <table <?= $table_bg ?>>
                        ...
                        if (isset($results) && count($results)>0) {
                            ...
                            foreach ($results as $key => $values) {
                                ...
                                if((in_array($values[1],$extension_array) OR in_array($values[2],$extension_array)) && (in_array($values[1],$arrayPhone) OR in_array($values[2],$arrayPhone))) {
