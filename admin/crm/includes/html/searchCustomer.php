...
<?php } elseif(empty($_GET['customerid']) && (!empty($values['InstagramID'])) && ($_GET['type']=="instagram")) {?>
<a href="?customerid=<?= $values['Cid'] ?><?php echo $data; ?>&url=<?php echo $_GET['url'];?>&curP=<?= $_GET['curP'] ?>" >Overwrite</a>

<?php } elseif(empty($_GET['customerid']) && (!empty($values['GoogleID'])) && ($_GET['type']=="googleplus")) {?>
<a href="?customerid=<?= $values['Cid'] ?><?php echo $data; ?>&url=<?php echo $_GET['url'];?>&curP=<?= $_GET['curP'] ?>" >Overwrite</a>
