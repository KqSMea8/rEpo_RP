...
<div class="had">Flagged Emails</div>
            ...
            <form action="" method="post" name="form1">
                    ...
                    <table <?= $table_bg ?>>
                            ...
                            <tr align="left"  >
                             <!-- <td width="0%" class="head1" ><input type="checkbox" name="SelectAll" id="SelectAll" onclick="Javascript:SelectCheckBoxes('SelectAll','AddID','<?= sizeof($arryContact) ?>');" /></td>-->
                                ...
                                <td width="7%"  class="head1" >Type</td>
                                ...
                                <td width="9%"  align="center"  class="head1 head1_action" >Date</td>
				...
				if($values['Status']) $boldtext = "font-weight:bold;";
                                ...
                                if($values["MailType"]=='Sent')
                                {
                                  ...
                                  $type_text='sent';
                                }else if($values["MailType"]=='TrashCan')
                                {
                                  $type_text='trash';  
                                }
                                else if($values["MailType"]=='Draft')
                                {
                                  $type_text='Draft';    
                                }
                                else if($values["MailType"]=='Inbox')
                                {
                                  $values["Recipient"]=$values["To_Email"];
                                  $type_text='inbox';       
                                }
                                else if($values["MailType"]=='Spam')
                                {
                                  $values["Recipient"]=$values["To_Email"];
                                  $type_text='spam';   
                                }
                                ...
                                <tr align="left" >
                                      ...
                                      <td align="left" style="line-height:30px;" >
                                          ...
                                          <a href="viewEmail.php?ViewId=<?php echo $values["autoId"] ?>&type=<?=$type_text?>&flagged=Yes">
