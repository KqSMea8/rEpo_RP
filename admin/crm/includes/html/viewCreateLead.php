...
<a href="leadForm.php?view=<?php echo $values['formID']; ?>&amp;curP=<?php echo $_GET['curP']; ?>" ><?= $edit ?></a>
                                  

                                    <a href="leadForm.php?del_id=<?php echo $values['formID']; ?>&amp;curP=<?php echo $_GET['curP']; ?>" onclick="return confirmDialog(this, '<?= $ModuleName ?>')"  ><?= $delete ?></a>   </td>
