...
<?
	/*********************/
	/*********************/
	$FirstName = $arryContact[0]['FirstName'];	
...
<a class="download" style="float:right;" target="_blank" href="pdfContactView.php?AddID=<?=$_GET['view']?>">Download</a>

<div class="had">
Manage Contact    <span>&raquo;

<?php if($_GET['tab'] == 'Email'){ echo 'Email'; }else{ echo 'Contact Details';}?>
