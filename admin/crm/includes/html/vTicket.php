...
if($arryTicket[0]['sendnotification'] == 1 && $h == 0){?>
    <tr>
            <td  align="right"  class="blackbold"> Notifications  :</td>
            <td   align="left" > <?php echo stripslashes($arryTicket[0]['notifications']); ?>  </td>
    </tr>
<?php 
