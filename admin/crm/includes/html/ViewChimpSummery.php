...
<div class="had"><?= $MainModuleName ?> View Report</div>
...
<form action="" method="post" name="form1">
 ...
 <?php if(!empty($viewsummer)) { ?>
        <tr>
            <td  valign="top">
                <div id="prv_msg_div" style="display:none"><img src="images/loading.gif">&nbsp;Searching..............</div>
               
                <div id="preview_div">
                    <h1><?php echo $GetcampaignSummery[0]['title']; ?></h1>
                    <h2><?php echo 'Subject:&nbsp;' . $GetcampaignSummery[0]['subject']; ?></h2>
                    <h3><?php echo $viewsummer['emails_sent'] . '&nbsp;Recipients'; ?></h3>
