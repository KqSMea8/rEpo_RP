                                ...
                                <tr>
                                    <td align="center" valign="top" ><table width="100%" border="0" cellpadding="5" cellspacing="1" >
                                            ...
                                            <tr>
                                                ...
                                                <td width="56%"  align="left" valign="top">
                                                    <input  name="Title" id="Title" value="<?=(isset($arryArticle[0]['Title'])) ? stripslashes($arryArticle[0]['Title']) : ''; ?>" type="text" class="inputbox"  size="50" />
                                                </td>
                                            </tr>
                                           ...
                                           <tr>
                                                ...
                                                <td width="56%"  align="left" valign="top">
                                                    <input  name="Priority" id="Priority" onkeypress="return isNumberKey(event)" value="<?=(isset($arryArticle[0]['Priority'])) ? stripslashes($arryArticle[0]['Priority']) : ''; ?>" type="text" class="inputbox" />
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" class="blacknormal">
                                                    <table width="151" border="0" cellpadding="0" cellspacing="0"  class="blacknormal margin-left">
                                                        <tr>
                                                            <td width="20" align="left" valign="middle"><input name="Status" type="radio" value="1" <?= (isset($PageStatus) && $PageStatus == "Yes") ? "checked" : "" ?> /></td>
                                                            <td width="48" align="left" valign="middle">Active</td>
                                                            <td width="20" align="left" valign="middle"><input name="Status" type="radio" <?= (isset($PageStatus) && $PageStatus == "No") ? "checked" : "" ?> value="0" /></td>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2" align="left" valign="top" class="editor_box">
                                                    ...
                                                    <textarea name="Fulltext" id="full_text"><?=(isset($arryArticle[0]['Fulltext'])) ? stripslashes($arryArticle[0]['Fulltext']) :''; ?></textarea>
                                                    <script type="text/javascript">
