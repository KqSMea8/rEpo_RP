    ...
    unset($_SESSION['mess_Page']);
            ...
            <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
                <tr>
                    ...
                    <td width="39%" align="right"> <a href="editMenu.php?CustomerID=<?php echo  $_REQUEST['CustomerID'];?>" class="add">Add New Menu</a>      </td>
                </tr>
            ...
            <table <?= $table_bg ?>>
                <tr align="left" >
                    <td width="30%" height="20"  class="head1">Menu Name</td> 
					<td width="30%" height="20"  class="head1">Menu Type</td> 
                ...
                if (is_array($arryMenus) && $num > 0) {
                    ...
                    foreach ($arryMenus as $key => $values) {
                        ...
                        echo '<a href="editMenu.php?active_id=' . $values["MenuId"] .'&CustomerID=' . $_REQUEST['CustomerID'] .  '&curP=' . $_GET["curP"] . '" class="' . $status . '">' . $status . '</a>';
                        ?>
                            </td>
                            <td height="26" align="right"  valign="top">
                                <a href="editMenu.php?edit=<?php echo $values['MenuId']; ?>&curP=<?php echo $_GET['curP']; ?>&CustomerID=<?php echo  $_REQUEST['CustomerID'];?>" class="Blue"><?= $edit ?></a>
                                <a href="editMenu.php?del_id=<?php echo $values['MenuId']; ?>&curP=<?php echo $_GET['curP']; ?>&CustomerID=<?php echo  $_REQUEST['CustomerID'];?>" onclick="return confDel('<?= $values['Name'] ?>')" class="Blue" ><?= $delete ?></a>              
                                &nbsp;
                            </td>
                        </tr>
                    <?php } // foreach end //?>
