...
<!-- Here we create or get an existing "Account" object called "Sample". The "Account" is going to use the SIP protocol -->                        
      Account = Zoiper.AddAccount("Ravi", "sip");
<!-- Here we set the "Account" properties -->                    
      Account.Domain   = "66.55.11.57";
      Account.CallerID = "Ravi";
      Account.UserName = "3021";
      Account.Password = "xeeQu3nuphab";
...
<!-- Here we define the HTML elements we are going to need in this example -->
  <table border=1 width=100%>
    ...
    <tr>
      <td width=100%>
        Number&nbsp;<input id="number" type="text" class="inputbox"/>
        <button onclick="Dial()" class="button dial">Dial</button>
       <!--  <button onclick="Hold()" class="button">Hold</button>-->
        <button onclick="Hang()" class="button hang">Hang</button>
      </td>
    </tr>
    <!-- <tr>
      <td width=100%>
