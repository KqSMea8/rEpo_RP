    ...
    unset($_SESSION['mess_Page']);
            ...
            <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
                <tr>
                    ...
                    <td width="39%" align="right"> <a href="editForm.php?CustomerID=<?php echo  $_REQUEST['CustomerID'];?>" class="add">Add New Form</a>      </td>
                </tr>
            ...
            <table <?= $table_bg ?>>
                ...
                if (is_array($arryForms) && $num > 0) {
                    ...
                    foreach ($arryForms as $key => $values) {
                        ...
                        echo '<a href="editForm.php?active_id=' . $values["FormId"] .'&CustomerID=' . $_REQUEST['CustomerID'] . '&curP=' . $_GET["curP"] . '" class="' . $status . '">' . $status . '</a>';
                        ?>
                            </td>
                            <td height="26" align="right"  valign="top">
                                <a href="editForm.php?edit=<?php echo $values['FormId']; ?>&curP=<?php echo $_GET['curP']; ?>&CustomerID=<?php echo  $_REQUEST['CustomerID'];?>" class="Blue"><?= $edit ?></a>
                                <a href="editForm.php?del_id=<?php echo $values['FormId']; ?>&curP=<?php echo $_GET['curP']; ?>&CustomerID=<?php echo  $_REQUEST['CustomerID'];?>" onclick="return confDel('<?= $values['Name'] ?>')" class="Blue" ><?= $delete ?></a>              
                                &nbsp;
                            </td>
                        </tr>
                    <?php } // foreach end //?>
