...
<div class="had">Trash Emails</div>
                    ...
                    <table <?= $table_bg ?>>
                            ...
                            <tr align="left"  >
                             <!-- <td width="0%" class="head1" ><input type="checkbox" name="SelectAll" id="SelectAll" onclick="Javascript:SelectCheckBoxes('SelectAll','AddID','<?= sizeof($arryContact) ?>');" /></td>-->
                                ...
                                <td width="1%" class="head1" align="center" ><input type="checkbox" name="SelectAll" id="SelectAll" onclick="Javascript:SelectCheckBoxes('SelectAll', 'emailID', '<?= sizeof($arryTrashItems) ?>');" /></td>
                            </tr>

                        <?php
                        
                       
                        if (is_array($arryTrashItems) && $num > 0) {
                            $flag = true;
                            $Line = 0;
                            
                            
                            foreach ($arryTrashItems as $key => $values) {
                                $flag = !$flag;
				...
				if($values['Status']) $boldtext = "font-weight:bold;";
                                ...
                                <tr align="left"  bgcolor="<?= $bgcolor ?>">
                                      ...
                                      <td align="left" style="line-height:30px;" >
                                          ...
                                          <a href="viewEmail.php?ViewId=<?php echo $values["autoId"] ?>&type=trash">
...
<?php } ?>
                        ...
                        <tr >  <td  colspan="8" >Total Record(s) : &nbsp;<?php echo $num; ?>      <?php if (count($arryTrashItems) > 0) { ?>
...
?></td>
                ...
                <input type="hidden" name="NumField" id="NumField" value="<?= sizeof($arryTrashItems) ?>">
