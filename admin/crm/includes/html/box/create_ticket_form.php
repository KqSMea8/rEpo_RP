...
if(!empty($_SESSION['msg_lead_form'])){
 ...
 <!--tr>
   ...
   <tr>
    ...
    <tr>
       <td align="center" ><br>
     <textarea name="Description" type="text" class="textarea" id="Description" style="width:90%;height:800px;" readonly  ><?php if(isset($arryLeadForm[0]['HtmlForm'])) echo htmlentities(stripslashes($arryLeadForm[0]['HtmlForm'])) ?></textarea>    
...
<td  align="right"   class="blackbold" width="20%"> Form Title : <span class="red">*</span> </td>
        <td   align="left" >          
                <input name="FormTitle" type="text" class="inputbox" id="FormTitle"   value="<?php echo (isset($arryLeadForm[0]['FormTitle'])) ? stripslashes($arryLeadForm[0]['FormTitle']) : ""; ?>"  maxlength="100" />        
           </td>
</tr>
...
<td  align="right"   class="blackbold"> Subtitle : <span class="red">*</span> </td>
        <td   align="left" >          
                    <input name="Subtitle" type="text" class="inputbox" id="Subtitle"   value="<?php echo (isset($arryLeadForm[0]['Subtitle'])) ?  stripslashes($arryLeadForm[0]['Subtitle']) : ''; ?>"  maxlength="100" />        
           </td>
</tr>
...
<td  align="right"   class="blackbold" valign="top"> Description :  </td>
        <td   align="left" >          
                <textarea name="Description" type="text" class="textarea" id="Description" maxlength="500" ><?php echo (isset($arryLeadForm[0]['Description'])) ?  stripslashes($arryLeadForm[0]['Description']) : ''; ?></textarea>    
           </td>
</tr>
