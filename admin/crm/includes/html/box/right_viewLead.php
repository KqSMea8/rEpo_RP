<div class="right-search">
               ...
               <div class="right_box">
<ul class="rightlink">
<li <?=($_GET['tab']=="todays")?("class='active'"):("");?>><a href="<?=$RedirectUrl?>&tab=todays" >Todays Leads</a></li>
...
<br><br>
 ...
 <? if($_GET['module']=='lead'){ require_once("../includes/html/box/right_custom.php");} ?>

<fieldset>
<!--By chetan 25dec-->
			<?php if(isset($RowColorDropDown)){?> 
			<label id="highlight">Search By Color: <label>
                        <?php echo $RowColorDropDown; 
			} ?>
			<!--End-->
</fieldset>
<? //edit by ali for DateRange ?>
<fieldset>
...
<input id="FromDate" name="FromDate" readonly=""  value="<?=$FromDate?>"  type="text" > 
                    </fieldset>
