...
.fblogin {
    background: url("images/sig.png") no-repeat scroll 0 0 transparent;
    cursor: pointer;
    height: 29px;
    margin-right: 6px;
    margin-top: 0;
...
<div id="status" style="display: inline-block; margin-top: 20px;"></div>
<span class="fblogut" style="display: inline-block; float: right; margin-top: 20px; display:none;"><a class="back" href="javascript:void(0)" onclick="window.history.back();">Back</a>
    <a class="fancybox add_quick" href="facebook-friends.php">Friends List</a></span>
