...
<input type="button" class="export_button"  name="exp" value="Export To Excel" onclick="Javascript:window.location ='export_annualRevenue.php?<?= $QueryString ?>';" />
...
<table <?=$table_bg?>>
    ...
    <tr align="left"  >
        <td width="25%"  class="head1" >Lead Name</td>
        <td width="20%" class="head1" >Lead Date</td>
        <td  class="head1" >AnnualRevenue</td>
