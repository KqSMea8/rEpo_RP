...
<form action="" method="post" name="form1">
 ...
 <tr>  
            <td  valign="top" align="right">
                ...
                <a href="meetingLeadForm.php" class="add fancybox fancybox.iframe" >Generate Site Link</a>
                     
<? if ($_GET['key'] != '') { ?>
                    <a class="grey_bt"  href="viewCreateLead.php">View All</a>
        <? } ?>
...
<!-- code by bhoodev-->
<a href="vLeadForm.php?formid=<?php echo $values['formID']; ?>&opt=code" class="fancybox fancybox.iframe" >Html Code</a>
<a href="vLeadForm.php?formid=<?php echo $values['formID']; ?>&opt=preview" class="fancybox fancybox.iframe" ><?=$view?></a>
<a href="meetingLeadForm.php?del_id=<?php echo $values['formID']; ?>&amp;curP=<?php echo $_GET['curP']; ?>" onclick="return confirmDialog(this, '<?= $ModuleName ?>')"  ><?= $delete ?></a>   </td>
