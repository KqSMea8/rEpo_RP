...
<input type="button" class="export_button"  name="exp" value="Export To Excel" onclick="Javascript:window.location ='export_territory.php?<?= $QueryString ?>';" />
...
<table <?=$table_bg?>>
    ...
    <tr align="left"  >
        <td width="14%"  class="head1" >Lead Name</td>
