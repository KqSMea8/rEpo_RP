				...
				echo (!empty($arryMenu) && $values['MenuTypeId'] == $arryMenu[0]['MenuTypeId']) ? "selected" : "";
											 ...
											 <tr>
                                                ...
                                                <td width="56%"  align="left" valign="top">
													...
													$webcmsObj->getParentMenus(0,0,'',$CustomerID);	
													}							
                                            ...
                                            <tr>
                                                ...
                                                <td width="56%"  align="left" valign="top">
                                                    <input  name="Name" id="Name" value="<?=(isset($arryMenu[0]['Name'])) ? stripslashes($arryMenu[0]['Name']) : ''; ?>" type="text" class="inputbox"  size="50" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="30%" align="right" valign="top"  class="blackbold"> 
                                                    Alias : </td>
                                                <td width="56%"  align="left" valign="top">
                                                    <input  name="Alias" id="Alias" value="<?=(isset($arryMenu[0]['Alias'])) ? stripslashes($arryMenu[0]['Alias']) : ''; ?>" type="text" class="inputbox" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="30%" align="right" valign="top"  class="blackbold"> 
                                                ...
                                                <td width="56%"  align="left" valign="top">
                                                    <input  name="Priority" id="Priority" onkeypress="return isNumberKey(event)" value="<?=(isset($arryMenu[0]['Priority'])) ? stripslashes($arryMenu[0]['Priority']) : ''; ?>" type="text" class="inputbox" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="30%" align="right" valign="top"  class="blackbold"> 
									...
									echo (!empty($arryMenu) && $values['ArticleId'] == $arryMenu[0]['Link']) ? "selected" : "";
                                            ...
                                            <tr>
                                                <td width="30%" align="right" valign="top"  class="blackbold"> 
                                                    Meta Keywords :</td>
                                                <td width="56%"  align="left" valign="top">
													 <textarea style="width:60%; height: 85px;" class="inputbox" id="MetaKeywords" name="MetaKeywords"><?=(isset($arryMenu[0]['MetaKeywords'])) ? stripslashes($arryMenu[0]['MetaKeywords']) : '';?></textarea>
                                            ...
                                            <tr>
                                                <td width="30%" align="right" valign="top"  class="blackbold"> 
                                                    Meta Title :</td>
                                                <td width="56%"  align="left" valign="top">
												 <textarea style="width:60%; height: 85px;" class="inputbox" id="MetaTitle" name="MetaTitle"><?=(isset($arryMenu[0]['MetaTitle'])) ? stripslashes($arryMenu[0]['MetaTitle']) : ''; ?></textarea>
                                            ...
                                            <tr>
                                                <td width="30%" align="right" valign="top"  class="blackbold"> 
                                                    Meta Description :</td>
                                                <td width="56%"  align="left" valign="top">
												 <textarea style="width:60%; height: 85px;" class="inputbox" id="MetaDescription" name="MetaDescription"><?=(isset($arryMenu[0]['MetaDescription'])) ? stripslashes($arryMenu[0]['MetaDescription']) : '';?></textarea>
