...
/*************************/
$arryLead=$objLead->LearReportByAnnualRevenue($_GET);
...
if($num>0){
	...
	$header = "Lead Name\tLead Date\tAnnualRevenue\tRating";
    ...
    */
		...
		$line = stripslashes($values["FirstName"]).' '.stripslashes($values["LastName"])." \t".stripslashes($values["LeadDate"])."\t".stripslashes($values["AnnualRevenue"])."\t".stripslashes($values["Rating"])."\n";
