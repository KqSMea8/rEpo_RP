...
if(empty($_SERVER['HTTP_REFERER'])){
 ...
 $fetch = "SELECT e.*,d.Department as emp_dep,d.depID from h_employee e left outer join  h_department d on e.Department=d.depID  WHERE e.Status=1 and e.UserName LIKE '%".$_GET['q']."%' and  e.locationID='".$_SESSION['locationID'] ."'  ORDER BY e.UserName DESC LIMIT 10"; 
