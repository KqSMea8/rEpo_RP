...
table#mainTable{
 ...
 <table id="mainTable" >
 	<tr>
        ...
        <tr>
	 <td>
               <h4><img width="180" height="" src="'.$SiteLogo.'"></h4>
	 </td>
 ...
 <tr>
 	<td style="width:210px; margin-top:30px; padding:0px; border:1px solid #e3e3e3;" valign="top">
        <table>
                <tr>
                ...
                <tr>
                <td style="font-size:12px; line-height:22px; margin:8px 0 8px 10px; text-align:left;">'.wordwrap($Address,50,'<br>').'</td>
                </tr>  
 	...
 	<td style="width:320px; height:auto; margin-top:15px; padding:0px; border:1px solid #e3e3e3;" valign="top">
 	  <table>
                <tr>
                ...
                <tr>
                <td style="font-size:12px; line-height:22px; margin:8px 0 8px 10px; text-align:left;">'.wordwrap($ShippingAddress,50,'<br>').'</td>
                </tr>  
...
<table style="width:100; border:none; cellpadding:0; cellspacing:0;margin:0px; padding:0px;">
  ...
  <tr>
    ...
    <td style="border:1px solid #cacaca; border-bottom:none;padding:5px 10px;"><span style="text-align:right;margin-left:27px;">'.$TaxRate.'</span></td>
  </tr>
  <tr>
    <td style="padding:5px 10px;">Freight</td>
    <td style="border:1px solid #cacaca; padding:5px 10px; "> <span style="text-align:right; margin-left:27px;">'.$Freight.'</span></td>
  </tr>
...
ob_end_clean(); // close and clean the output buffer.
    ...
    { //echo $content;
 	...
 	$QuoteID = $arryQuote[0][$ModuleID];
        
        //echo $_GET['attachfile'];die;
        ...
        $html2pdf->Output($savefileUrl.$QuoteID.'.pdf','F');    // Save file to dir
        exit();
        } // in htmltopdf fille .php
        
        
        $html2pdf->Output($QuoteID.'.pdf','D');
