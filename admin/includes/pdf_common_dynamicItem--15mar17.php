...
if (is_array($arryPurchaseItem) && $NumLine > 0) {
    ...
    foreach ($arryPurchaseItem as $key => $values) {
        ...
        <td style="width:'.$width1.';  text-align:left; font-size:' . $LineItemFontSize . 'px; color:' . $LineItemFieldColor . ';" >';
         ...
         $LineItem1.=$description.'<br /><b>Comment: </b>'.stripslashes($values['DesComment']);
         $LineItem1.='</td>';
...
<tbody valign="top" style="vertical-align: top; display:table;">
  ...
  if($DiscountDisplay=='show'){
    ...
    $LineItem .= '<td  style="width:'.$width9.'; border:1px solid #e3e3e3; color:#fff; vertical-align: top; text-align:right; font-size:' . $LineItemFontSize . 'px; font-weight:' . $LineItemHeadingBold . '; color:' . $LineHeadColor . ';">Amount</td>
</tr></tbody></table>';
...
if (is_array($arrySaleItem) && $NumLine > 0) {
    ...
    foreach ($arrySaleItem as $key => $values) {
        ...
        $LineItem1.='<tr style="vertical-align:  top;  margin:0px;padding:0px;"><td colspan="2"  style="width:100%; '.$height.' margin:0px;padding:0px;"><table id="itemtable"  style="width:100%; border:0;cellpadding:0; cellspacing:0;border-collapse:collapse; vertical-align: top;" ><tr style="' . $even . ';vertical-align: top;">
 ...
 if($DiscountDisplay=='show'){
               ...
               $LineItem1 .= '<td valign="top" style="width:'.$width9.'; vertical-align: top; text-align:right; font-size:' . $LineItemFontSize . 'px; color:' . $LineItemFieldColor . ';" >' . number_format($values["amount"], 2) . '</td>
            </tr></table></td></tr>';
