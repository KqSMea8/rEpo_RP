...
if ($_GET['type'] == 'Journal') {
 ...
 array("colum_name" => "Order Source", "table_name" => "s_order", "colum_value" => "OrderSource"),
 ...
 array("colum_name" => "Order Source", "table_name" => "s_order", "colum_value" => "OrderSource"),
    ...
    $column = array
        (
        array("colum_name" => "Credit Memo ID", "table_name" => "s_order", "colum_value" => "CreditID"),
    ...
    $column = array
        ...
        array("colum_name" => "Payment Date", "table_name" => "f_payment", "colum_value" => "PaymentDate"),
        array("colum_name" => "Invoice Number", "table_name" => "f_payment", "colum_value" => "InvoiceID"),
       // array("colum_name" => "PO/Reference Number", "table_name" => "p_order", "colum_value" => "ReferenceNo"),
	array("colum_name" => "Reference No.", "table_name" => "f_payment", "colum_value" => "ReferenceNo"),
    ...
    $column = array
        (
        array("colum_name" => "Credit Memo ID", "table_name" => "p_order", "colum_value" => "CreditID"),
