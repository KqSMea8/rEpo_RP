...
<tr <?=$StyleUS?> class="ClassUS" >
        ...
        <td   align="left" >
	 <input name="EIN" type="text" class="inputbox" id="EIN" value="<?=stripslashes($arryLocation[0]['EIN'])?>"     maxlength="20" onkeypress="return isPhoneKey(event);"  />			
	</td>
      </tr>
      ...
      <tr <?=$StyleIndia?> class="ClassIndia">
        ...
        <td   align="left" >
	 <input name="VAT" type="text" class="inputbox" id="VAT" value="<?=stripslashes($arryLocation[0]['VAT'])?>"  maxlength="20" onkeypress="return isUniqueKey(event);"/>			
	</td>
      </tr>
      ...
      <tr <?=$StyleIndia?> class="ClassIndia">
        ...
        <td   align="left" >
	 <input name="CST" type="text" class="inputbox" id="CST" value="<?=stripslashes($arryLocation[0]['CST'])?>"     maxlength="20" onkeypress="return isUniqueKey(event);" />			
	</td>
      </tr>
	...
	<tr <?=$StyleIndia?> class="ClassIndia" >
        ...
        <td   align="left" >
	 <input name="TRN" type="text" class="inputbox" id="TRN" value="<?=stripslashes($arryLocation[0]['TRN'])?>"     maxlength="20" onkeypress="return isUniqueKey(event);" />	
