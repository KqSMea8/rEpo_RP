...
function SetSuppCode(SuppCode){	
	...
	if(document.getElementById("link").value != ''){
		window.parent.location.href= document.getElementById("link").value+"?sc="+SuppCode;
				...
				$.ajax({
					type: "GET",
					url: "finance/ajax.php",
					data: SendUrl,
					dataType : "JSON",
					success: function (responseText) {
						window.parent.document.getElementById("SuppCode").value=SuppCode;
 						window.parent.document.getElementById("SuppID").value=responseText["SuppID"];
...
<form name="frmSrch" id="frmSrch" action="VendorList.php" method="get" onSubmit="return ResetSearch();">
