 ...
 <table width="100%" border="0" cellpadding="5" cellspacing="0" >
	<tr>
	 ...
	 <td  align="left">
		  ...
		  <input name="ReceivedAmount" type="text" class="inputbox" id="ReceivedAmount" style="width: 90px;" maxlength="10" onkeypress="return isDecimalKeyNeg(event);"    value="<?=$arryTransaction[0]['OriginalAmount']?>"/>
	 ...
	 <tr>
        ...
        <td  align="left">
                        ...
                        <select name="CustomerName" id="CustomerName" class="<?=$ClassName?>" <?=$Disabled?>  onChange="return checkContra();" >
                            ...
                            <option value="<?=$values['custID']?>" <?=($CustIDForContra==$values['custID'] || $arryTransaction[0]['CustID']==$values['custID'])?('selected'):('')?>><?=$values['CustomerName']?></option>
                            <?php }?>
...
?>
     <option label="<?=$arryBankAccount[$i]['BankCurrency']?>" value="<?=$arryBankAccount[$i]['BankAccountID']?>" <?=$selected?>>
