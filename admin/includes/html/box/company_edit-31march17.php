...
<tr>
 ...
 <?php if($arryCurrentLocation[0]['country_id']==106){?>
      ...
      <tr>
        ...
        <td   align="left" >
	 <input name="VAT" type="text" class="inputbox" id="VAT" value="<?=stripslashes($arryCompany[0]['VAT'])?>"  maxlength="20"/>			
	</td>
      </tr>
      ...
      <tr>
        ...
        <td   align="left" >
	 <input name="CST" type="text" class="inputbox" id="CST" value="<?=stripslashes($arryCompany[0]['CST'])?>"     maxlength="20" />			
	</td>
      </tr>
...
<tr>
       		 <td colspan="2" align="left" class="head">Sales Settings</td>
        </tr>
<tr>
