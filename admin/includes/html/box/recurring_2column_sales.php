  ...
  <tr>
		...
		<td   align="left" width="30%">
		  <select name="EntryType" class="inputbox" id="EntryType" style="width:100px;">
				<option value="one_time" <?php if(isset($arryRecurr[0]['EntryType']) && $arryRecurr[0]['EntryType'] == "one_time"){echo "selected";}?>>One Time</option>
				<option value="recurring" <?php if(isset($arryRecurr[0]['EntryType']) && $arryRecurr[0]['EntryType'] == "recurring"){echo "selected";}?>>Recurring</option>	 
			</select> 
		</td>
		...
		<select name="EntryDate" class="inputbox" id="EntryDate" style="width:100px;display:none;">
				...
				<option value="<?=$prefix.$i;?>" <?php if(isset($arryRecurr[0]['EntryDate']) && $arryRecurr[0]['EntryDate'] == $prefix.$i){echo "selected";}?>><?=$prefix.$i;?></option>
				<?php }?>
			</select> 
		...
		<td  align="left" class="blacknormal">
                     <select name="EntryInterval" class="inputbox" id="EntryInterval" style="width:100px;">
                         ...
                         <option value="biweekly" <?php if(isset($arryRecurr[0]['biweekly']) &&  $arryRecurr[0]['EntryInterval'] == "biweekly"){echo "selected";}?>>Biweekly</option>
                         <option value="semi_monthly" <?php if(isset($arryRecurr[0]['semi_monthly']) &&  $arryRecurr[0]['EntryInterval'] == "semi_monthly"){echo "selected";}?>>Semi Monthly</option>
			 <option value="monthly" <?php if(isset($arryRecurr[0]['EntryInterval']) && $arryRecurr[0]['EntryInterval'] == "monthly"){echo "selected";}?>>Monthly</option>
			<? if($BiMonthlyON==1){?>
			 <option value="bi_monthly" <?php if($arryRecurr[0]['EntryInterval'] == "bi_monthly"){echo "selected";}?>>Bi Monthly</option>
			<? } ?>
			 <option value="yearly" <?php if(isset($arryRecurr[0]['EntryInterval']) && $arryRecurr[0]['EntryInterval'] == "yearly"){echo "selected";}?>>Yearly</option>	 
			</select> 
		...
		<td  align="left" class="blacknormal">
                    <span style="display:none;" id="dEveryField">
                     <select name="EntryMonth" class="inputbox" id="EntryMonth" style="width:100px;">
                        ...
                        <option value="<?=$m;?>" <?php if(isset($arryRecurr[0]['EntryMonth']) && $arryRecurr[0]['EntryMonth'] == $m){echo "selected";}?>><?=$month?></option>
                        <?php } ?>
			</select> 
		 </span>
    ...
    <tr style="display:none;" id="dFrom">
		...
		<td  align="left" class="blacknormal">
                    <?php $EntryFrom = ((isset($arryRecurr[0]['EntryFrom']) && $arryRecurr[0]['EntryFrom'] > 0) ? $arryRecurr[0]['EntryFrom']:"");?>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input id="Infinite" type="checkbox" value="1" name="Infinite" <?=(isset($arryRecurr[0]['EntryTo']) && $arryRecurr[0]['EntryTo']>0)?(""):("checked")?>>&nbsp;Infinite</label> 
		...
		<td  align="left" class="blacknormal"   id="EntryToVal">
                      <?php $EntryTo = ((isset($arryRecurr[0]['EntryTo']) && $arryRecurr[0]['EntryTo'] > 0) ? $arryRecurr[0]['EntryTo'] :"");?>
...
<? 
 $PaymentTermCard = (!empty($arryRecurr[0]['PaymentTerm']))?($arryRecurr[0]['PaymentTerm']):('');

if(empty($arryRecurr[0]['CrmQuote']) && strtolower(trim($PaymentTermCard))=="credit card") { 
