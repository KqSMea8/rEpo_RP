...
(empty($SupPrefx))?($SupPrefx=""):("");
(empty($analogStyle))?($analogStyle=""):(""); 
...
$dateFromPHP = strtotime(date('Y-m-d H:i:s'));
/******************************/
...
if($SelfPage=='home.php' || $SelfPage=='home1.php')$SupPrefx='../';
?>
<SCRIPT LANGUAGE=JAVASCRIPT>
var nowDate = new Date(<?=$dateFromPHP?> * 1000);
...
//var jq = $.noConflict();
 jQuery(document).ready(function() {
   jQuery('#analog-clock').clock({offset: '<?=$FinalOffset?>', type: 'analog'});
 });
</script>
