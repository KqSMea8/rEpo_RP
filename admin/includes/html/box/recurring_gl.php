...
function SetForInfiniteGL(){
	if(document.getElementById("InfiniteGL").checked){
		$("#EntryToLabelGL").hide();
		$("#EntryToValGL").hide();
		$("#EntryToGL").val("");
	}else{
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label><input id="InfiniteGL" type="checkbox" value="1" name="InfiniteGL" <?=($arryRecurr[0]['EntryTo']>0)?(""):("checked")?>>&nbsp;Infinite</label> 



		</td>
	
		<td  align="right"   class="blackbold"  id="EntryToLabelGL">Entry To :</td>
		<td  align="left" class="blacknormal"  id="EntryToValGL">
