...
<tr>
	...
	<input name="OldImage" type="hidden" value="<?=$arryCompany[0]['Image']?>">
...
<tr <?=$StyleUS?> class="ClassUS" >
	 ...
	 <input name="EIN" type="text" class="inputbox" id="EIN" value="<?=stripslashes($arryCompany[0]['EIN'])?>"     maxlength="20" onkeypress="return isPhoneKey(event);"  />			
      ...
      <tr <?=$StyleIndia?> class="ClassIndia">
        ...
        <td   align="left" >
	 <input name="VAT" type="text" class="inputbox" id="VAT" value="<?=stripslashes($arryCompany[0]['VAT'])?>"  maxlength="20" onkeypress="return isUniqueKey(event);"/>			
	</td>
      </tr>
      ...
      <tr <?=$StyleIndia?> class="ClassIndia">
        ...
        <td   align="left" >
	 <input name="CST" type="text" class="inputbox" id="CST" value="<?=stripslashes($arryCompany[0]['CST'])?>"     maxlength="20" onkeypress="return isUniqueKey(event);" />			
	</td>
      </tr>
	...
	<tr <?=$StyleIndia?> class="ClassIndia" >
        ...
        <td   align="left" >
	 <input name="TRN" type="text" class="inputbox" id="TRN" value="<?=stripslashes($arryCompany[0]['TRN'])?>"     maxlength="20" onkeypress="return isUniqueKey(event);" />	
...
$(document).ready(function(){
	...
	$(document).on('change', '#country_id', function(){  
			...
			if(country_id =='1'){  
				$(".ClassUS").show();  
			}else if(country_id =='106' || country_id=='234'){  
				 $(".ClassIndia").show();
			} 
	});
...
<tr>
       		 <td colspan="2" align="left" class="head">General Settings</td>
        </tr>
<!--tr>
        ...
        <td   align="left"  >
		 ...
		 if(empty($arryCompany[0]['spiffDis'])) {$SpiffChecked = ''; $InSpiffChecked = ' checked'; }else {$SpiffChecked = ' checked'; $InSpiffChecked ='';
		}
	  ?>
          <label><input type="radio" name="spiffDis" id="spiffDis" value="1" <?=$SpiffChecked?> />
          Yes</label>&nbsp;&nbsp;&nbsp;&nbsp;
          <label><input type="radio" name="spiffDis" id="spiffDis" value="0" <?=$InSpiffChecked?> />
          No</label> </td>
      </tr-->
      ...
      <tr>
        ...
        <td   align="left"  >
         	<textarea name="empSignature" id="empSignature" class="bigbox" maxlength="500"><?=stripslashes($arryCompany[0]['empSignature'])?></textarea>
		 <script type="text/javascript">
...
<span class=red><?=$DisablesMsg?></span>
