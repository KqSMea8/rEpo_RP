...
if (!empty($_GET['view'])) {
	if($_GET["tab"]=="sales"){
		include($MainPrefix."includes/html/box/commission_view.php");
	}else if($_GET["tab"]=="territory"){
		include($MainPrefix."includes/html/box/territory_view.php");
	}else{
		include($MainPrefix."includes/html/box/user_view.php");	
	}
