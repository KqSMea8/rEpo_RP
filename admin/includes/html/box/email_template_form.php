...
//-->
 ...
 <tr>
			  ...
			  <input type="hidden" name="TemplateID" id="TemplateID" value="<?=$arrayContents[0]['TemplateID']?>" />
			   <input type="hidden" name="EmpID" id="EmpID" value="<?=(isset($_GET['EmpID']) ? $_GET['EmpID'] : '');?>" />
				  
				  </td></tr> 
				
              </form>
          </table>
<? }else{ echo '<div class=message>'.INVALID_REQUEST.'</div>';} ?>
