  ...
  <tr>
		...
		<td   align="left">
		  <select name="EntryType" class="inputbox" id="EntryType" style="width:100px;">
				<option value="one_time" <?php if(!empty($arryRecurr) && $arryRecurr[0]['EntryType'] == "one_time"){echo "selected";}?>>One Time</option>
				<option value="recurring" <?php if(!empty($arryRecurr) && $arryRecurr[0]['EntryType'] == "recurring"){echo "selected";}?>>Recurring</option>	 
			</select> 
		</td>
		...
		<select name="EntryDate" class="inputbox" id="EntryDate" style="width:100px;display:none;">
				...
				<option value="<?=$prefix.$i;?>" <?php if(!empty($arryRecurr) && $arryRecurr[0]['EntryDate'] == $prefix.$i){echo "selected";}?>><?=$prefix.$i;?></option>
				<?php }?>
			</select> 
		...
		<td  align="left" class="blacknormal">
                     <select name="EntryInterval" class="inputbox" id="EntryInterval" style="width:100px;">
                         <option value="daily" <?php if(!empty($arryRecurr) && $arryRecurr[0]['EntryInterval'] == "daily"){echo "selected";}?>>Daily</option>
                         <option value="weekly" <?php if(!empty($arryRecurr) && $arryRecurr[0]['EntryInterval'] == "weekly"){echo "selected";}?>>Weekly</option>
                         <option value="biweekly" <?php if(!empty($arryRecurr) && $arryRecurr[0]['EntryInterval'] == "biweekly"){echo "selected";}?>>Biweekly</option>
                         <option value="semi_monthly" <?php if(!empty($arryRecurr) && $arryRecurr[0]['EntryInterval'] == "semi_monthly"){echo "selected";}?>>Semi Monthly</option>
			 <option value="monthly" <?php if(!empty($arryRecurr) && $arryRecurr[0]['EntryInterval'] == "monthly"){echo "selected";}?>>Monthly</option>
			 <option value="yearly" <?php if(!empty($arryRecurr) && $arryRecurr[0]['EntryInterval'] == "yearly"){echo "selected";}?>>Yearly</option>	 
			</select> 
		...
		<td  align="left" class="blacknormal">
                    <span style="display:none;" id="dEveryField">
                     <select name="EntryMonth" class="inputbox" id="EntryMonth" style="width:100px;">
                        ...
                        <option value="<?=$m;?>" <?php if(!empty($arryRecurr) && $arryRecurr[0]['EntryMonth'] == $m){echo "selected";}?>><?=$month?></option>
                        <?php } ?>
			</select> 
		 </span>
    ...
    <tr style="display:none;" id="dFrom">
		...
		<td  align="left" class="blacknormal">
                    <?php $EntryFrom = (!empty($arryRecurr) && $arryRecurr[0]['EntryFrom'] > 0) ? $arryRecurr[0]['EntryFrom'] : "";?>
		...
		<td  align="left" class="blacknormal">
                      <?php $EntryTo = (!empty($arryRecurr) && $arryRecurr[0]['EntryTo'] > 0) ? $arryRecurr[0]['EntryTo'] : "";?>
