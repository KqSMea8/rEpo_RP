...
function SetGrossHtml(){
	if(document.getElementById("GrandTotalSalesID") != null){
		...
		var ExemptSales = document.getElementById("ExemptSalesID").innerHTML;
		var GrandTotalSales = GrandTotalSales.replace(",", "");
		var ExemptSales = ExemptSales.replace(",", "");	
		var TaxableSalesID = parseFloat(GrandTotalSales) - parseFloat(ExemptSales);
		TaxableSalesID = number_format(TaxableSalesID,2);


	 	document.getElementById("GrossSalesID").innerHTML = document.getElementById("GrandTotalSalesID").innerHTML;
		document.getElementById("TaxableSalesID").innerHTML = TaxableSalesID;
