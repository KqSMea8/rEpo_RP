...
<table width="100%" border="0" cellpadding="5" cellspacing="0" class="borderall">
	...
	<tr>
	 ...
	 <tr>
        ...
        <td align="left">
		  <input name="PaidAmount" type="text" class="inputbox" id="PaidAmount" style="width: 90px;" maxlength="10" onkeypress="return isDecimalKey(event);"  value="<?=$arryTransaction[0]['OriginalAmount']?>"  /> <?=$Config['Currency55']?>  
...
?>
	<option value="<?=$SuppCode?>" 
	<?=($arryTransaction[0]['SuppCode']==$SuppCode)?('selected'):('')?> ><?=stripslashes($values['CompanyName'])?></option>
	<?php }?>
