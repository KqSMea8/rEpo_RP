...
<?php
require_once("paypal_pro.live.php");
...
/*
Api username:   admin_api1.virtualstacks.com

API password:   LFVHZUKECP9LUTTP

Api signature:    AFcWxV21C7fd0v3bYYYRCpSSRl31AkcWpUe5S

 Paypal email:     admin@virtualstacks.com
*/


$paypalPro = new paypal_pro('admin_api1.virtualstacks.com', 'LFVHZUKECP9LUTTP', 'AFcWxV21C7fd0v3bYYYRCpSSRl31AkcWpUe5S', '', '', TRUE, FALSE );
