...
$argv[1]='CmpID=250&AdminID=250&AdminType=admin&OrderID=5472&locationID=1&cu=9';
...
if(!empty($argv[1])){
	...
	$Department = 8; $ThisPage = 'ImportSerial.php';	
...
require_once($Prefix."classes/purchase.class.php");
	...
	if($parameters['cu']>0){
			$arrySelCurrency = $objRegion->getCurrency($parameters['cu'],'');
