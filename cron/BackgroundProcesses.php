...
//$argv[1]='CmpID=76&AdminID=76&AdminType=admin&ProcessName=AmazonLowestPrice';
...
if(empty($parameters['ProcessName'])) exit;
...
session_start();
	...
	$Department = 5; $ThisPage = 'BackgroundProcesses.php';	
