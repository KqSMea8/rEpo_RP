...
;(function($, window, document, undefined) {
    ...
    var pluginName = "floatingSocialShare",
        defaults = {
            ...
            url: ["http://facebook.com","http://twitter.com","http://plus.google.com","http://linkedin.com"],
            text: "share with ",
                ...
                $.each(networks, function(k, v) {
                    ...
                    if (value === k) {
                        var $icon = $("<i>", {class: "m-top5 fa fa-" + value + ""}),
                            _href = v.url.replace('{url}', base.settings.url[index]).replace('{title}', base.settings.title).replace('{description}', base.settings.description),
                        ...
                        if(base.settings.counter === true)
                            setShareCount(value, base.settings.url[index], $component);
    ...
    var places = ["top-left", "top-right"],
        networks = {
            "facebook" : { className: "facebook", url:"{url}" },
            "twitter": { className: "twitter", url:"{url}" },
            "google-plus": { className: "google-plus", url: "{url}" },
            "linkedin":  { className: "linkedin", url: "{url}" },
            "myspace":  { className: "myspace", url: "{url}" },
            "pinterest":  { className: "pinterest", url: "{url}" },
            "youtube":  { className: "youtube", url: "{url}" },
            "instagram":  { className: "instagram", url: "{url}" },
            "xing":  { className: "xing", url: "{url}" },
