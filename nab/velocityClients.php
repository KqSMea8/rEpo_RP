...
if (isset($_POST['TransactionToken']) && $_POST['TransactionToken'] != '') {
	...
	$cardDataKeyed = array('cardowner' => 'Jane Doe', 'cardtype' => 'AmericanExpress', 'pan' => '4012888812348882', 'expire' => '1215', 'cvv' => '123');
	$cardDataSwiped = array('track2data' => '4012000033330026=09041011000012345678', 'cardtype' => 'AmericanExpress');
	...
	try {
      ...
      array(
        'querytransactionparam' => array(
          ...
          //     'StartDateTime' => '2016-01-13 02:03:40',
