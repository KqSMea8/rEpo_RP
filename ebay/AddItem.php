...
<BODY>
<div class="container">
<div style="   background: #ddd none repeat scroll 0 0;
    border: 1px solid #777;
    padding: 6px;
    text-align: center;margin-bottom:20px;"> Add Item in Ebay </div>
<form action="AddItem.php" method="post" enctype="multipart/form-data" style="    border: 1px solid #333;
    margin: 0 auto;
    padding: 10px;
    width: 29%;">
<br><div class="row">
		...
		<div class="col-md-6">
          <input name="primaryCategory" value="63850" style="width:98%;"/>
...
<br><div class="row">
		...
		?>
		<div class="col-md-6"><input style="width:98%;" required class="form-control" type="text" name="itemTitle" value="<?php echo $title; ?>" size="49"></div>
	</div>
	...
	<br><div class="row">
		...
		<div class="col-md-6">
			<select class="form-control" id="itemCondition" name="itemCondition" title="Condition" style="width:37%;">
	...
	<br><div class="row">
	  <div class="col-md-6">listingDuration</div>
		<div class="col-md-6">
	          <select class="form-control" name="listingDuration" style="width:37%;">
...
<br><div class="row">
	...
	<div class="col-md-6"><input class="form-control" required type="text" name="startPrice" style="width:61%;"></div>
	</div>
	...
	<br><div class="row">
		<div class="col-md-12">
		<div class="pull-left"><input style="cursor:pointer;" class="form-control btn btn-primary" type="submit" name="submit" value="AddItem" tittle="AddItem"></div>
...
<?php
		...
		else
		{
			for($i=0;$i<count($images['name']);$i++):
				...
				if($images['type'][$i]!='image/png'&& $images['type'][$i]!='image/jpeg' && $images['type'][$i]!='image/jpg' && $images['type'][$i]!='image/gif'){
					...
					$name .=$i.'.'.$ext;
	//print_r($name);exit;
					move_uploaded_file($images['tmp_name'][$i], 'upload/'.$name);
					$img_name[]=$name;
				}
				//check image type	
			endfor;
		...
		$requestXmlBody .= '<PictureURL>http://199.227.27.207/erp/ebay/upload/'.$img_name[$j].'</PictureURL>';
		endfor;
		$requestXmlBody .= '</PictureDetails>';	
	  ...
	  $requestXmlBody .= "<Description>Text description of return policy details here.</Description>";
	...
	/**************************/
			...
			$selected = mysql_select_db("erp",$dbhandle) 
			or die("Could not select examples");

			//execute the SQL query and return records
                        $result = mysql_query("INSERT INTO 'ebay_items' ('search_keyword','categoryID','itemID','title','description','startprice','conditionvalue','listingDuration','image','listingtype') 
				VALUES ('123','23526','123456','abcd','tfghfhfghgfhgfhgf','20','12518526','20 days','5','Fixed value')");

echo  "hello";$result;			//close the connection
			...
			mysql_select_db("erp_sakshay") or die(mysql_error());

			// Insert a row of information into the table "example"

 $sql="INSERT INTO ebay_items ( searchkeyword, categoryID,itemID,title,description,startprice, conditionvalue, listingDuration, image, listingtype) VALUES ( '".$safequery."', '".$primaryCategory."', '".$itemID."', '".$itemTitle."','".$itemDescription."', '".$startPrice."', '".$itemCondition."', '".$listingDuration."','".$total_images."', '".$listingType."')";
