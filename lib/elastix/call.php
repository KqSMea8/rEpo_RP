...
$strHost = "66.55.11.57";
$strUser = "4000";#specify the asterisk manager username you want to login with
$strSecret = "0a45601b845119cb403a391a8f5fba5e";#specify the password for the above user
#specify the channel (extension) you want to receive the call requests with
#e.g. SIP/XXX, IAX2/XXXX, ZAP/XXXX, etc
# $strChannel = "SIP/100";
$strChannel = 4001;        //$_REQUEST['exten'];
