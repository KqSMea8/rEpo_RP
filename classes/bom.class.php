...
if($serial_noum[$j]!=''){
    ...
    function AddAssembleItem($AID, $arryDetails) {
        ...
        for ($i = 1; $i <= $NumLine; $i++) {
            ...
            if (!empty($arryDetails['sku' . $i])) {
                //$arryTax = explode(":",$arryDetails['tax'.$i]);
if($arryDetails['warehouse' ]==''){ $arryDetails['warehouse' ]=1;}
                $id = $arryDetails['id' . $i];
                /* if($id>0){
                ...
                $sql = "insert into inv_item_assembly (asmID,bomID,bom_refID, item_id, sku, description,valuationType,available_qty, qty, unit_cost, total_bom_cost,serial,`Condition`,req_item,serialPrice,serialdesc,binloc,WID) values('" . $AID . "','" . $bomID . "','" . $id . "','" . $arryDetails['item_id' . $i] . "', '" . addslashes($arryDetails['sku' . $i]) . "', '" . addslashes($arryDetails['description' . $i]) . "','" . addslashes($arryDetails['valuationType' . $i]) . "','" . addslashes($arryDetails['on_hand' . $i]) . "', '" . addslashes($arryDetails['qty' . $i]) . "', '" . addslashes($arryDetails['price' . $i]) . "','" . addslashes($arryDetails['amount' . $i]) . "','" . addslashes($arryDetails['serial_value' . $i]) . "', '" . addslashes($arryDetails['Condition' . $i]) . "','" . addslashes($arryDetails['req_item' . $i]) . "','" . addslashes($arryDetails['serialPrice' . $i]) . "','" . addslashes($arryDetails['serialdesc' . $i]) . "','" . addslashes($arryDetails['binloc' . $i]) . "','" . addslashes($arryDetails['warehouse' ]) . "')";
...
/*********Added By karishma based on Condition 6 Jan 2016*********************/
            ...
            $strAddQueryQtySerial .= (!empty($arryDetails['warehouse' ])) ? (" and warehouse='".$arryDetails['warehouse' ]."'") : ("");
...
$UpdateQtysql = "update inv_item_quanity_condition set condition_qty = condition_qty-" . $arryDetails['qty' . $i] . "  where Sku='" . $arryDetails['sku' . $i] . "' ".$strAddQueryQty."";
	...
	//$strSQL = "update inv_serial_item set UsedSerial = '1' where serialNumber='".$serial_no[$k]."' and Sku ='" . addslashes($arryItem[$Count]["sku"]) ."' and `Condition` = '".addslashes($arryItem[$Count]["Condition"])."' and warehouse = '".$arryDetails['warehouse' ]."'"; 
...
if($arryDetails['warehouse' ]==''){ $arryDetails['warehouse' ]=1;}
                $id = $arryDetails['id' . $i];
                if ($id > 0) {
                    $sql = "update inv_item_assembly set item_id='" . $arryDetails['item_id' . $i] . "', sku='" . addslashes($arryDetails['sku' . $i]) . "', description='" . addslashes($arryDetails['description' . $i]) . "', qty='" . addslashes($arryDetails['qty' . $i]) . "', unit_cost='" . addslashes($arryDetails['price' . $i]) . "', total_bom_cost='" . addslashes($arryDetails['amount' . $i]) . "' ,serial='" . addslashes($arryDetails['serial_value' . $i]) . "',`Condition` = '" . addslashes($arryDetails['Condition' . $i]) . "',req_item='" . addslashes($arryDetails['req_item' . $i]) . "',binloc='" . addslashes($arryDetails['binloc' . $i]) . "',WID='" . addslashes($arryDetails['warehouse' ]) . "'  where id='" . $id. "'";
                } else {

                    $sql = "insert into inv_item_assembly (asmID,bomID,bom_refID, item_id, sku, description,valuationType,available_qty, qty, unit_cost, total_bom_cost,serial,`Condition`,req_item,binloc,WID) values('" . $AID . "','" . $bomID . "','" . $id . "','" . $arryDetails['item_id' . $i] . "', '" . addslashes($arryDetails['sku' . $i]) . "', '" . addslashes($arryDetails['description' . $i]) . "','" . addslashes($arryDetails['valuationType' . $i]) . "','" . addslashes($arryDetails['on_hand' . $i]) . "', '" . addslashes($arryDetails['qty' . $i]) . "', '" . addslashes($arryDetails['price' . $i]) . "','" . addslashes($arryDetails['amount' . $i]) . "','" . addslashes($arryDetails['serial_value' . $i]) . "','" . addslashes($arryDetails['Condition' . $i]) . "','" . addslashes($arryDetails['req_item' . $i]) . "','" . addslashes($arryDetails['binloc' . $i]) . "','" . addslashes($arryDetails['warehouse' ]) . "')";
                }
                $this->query($sql, 0);
                if ($arryDetails['Status'] == 2) {
                    $strSQLItem = "update inv_items set qty_on_hand = qty_on_hand-'" . $arryDetails['qty' . $i] . "' where Sku='" . $arryDetails['sku' . $i] . "'";
...
$UpdateQtysql = "update inv_item_quanity_condition set condition_qty = condition_qty-" . $arryDetails['qty' . $i] . "  where Sku='" . $arryDetails['sku' . $i] . "' ".$strAddQueryQty." ";
        ...
        //$resultSr = "'" . implode ( "', '", $serial_no ) . "'";
			for ($k = 0; $k < sizeof($serial_no); $k++) {
				...
				//$strSQL = "update inv_serial_item set UsedSerial = '1' where serialNumber='".$serial_no[$j]."' and Sku ='" . addslashes($arryItem[$Count]["sku"]) ."' and `Condition` = '".addslashes($arryItem[$Count]["Condition"])."' and warehouse='".$arryDetails['warehouse' ]."'"; 
...
if($arryDetails['warehouse' ]==''){ $arryDetails['warehouse' ]=1;}
                ...
                $sql = "insert into inv_item_disassembly (dsmID,bomID,bom_refID, item_id, sku, description,valuationType,available_qty, qty, unit_cost, total_bom_cost,serial_value,`Condition`,req_item,binloc,WID) values('" . $AID . "','" . $bomID . "','" . $id . "','" . $arryDetails['item_id' . $i] . "', '" . addslashes($arryDetails['sku' . $i]) . "', '" . addslashes($arryDetails['description' . $i]) . "','" . addslashes($arryDetails['valuationType' . $i]) . "','" . addslashes($arryDetails['on_hand' . $i]) . "', '" . addslashes($arryDetails['qty' . $i]) . "', '" . addslashes($arryDetails['price' . $i]) . "','" . addslashes($arryDetails['amount' . $i]) . "','" . addslashes($arryDetails['serial_value' . $i]) . "','" . addslashes($arryDetails['Condition' . $i]) . "','" . addslashes($arryDetails['req_item' . $i]) . "','" . addslashes($arryDetails['binloc' . $i]) . "','".$arryDetails['warehouse' ]."')";
...
//$arryDetails['warehouse']=1;
                        for ($j = 0; $j <= sizeof($serial_noum) - 1; $j++) {
                            $strSQLQuery = "insert into inv_serial_item (warehouse,serialNumber,Sku,disassembly,`Condition`,type,description,UnitCost,binid)  values ('" . $arryDetails['warehouse' ] . "','" . $serial_noum[$j] . "','" . addslashes($arryDetails['sku' . $i]) . "','" . $AID . "','" . addslashes($arryDetails['Condition' . $i]) . "','disassemble',addslashes($serial_des[$j]),'". addslashes($arryDetails['price' . $i])."','" . addslashes($arryDetails['binloc' . $i]) . "')";
                            $this->query($strSQLQuery, 0);
                            //echo   $serial_no[$i]."<br/>"; 
                        }
                    }
 ...
 $sql="select count(*) as total from inv_item_quanity_condition where 
						...
						if($restbl[0]['total']==0){
							...
							'" . addslashes($arryDetails['qty' . $i]) . "','" . addslashes($arryDetails['binloc' . $i]) . "','" . addslashes($arryDetails['warehouse' ]) . "')";
							$this->query($strSQLQuery, 0);
						}else{
							// update in tbl
...
if($arryDetails['warehouse' ]==''){ $arryDetails['warehouse' ]=1;}
                $id = $arryDetails['id' . $i];
                if ($id > 0) {
                    $sql = "update inv_item_disassembly set item_id='" . $arryDetails['item_id' . $i] . "', sku='" . addslashes($arryDetails['sku' . $i]) . "', description='" . addslashes($arryDetails['description' . $i]) . "', qty='" . addslashes($arryDetails['qty' . $i]) . "', unit_cost='" . addslashes($arryDetails['price' . $i]) . "', total_bom_cost='" . addslashes($arryDetails['amount' . $i]) . "' ,serial='" . addslashes($arryDetails['serial_value' . $i]) . "',`Condition`='" . addslashes($arryDetails['Condition' . $i]) . "',req_item='" . addslashes($arryDetails['req_item' . $i]) . "',binloc='" . addslashes($arryDetails['binloc' . $i]) . "',WID='".$arryDetails['warehouse' ]."'  where id='" . $id. "'";
                } else {
...
$strSQLQuery = "insert into inv_serial_item (warehouse,serialNumber,Sku,UsedSerial,disassembly,`Condition`,type,UnitCost,ReceiptDate,binid)  values ('".$arryDetails['warehouse' ]."','".$serial_noum[$j]."','".addslashes($arryDetails['sku'.$i])."','0','".$AID."','".addslashes($arryDetails['Condition'.$i])."','Receive Order','".$arryDetails['price'.$i]."','".$Config['TodayDate']."','".addslashes($arryDetails['binloc' . $i]) ."')";
 ...
 $sql="select count(*) as total from inv_item_quanity_condition where 
						...
						if($restbl[0]['total']==0){
							...
							'" . addslashes($arryDetails['Condition' . $i]) . "',
							'" . addslashes($arryDetails['sku' . $i]) . "','Disassembly',
							'" . addslashes($arryDetails['qty' . $i]) . "','".$arryDetails['warehouse' ]."','".addslashes($arryDetails['binloc' . $i]) ."')";
							$this->query($strSQLQuery, 0);
						}else{
							// update in tbl
							//$UpdateQtysql = "update inv_item_quanity_condition set condition_qty = condition_qty+" . $arryDetails['qty' . $i] . "  where Sku='" . $arryDetails['sku' . $i] . "' and `condition` = '".$arryDetails['Condition' . $i]."' and WID=1";
