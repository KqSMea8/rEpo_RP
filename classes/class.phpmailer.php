...
class phpmailer
{
     ...
     * @type string
     */
    public $From = 'smtpmail@virtualstacks.com';

    /**
     * The From name of the message.
     * @type string
     */
    public $FromName = 'VirtualStacks';
     ...
     * @type string
     */
    public $Sender = 'smtpmail@virtualstacks.com'; //'info@eznetcrm.com';
     ...
     */
	 ...
	 public $Host = 'mail.ezcloudmail.com';
    //public $Host = 'sm1.virtualstacks.com';
   ...
   // public $Port = 25;
     ...
     * @type string
     */
    #public $Username = 'smtpmail@virtualstacks.com';
    public $Username = 'smtpdev@vstacks.in';
    /**
     * SMTP password.
     * @type string
     */
    #public $Password = 'Virtual650';
    public $Password = 'vstacks0098';
    /**
     * SMTP auth type.
        ...
        foreach ($hosts as $hostentry) {
            ...
            if ($this->smtp->connect($prefix . $host, $port, $this->Timeout, $options)) {
				...
				//echo 'success';
                    ...
                    $lastexception = $exc;
                    echo 'We must have connected, but then failed TLS or Auth, so close connection nicely';
                    $this->smtp->quit();
                }
            }
        }
