 ...
 function GetHeaderMenusUser($Uid)
   ...
   if(!empty($Uid))
	...
	// $strid="select*from admin_modules where UserID=$Uid";
	 $strAddQuery ="SELECT M.*,P.* FROM admin_modules as M join permission as P on M.ModuleID=P.ModuleID  WHERE    Parent='53' and  P.UserID='".$Uid."' Order by OrderBy  asc"; 
 //echo  $strAddQuery;exit;
	 return $this->query($strAddQuery, 1);
    ...
    if(!empty($Uid))
     {
	// $strid="select*from admin_modules where UserID=$Uid";
	 $strAddQuery ="SELECT * FROM admin_modules   WHERE  Parent='53'  Order by OrderBy  asc"; 
...
function GetHeaderParent($pageurml)
    ...
    if(!empty($pageurml))
	 ...
	 $strAddQuery ="SELECT * FROM admin_modules   WHERE  link='".$pageurml."' and Parent='53'  Order by OrderBy  asc"; 
    //echo   $strAddQuery ;
	 return $this->query($strAddQuery, 1);
...
function GetrightmenuByadmin($AdminID)
	...
	// $strAddQuery ="SELECT P.*,CP.* FROM company as P left join permission_cmp as CP on P.CmpID=CP.CmpID WHERE 1  Order by CompanyName  asc"; 
	//echo $strAddQuery;exit;
	 // $strAddQuery ="SELECT * FROM `company` WHERE 1 Order by CompanyName  asc"; 
...
function GetHeaderSubmenuUserWorkflow($Uid,$Parent)
	 {
	
    if(!empty($Uid))
     {
	// $strid="select*from admin_modules where UserID=$Uid";
	 $strAddQuery ="SELECT M.*,P.* FROM admin_modules as M join permission as P on M.ModuleID=P.ModuleID  WHERE    Parent='".$Parent."' and  P.UserID='".$Uid."' Order by OrderBy  asc"; 
 //echo  $strAddQuery;exit;
	 return $this->query($strAddQuery, 1);
	 
	  }
	 }	
	 function GetHeaderSubmenuadminWorkflow($Uid,$Parent)
	 {
...
function GetHeaderParentWorkflow($pageurml)
	 {
