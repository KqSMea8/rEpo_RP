<?
class saleconfig extends dbClass
{
		//constructor
		function saleconfig()
		{
	...
	function NextPrevLead($leadID,$Next) {
		...
		if($leadID>0){			
			...
			$strSQLQuery = "select l.leadID  from s_lead l where l.leadID".$operator."'" . $leadID . "' and l.Opportunity='0' ". $strAddQuery. " order by l.leadID ".$asc." limit 0,1";
	...
	function NextPrevOpp($OpportunityID,$Next) {
		...
		if($OpportunityID>0){			
			...
			$strSQLQuery = "select o.OpportunityID from s_opportunity o where o.OpportunityID".$operator."'" . $OpportunityID . "' ". $strAddQuery. " order by o.OpportunityID ".$asc." limit 0,1";
	...
	function NextPrevTicket($TicketID,$Next) {
		...
		if($TicketID>0){			
			...
			$strSQLQuery = "select t.TicketID from s_ticket t where t.TicketID".$operator."'" . $TicketID . "' ". $strAddQuery. " order by t.TicketID ".$asc." limit 0,1";
