...
swfobject.embedSWF("open-flash-chart.swf", "my_chart", "615", "300", "9.0.0",{"get-data":"open_flash_chart_data"});
</script>
<script type="text/javascript">
...
var data = <?php echo $chart->toString(); ?>;
            ...
            <div style="border: 1px solid #E1E1E1;padding:10px;width:611px;background:#fff;"><div id="my_chart"></div></div>
        </div>
    </div>
