                                ...
                                <tr>
                                    <td align="center" valign="top" ><table width="100%" border="0" cellpadding="5" cellspacing="1" >
											<tr>
                                                ...
                                                <td width="56%"  align="left" valign="top">
													...
													foreach ($arryForms as $key => $values) {
														...
														echo ($values['FormId'] == $arryFormField[0]['FormId']) ? "selected" : "";
											...
											<tr>
                                                ...
                                                <td width="56%"  align="left" valign="top">
													...
													foreach ($FieldArray as $key => $values) {
														...
														echo (strtolower($values) == $arryFormField[0]['FieldType']) ? "selected" : "";
														echo '>'.$values.'</option>';
                                            ...
                                            <tr>
                                                ...
                                                <td width="56%"  align="left" valign="top">
                                                    <input  name="FieldName" id="FieldName" value="<?= stripslashes($arryFormField[0]['FieldName']) ?>" type="text" class="inputbox"  size="50" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="30%" align="right" valign="top"  class="blackbold"> 
                                                ...
                                                <td width="56%"  align="left" valign="top">
                                                    <input  name="Fieldlabel" id="Fieldlabel" value="<?= stripslashes($arryFormField[0]['Fieldlabel']) ?>" type="text" class="inputbox" />
                                                </td>
                                            </tr>
                                            
                                            <?php 
                                            $style='style="display:none"';
                                            if( $arryFormField[0]['FieldType']=='checkbox' || $arryFormField[0]['FieldType']=='radio' || $arryFormField[0]['FieldType']=='dropdown'){
                                            	$style='';
                                            }
                                            ?>
                                            <tr <?php echo $style; ?>id="Fieldvaluestr">
                                                ...
                                                <td width="56%"  align="left" valign="top">
													 <textarea style="width:60%; height: 85px;" class="inputbox" id="Fieldvalues" name="Fieldvalues"><?= stripslashes($arryFormField[0]['Fieldvalues']) ?></textarea>
                                            ...
                                            <tr>
                                                ...
                                                <td width="56%"  align="left" valign="top">
                                                    <input  name="Priority" id="Priority" onkeypress="return isNumberKey(event)" value="<?= stripslashes($arryFormField[0]['Priority']) ?>" type="text" class="inputbox" />
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td width="30%" align="right" valign="top"  class="blackbold"> 
                                                    Manadatory :</td>
                                                <td width="56%"  align="left" valign="top">
                                                    <input  name="Manadatory" id="Manadatory" value="1" type="checkbox" <?php echo ($arryFormField[0]['Manadatory'] == 'Yes') ? "checked" : "";?> />
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" class="blacknormal">
                                                    <table width="151" border="0" cellpadding="0" cellspacing="0"  class="blacknormal margin-left">
                                                        <tr>
                                                            <td width="20" align="left" valign="middle"><input name="Status" type="radio" value="1" <?= ($FieldStatus == "Yes") ? "checked" : "" ?> /></td>
                                                            <td width="48" align="left" valign="middle">Active</td>
                                                            <td width="20" align="left" valign="middle"><input name="Status" type="radio" <?= ($FieldStatus == "No") ? "checked" : "" ?> value="0" /></td>
