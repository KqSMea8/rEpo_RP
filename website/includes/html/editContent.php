                                ...
                                <tr>
                                    <td align="center" valign="top" ><table width="100%" border="0" cellpadding="5" cellspacing="1" >
                                            ...
                                            <tr>
                                                ...
                                                <td width="56%"  align="left" valign="top">
                                                    <input  name="Title" id="Title" value="<?= stripslashes($arryArticle[0]['Title']) ?>" type="text" class="inputbox"  size="50" />
                                                </td>
                                            </tr>
                                           ...
                                           <tr>
                                                ...
                                                <td width="56%"  align="left" valign="top">
                                                    <input  name="Priority" id="Priority" onkeypress="return isNumberKey(event)" value="<?= stripslashes($arryArticle[0]['Priority']) ?>" type="text" class="inputbox" />
                                                </td>
                                            </tr>
                                                ...
                                                <td width="56%"  align="left" valign="top">
													...
													<?php
													 ...
													 foreach ($FormsArray as $key => $values) {
														...
														if($arryArticle[0]['FormId']==$values['FormId']) echo 'selected';
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2" align="left" valign="top" class="editor_box">
                                                    ...
                                                    <textarea name="Fulltext" id="full_text"><?= stripslashes($arryArticle[0]['Fulltext']) ?></textarea>
                                                    <script type="text/javascript">
