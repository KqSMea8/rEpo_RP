						...
						<div id="block-block-1" class="block block-block">
							...
							<div class="content">
								...
								foreach($socialDat as $socialData){ ?>
									<span><a href="<?php echo $socialData['URI'];?>" target="_blank"><img
											 alt="<?php echo $socialData['Title'];?>" title="<?php echo $socialData['Title'];?>" src="../images/<?php echo $socialData['Icon'];?>"> </a></span>
											<?php } ?>
...
<div class="content">
<p style="line-height: 175%;">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;<img src="img/eZnetLogo_0_1.png" alt="eZnet CRM"  title="eZnet CRM"></p>
...
<script>var chat={id:Math.floor(1e6*Math.random()+1),name:"",empemail:"",lis:"MnT2FSAl0U"};!function(){console.log(chat);var e=document.createElement("script");e.type="text/javascript",e.async=!0,e.src=document.location.protocol+"//199.227.27.208/test/vimyjs.js";var t=document.getElementsByTagName("script")[0];t.parentNode.insertBefore(e,t)}();</script>
