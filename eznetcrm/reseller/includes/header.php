...
<div class="cr-cl">
<div class="credit-button">Credit Limit: <?php 
$acLmt=$rsAccountLimit[0]['AccountLimit'];
if($acLmt<0 || $acLmt==''){
	$acLmt=0;
}
echo '$'.$acLmt;?></div>
