...
function twentytwelve_comment( $comment, $args, $depth ) {
	...
	<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
		<article id="comment-<?php comment_ID(); ?>" class="comment">
			...
			<div class="reply">
				<?php comment_reply_link( array_merge( $args, array( 'reply_text' => __( 'Comment', 'twentytwelve' ), 'after' => ' <span>&darr;</span>', 'depth' => $depth, 'max_depth' => $args['max_depth'] ) ) ); ?>
			</div><!-- .reply -->
		</article><!-- #comment-## -->
	<?php
		break;
...
function twentytwelve_continue_reading_link() {
	return ' <span class="more"><a href="'. esc_url( get_permalink() ) . '"  class="more-link">' . __( 'Read More <span class="meta-nav"></span>', 'twentytwelve' ) . '</a> </span>';
}
...
function twentytwelve_auto_excerpt_more( $more ) {
	return ' &hellip;' . twentytwelve_continue_reading_link();
}
