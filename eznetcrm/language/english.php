...
define("COMPANY_REG1","You have been registered successfully. Please check your email to activate your account.");
define("COMPANY_REG","You have been registered successfully. Please check your email for login credentials.");
